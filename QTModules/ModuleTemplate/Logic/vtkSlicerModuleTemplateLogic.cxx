/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkSlicerModuleTemplateLogic.cxx,v $
...
//----------------------------------------------------------------------------
vtkCxxRevisionMacro(vtkSlicerModuleTemplateLogic, "$Revision: 1.9.12.1 $");
...
//----------------------------------------------------------------------------
void vtkSlicerModuleTemplateLogic::ProcessMRMLEvents(vtkObject *vtkNotUsed(caller),
...
//----------------------------------------------------------------------------
void vtkSlicerModuleTemplateLogic::ProcessLogicEvents(vtkObject *vtkNotUsed(caller), 
                                            unsigned long event, 
                                            void *callData)
{
...
//#include <vtkMRMLScalarVolumeDisplayNode.h"
//----------------------------------------------------------------------------
void vtkSlicerModuleTemplateLogic::SetActiveVolumeNode(vtkMRMLVolumeNode *activeNode)
{
...
vtkMRMLVolumeNode* vtkSlicerModuleTemplateLogic::AddHeaderVolume (const char* filename, const char* volname, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerModuleTemplateLogic::AddArchetypeScalarVolume (const char* filename, const char* volname, int loadingOptions)
{ 
  int centerImage = 0;
  int labelMap = 0;
  int singleFile = 0;
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerModuleTemplateLogic::AddArchetypeScalarVolume(
...
// higher bits are reserved for future use
vtkMRMLVolumeNode* vtkSlicerModuleTemplateLogic::AddArchetypeVolume (const char* filename, const char* volname, int loadingOptions, vtkStringArray *fileList)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeNode* vtkSlicerModuleTemplateLogic::AddArchetypeVolume(const char* filename, 
                                                                    const char* volname, 
                                                                    int loadingOptions) 
{
...
//----------------------------------------------------------------------------
int vtkSlicerModuleTemplateLogic::SaveArchetypeVolume(const char* filename, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode *vtkSlicerModuleTemplateLogic::CreateLabelVolume (vtkMRMLScene *scene, vtkMRMLVolumeNode *volumeNode, const char *name)
{
  if ( volumeNode == 0 ) 
    {
    return 0;
...
void vtkSlicerModuleTemplateLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "vtkSlicerModuleTemplateLogic:             " << this->GetClassName() << "\n";
...
//----------------------------------------------------------------------------
int vtkSlicerModuleTemplateLogic::IsFreeSurferVolume (const char* filename)
{
...
//-------------------------------------------------------------------------
void vtkSlicerModuleTemplateLogic::ComputeTkRegVox2RASMatrix ( vtkMRMLVolumeNode *VNode,
                                                                       vtkMatrix4x4 *M )
{
    double dC, dS, dR;
    double Nc, Ns, Nr;
...
//-------------------------------------------------------------------------
void vtkSlicerModuleTemplateLogic::TranslateFreeSurferRegistrationMatrixIntoSlicerRASToRASMatrix( vtkMRMLVolumeNode *V1Node,
