...
//---------------------------------------------------------------------------
//vtkStandardNewMacro (qSlicerAnnotationTextManager );
//vtkCxxRevisionMacro ( qSlicerAnnotationTextManager, "$Revision: 1.0 $");


// Constructors
qSlicerAnnotationTextManager::qSlicerAnnotationTextManager(){
...
qSlicerAnnotationTextManager::qSlicerAnnotationTextManager(QWidget * parent){
...
//---------------------------------------------------------------------------
/*void qSlicerAnnotationTextManager::PrintSelf ( ostream& os, vtkIndent indent )
{
    this->vtkObject::PrintSelf ( os, indent );
}*/

//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::ProcessMRMLEvents ( vtkObject *caller, unsigned long event, void *callData )
{/*
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::Update3DWidget(vtkMRMLAnnotationTextNode *activeNode)
{/*
    if (activeNode == NULL)
    {
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::AddMRMLObservers ( )
{/*
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::RemoveMRMLObservers ( )
{/*
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::AddTextWidget(vtkMRMLAnnotationTextNode *node)
{
    if (!node)
    {
        return;
...
//---------------------------------------------------------------------------
vtkTextWidget* qSlicerAnnotationTextManager::GetTextWidget(const char *nodeID)
{/*
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::RemoveTextWidget(vtkMRMLAnnotationTextNode *node)
{/*
    if (!node)
    {
        return;
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::RemoveTextWidgets()
{/*
    int nnodes = this->MRMLScene->GetNumberOfNodesByClass("vtkMRMLAnnotationTextNode");
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::RequestRender()
{
  //this->GetViewerWidget()->RequestRender();
}

//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::Render()
{
  //this->GetViewerWidget()->Render();
}

//---------------------------------------------------------------------------
/*void qSlicerAnnotationTextManager::SetViewerWidget ( vtkSlicerViewerWidget *viewerWidget )
{
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::UpdateWidgetInteractors()
{
  /*bool isNull = false;
...
//---------------------------------------------------------------------------
void qSlicerAnnotationTextManager::UpdateLockUnlock(vtkMRMLAnnotationTextNode* textNode)
{
  if (textNode == NULL)
  {
    return;
...
void qSlicerAnnotationTextManager::UpdateWidget(vtkMRMLAnnotationTextNode *activeNode)
{
  vtkTextWidget *widget = this->GetTextWidget(activeNode->GetID());
  if ( widget==NULL)
  {
