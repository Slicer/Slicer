...
vtkMRMLAnnotationFiducialDisplayableManager::vtkMRMLAnnotationFiducialDisplayableManager()
{
}
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::Create()
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneClosingEvent()
{
}

//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneCloseEvent()
{
}

//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneLoadStartEvent()
{
}

//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneLoadEndEvent()
{
}

//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneRestoredEvent()
{
}

//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneNodeAddedEvent(vtkMRMLNode* node)
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::OnMRMLSceneNodeRemovedEvent(vtkMRMLNode* /*node*/)
{
}
...
//---------------------------------------------------------------------------
/*void vtkMRMLAnnotationFiducialDisplayableManager::SetFiducialNodeID ( char *id )
{
...
// the scene.
/*void vtkMRMLAnnotationFiducialDisplayableManager::UpdateInteractionModeAtStartInteraction()
{
...
// with direct manipulation-type interactions with widgets in
// the scene.
/*void vtkMRMLAnnotationFiducialDisplayableManager::UpdateInteractionModeAtEndInteraction()
{
  if ( this->MRMLScene == NULL )
    {
    //vtkErrorMacro ( "UpdateInteractionModeAtStartInteraction: NULL scene.");
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::ProcessMRMLEvents ( vtkObject *caller, unsigned long event, void *callData )
{
/*
  ...
  if (callScene != NULL && callScene == this->MRMLScene && callData != NULL && event == vtkMRMLScene::NodeAddedEvent)
  {
    ...
    else if (addNode2 != NULL && addNode2->IsA("vtkMRMLFiducialListNode"))
    {
      ...
      //this->InvokeEvent(vtkMRMLAnnotationFiducialDisplayableManager::AddFiducialCompletedEvent);
    }
  }
...
//---------------------------------------------------------------------------
/*void vtkMRMLAnnotationFiducialDisplayableManager::UpdateWidget(vtkMRMLAnnotationFiducialNode *activeFiducialNode)
{ 
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::Update3DWidget(vtkMRMLFiducialListNode *activeFiducialListNode)
{
...
//---------------------------------------------------------------------------
/*void vtkMRMLAnnotationFiducialDisplayableManager::UpdateDisplayNode(vtkMRMLAnnotationFiducialNode* FiducialNode)
{
  cout << "vtkMRMLAnnotationFiducialDisplayableManager::UpdateDisplayNode Start" << endl;
...
//---------------------------------------------------------------------------
/*void vtkMRMLAnnotationFiducialDisplayableManager::UpdateTextDisplayProperty(vtkMRMLAnnotationTextDisplayNode *node)
{
  cout << "vtkMRMLAnnotationFiducialDisplayableManager::Update Text Display Property" << endl;
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::UpdatePointDisplayProperty(vtkMRMLAnnotationPointDisplayNode *node)
{
...
/*
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddMRMLObservers ( )
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemoveMRMLObservers ( )
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::UpdateFiducialWidgetInteractors()
{
  //bool isNull = false;
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddSeedWidget(vtkMRMLAnnotationFiducialNode *FiducialNode)
{
  if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddSeedWidget(vtkMRMLFiducialListNode *fiducialListNode)
{
  if (!fiducialListNode)
  {
...
//---------------------------------------------------------------------------
/*vtkSlicerSeedWidgetClass* vtkMRMLAnnotationFiducialDisplayableManager::GetSeedWidget(const char *nodeID)
{
  std::map<std::string, vtkSlicerSeedWidgetClass *>::iterator iter;
  for (iter = this->SeedWidgets.begin(); iter != this->SeedWidgets.end(); iter++)
  {
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemoveSeedWidget(vtkMRMLAnnotationFiducialNode *FiducialNode)
{
  if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
std::string vtkMRMLAnnotationFiducialDisplayableManager::GetTextDisplayNodeID(const char *nodeID)
{
...
//---------------------------------------------------------------------------
std::string vtkMRMLAnnotationFiducialDisplayableManager::GetFiducialNodeIDFromTextDisplayNode(const char *nodeID)
{
  /*std::string tempstring;
  std::map<std::string, std::string>::iterator iter;
  for (iter = this->TextDisplayNodes.begin();  iter != this->TextDisplayNodes.end(); iter++)
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddTextDiaplayNodeID(vtkMRMLAnnotationFiducialNode *FiducialNode)
{
  /*if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemoveTextDisplayNodeID(vtkMRMLAnnotationFiducialNode *FiducialNode)
{
  if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
std::string vtkMRMLAnnotationFiducialDisplayableManager::GetPointDisplayNodeID(const char *nodeID)
{
  /*std::string tempstring;
  std::map<std::string, std::string>::iterator iter;
...
//---------------------------------------------------------------------------
std::string vtkMRMLAnnotationFiducialDisplayableManager::GetFiducialNodeIDFromPointDisplayNode(const char *nodeID)
{/*
  std::string tempstring;
  std::map<std::string, std::string>::iterator iter;
  for (iter = this->PointDisplayNodes.begin(); iter != this->PointDisplayNodes.end(); iter++)
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddPointDiaplayNodeID(vtkMRMLAnnotationFiducialNode *FiducialNode)
{/*
  if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemovePointDisplayNodeID(vtkMRMLAnnotationFiducialNode *FiducialNode)
{/*
  if (!FiducialNode)
  {
    return;
...
//---------------------------------------------------------------------------
/*void vtkMRMLAnnotationFiducialDisplayableManager::SetViewerWidget ( vtkSlicerViewerWidget *viewerWidget )
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::Update3DWidgetVisibility(vtkMRMLFiducialListNode *activeFiducialListNode)
{/*
  if (activeFiducialListNode == NULL)
  {
    //vtkDebugMacro("Update3DWidget: passed in Fiducial node is null, returning");
...
void vtkMRMLAnnotationFiducialDisplayableManager::UpdateCamera()
{/*
  vtkCamera *cam = NULL;
...
//---------------------------------------------------------------------------
vtkCamera *vtkMRMLAnnotationFiducialDisplayableManager::GetActiveCamera()
{/*
...
void vtkMRMLAnnotationFiducialDisplayableManager::UpdateFiducialMeasurement(vtkMRMLAnnotationFiducialNode* FiducialNode)
{/*
  if (this->GetViewerWidget()) 
  {
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemoveSeedWidgets()
{/*
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::AddSeed(vtkMRMLFiducialListNode *fiducialListNode, const char *pointID)
{
  if (!fiducialListNode)
  {
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::RemoveSeed(vtkMRMLFiducialListNode *fiducialListNode, const char *pointID)
{/*
  if (!fiducialListNode)
  {
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::UpdateSeed(vtkMRMLFiducialListNode *flist, const char *fidID) // int f)
{
...
//---------------------------------------------------------------------------
void vtkMRMLAnnotationFiducialDisplayableManager::UpdateLockUnlock(vtkMRMLFiducialListNode* node)
{/*
  if (node == NULL)
  {
    return;
