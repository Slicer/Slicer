...
//-----------------------------------------------------------------------------
vtkSlicerAnnotationModuleLogic* qSlicerAnnotationModuleWidgetPrivate::logic()const
{
...
//-----------------------------------------------------------------------------
void qSlicerAnnotationModuleWidgetPrivate::updateAnnotation(
  int index, const QString& label, const QString& value, const QString& text)
{
  ...
  visibilitywidget = qobject_cast<qSlicerAnnotationModulePushButton*>(tableWidget->cellWidget(index, VisibleColumn));
  if (visibilitywidget == 0)
  {
      visibilitywidget = new qSlicerAnnotationModulePushButton(index, tableWidget);
  ...
  typewidget = qobject_cast<qSlicerAnnotationModulePushButton*>(tableWidget->cellWidget(index, TypeColumn));
  if (typewidget == 0)
  {
  ...
  lockwidget = qobject_cast<qSlicerAnnotationModulePushButton*>(tableWidget->cellWidget(index, LockColumn));
  if (lockwidget == 0)
  {
...
//-----------------------------------------------------------------------------
void qSlicerAnnotationModuleWidgetPrivate::SetItemEditable(int row, int col, bool isEditable)
{
    if ( isEditable )
    {
...
void qSlicerAnnotationModuleWidgetPrivate::moveSelectedRow(bool up)
{
    ...
    // change icons
    qSlicerAnnotationModulePushButton* button1 = (qSlicerAnnotationModulePushButton*)this->tableWidget->cellWidget(sourceRow, TypeColumn);
    qSlicerAnnotationModulePushButton* button2 = (qSlicerAnnotationModulePushButton*)this->tableWidget->cellWidget(destRow, TypeColumn);
...
// sets the whole row
//-----------------------------------------------------------------------------
void qSlicerAnnotationModuleWidgetPrivate::setRow(int row, const QList<QTableWidgetItem*>& rowItems)
{
    for (int col = 0; col < this->tableWidget->columnCount(); ++col)
    {
...
void qSlicerAnnotationModuleWidgetPrivate::updateSelection(int totalitems)
{
    if( isSelectAll )
    {
        ...
        isSelectAll = false;
        this->Ui_qSlicerAnnotationModule::selectedAllButton->setIcon( QIcon(":/Icons/AnnotationDeselectAll.png") );
    }
    else
    {
        for (int i = 0; i < totalitems; ++i)
        ...
        isSelectAll = true;
        this->Ui_qSlicerAnnotationModule::selectedAllButton->setIcon( QIcon(":/Icons/AnnotationSelectAll.png") );
    }
...
void qSlicerAnnotationModuleWidget::propertyEditButtonClicked()
{
    ...
    if ( this->GetPropertyDialog(mrmlnode->GetID()) == NULL )
    {
        qSlicerAnnotationModuleAnnotationPropertyDialog* propertyDialog =
            new qSlicerAnnotationModuleAnnotationPropertyDialog( mrmlnode, d->logic() );
...
void qSlicerAnnotationModuleWidget::propertyRestored(char* nodeID)
{
    ...
    QString valueString;
    qSlicerAnnotationModuleAnnotationPropertyDialog::FormatValueToChar(d->logic()->GetAnnotationTextFormatProperty(node), d->logic()->GetAnnotationMeasurement(node), valueString);
...
void qSlicerAnnotationModuleWidget::propertyAccepted(char* nodeID, QString text)
{
    CTK_D(qSlicerAnnotationModuleWidget);
...
void qSlicerAnnotationModuleWidgetPrivate::setInvisibleItemIcon(bool isVisible)
{
    ...
    foreach(int i, selectedRows)
    {
        qSlicerAnnotationModulePushButton* widget = qobject_cast<qSlicerAnnotationModulePushButton*>(tableWidget->cellWidget(i, VisibleColumn));
...
void qSlicerAnnotationModuleWidgetPrivate::setLockUnLockIcon(bool isLocked)
{
    ...
    foreach(int i, selectedRows)
    {
        qSlicerAnnotationModulePushButton* widget = qobject_cast<qSlicerAnnotationModulePushButton*>(tableWidget->cellWidget(i, LockColumn));
...
//-----------------------------------------------------------------------------
void qSlicerAnnotationModuleWidget::updateAnnotationTable(int index, std::vector<double> thevalue, const char* format)
{
    CTK_D(qSlicerAnnotationModuleWidget);
...
void qSlicerAnnotationModuleWidget::updateValue(vtkObject* annotationNode, void* call_data)
{
    CTK_D(qSlicerAnnotationModuleWidget);
    ...
    qSlicerAnnotationModuleAnnotationPropertyDialog* pdialog = this->GetPropertyDialog(node->GetID());
    if ( pdialog != NULL )
    {
...
//-----------------------------------------------------------------------------
qSlicerAnnotationModuleAnnotationPropertyDialog* qSlicerAnnotationModuleWidget::GetPropertyDialog(const char* id)
{
    std::map<std::string, qSlicerAnnotationModuleAnnotationPropertyDialog*>::iterator iter;
    for (iter = this->m_PropertyDialogs.begin(); iter != this->m_PropertyDialogs.end(); iter++)
    {
...
//-----------------------------------------------------------------------------
void qSlicerAnnotationModuleWidget::AddTextNodeCompleted(vtkObject* object, void* call_data)
{
  CTK_D(qSlicerAnnotationModuleWidget);
