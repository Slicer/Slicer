/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper.cxx,v $
  Language:  C++
...
// Construct a new vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper with default values
vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper::vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper()
{
}

// Destruct a vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper - clean up any memory used
vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper::~vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper()
{
}
...
void vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper::GenerateImage( int threadID,
                                                 int threadCount,
                                                 vtkVolume *vol,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper )
{
    ...
    if ( mapper->GetInput()->GetNumberOfScalarComponents() == 1 )
      ...
      if ( mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeGOShadeHelperGenerateImageOneSimpleNN(
              (VTK_TT *)(data),
    ...
    // Dependent (color) components
      ...
      // specify color and the fourth specifies opacity (through a lookup table)
        ...
        if ( scalarType == VTK_UNSIGNED_CHAR )
          {
          vtkSlicerFixedPointCompositeGOShadeHelperGenerateImageFourDependentNN( 
  ...
  // Trilinear Interpolation
    ...
    // Indepedent components (more than one)
      ...
      switch ( scalarType )
        {
        vtkTemplateMacro( 
          vtkSlicerFixedPointCompositeGOShadeHelperGenerateImageIndependentTrilin(
            (VTK_TT *)(data),
            threadID, threadCount, mapper, vol) );
        }
      }
    // Dependent components
      ...
      // specify color and the fourth specifies opacity (through a lookup table)
        ...
        if ( scalarType == VTK_UNSIGNED_CHAR )
          {
          vtkSlicerFixedPointCompositeGOShadeHelperGenerateImageFourDependentTrilin( 
            static_cast<unsigned char *>(data), threadID, threadCount, mapper, vol );
          }
        else
          {
...
// Print method for vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper
void vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper::PrintSelf(ostream& os, vtkIndent indent)
{
