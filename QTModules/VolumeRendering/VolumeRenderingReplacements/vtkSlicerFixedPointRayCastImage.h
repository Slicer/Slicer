/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointRayCastImage.h,v $
...
// .NAME vtkSlicerFixedPointRayCastImage - helper class for a ray cast image
// .SECTION Description
...
// vtkSlicerFixedPointVolumeRayCastMapper so that multiple mappers can share
...
class Q_SLICER_QTMODULES_VOLUMERENDERING_REPLACEMENTS_EXPORT vtkSlicerFixedPointRayCastImage : public vtkObject
{
public:
...
private:
  vtkSlicerFixedPointRayCastImage(const vtkSlicerFixedPointRayCastImage&);  // Not implemented.
  void operator=(const vtkSlicerFixedPointRayCastImage&);  // Not implemented.
};
