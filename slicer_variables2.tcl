...
#set ::SLICER_TAG "http://www.na-mic.org/svn/Slicer3/branches/testing/sign_integration/Slicer3"
...
switch $::tcl_platform(os) {
    ...
    # Windows NT currently covers WinNT, Win2000, XP Home, XP Pro
        ...
        set ::BatchMake_TEST_FILE $::BatchMake_BUILD_DIR/bin/$::VTK_BUILD_TYPE/BatchMake
