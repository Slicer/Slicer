...
if(NOT DEFINED CTK_DIR AND NOT Slicer_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    ...
    "549a5b7b72f7b63a70ad91f6d183c7728511f794"
    QUIET
    )
  ...
  set(EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS_APPLE)
  if(APPLE)
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS_APPLE
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      ${EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS_APPLE}
