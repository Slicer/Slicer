...
macro(CHECKIFSLICER3BUILD)
  if(BUILD_AGAINST_SLICER3)  ## This is only required to build against slicer as an external module.
    ...
    if (Slicer_FOUND)
      ...
      message(FATAL_ERROR "Cannot build without a Slicer3 build tree or a Slicer3 installation when BUILD_AGAINST_SLICER3 was specified. Please set Slicer_DIR when BUILD_AGAINST_SLICER3:BOOL=ON.")
    endif (Slicer_FOUND)
