...
bool UNLM_gradientDistance_smaller( OrderType e1, OrderType e2 ){return(e1[1]<e2[1]);}
/* *************************************************************************** */
...
public:
  ...
  IndicatorType GetDWI(void){ return m_DWI; }
...
private:
  //bool ComputeInverseMatrix( const double* measures, const double* squaredAverages, double normal, double* whitened ) const;
