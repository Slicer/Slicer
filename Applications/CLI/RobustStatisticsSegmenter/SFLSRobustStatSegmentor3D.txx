#ifndef SFLSRobustStatSegmentor3D_hpp_
#define SFLSRobustStatSegmentor3D_hpp_
  ...
  for (long i = 0; i < n; ++i)
    {
      ...
      this->m_force.push_back((1 - (this->m_curvatureWeight))*cvForce[i]/(fmax + 1e-10) +  (this->m_curvatureWeight)*kappaOnZeroLS[i]/(kappaMax + 1e-10));
    }
