...
class CurvedPlanarReformation(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("CurvedPlanarReformation")  # TODO: make this more human readable by adding spaces
...
See more information in <a href="https://github.com/organization/projectname#CurvedPlanarReformation">module documentation</a>.
""",
        )
...
def registerSampleData():
    ...
    # CurvedPlanarReformation1
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category="CurvedPlanarReformation",
        sampleName="CurvedPlanarReformation1",
        # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
        # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
        thumbnailFileName=os.path.join(iconsPath, "CurvedPlanarReformation1.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames="CurvedPlanarReformation1.nrrd",
        # Checksum to ensure file integrity. Can be computed by this command:
        #  import hashlib; print(hashlib.sha256(open(filename, "rb").read()).hexdigest())
        checksums="SHA256:998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        # This node name will be used when the data set is loaded
        nodeNames="CurvedPlanarReformation1",
    )

    # CurvedPlanarReformation2
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category="CurvedPlanarReformation",
        sampleName="CurvedPlanarReformation2",
        thumbnailFileName=os.path.join(iconsPath, "CurvedPlanarReformation2.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames="CurvedPlanarReformation2.nrrd",
        checksums="SHA256:1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        # This node name will be used when the data set is loaded
        nodeNames="CurvedPlanarReformation2",
    )


#
# CurvedPlanarReformationParameterNode
#


@parameterNodeWrapper
class CurvedPlanarReformationParameterNode:
    """
...
class CurvedPlanarReformationWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath("UI/CurvedPlanarReformation.ui"))
        ...
        self.logic = CurvedPlanarReformationLogic()
    ...
    def setParameterNode(self, inputParameterNode: Optional[CurvedPlanarReformationParameterNode]) -> None:
        """
...
class CurvedPlanarReformationLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return CurvedPlanarReformationParameterNode(super().getParameterNode())
...
class CurvedPlanarReformationTest(ScriptedLoadableModuleTest):
    ...
    def test_CurvedPlanarReformation1(self):
        ...
        self.delayDisplay(f"{resamplerName!r} {'was' if found else 'was NOT'} found in ApplicationLogic")
        ...
        self.delayDisplay(f"SliceLogic was{'' if numSliceLogics else ' NOT'} found in ApplicationLogic")
