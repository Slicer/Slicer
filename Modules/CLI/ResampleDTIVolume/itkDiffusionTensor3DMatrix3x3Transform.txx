...
DiffusionTensor3DMatrix3x3Transform<TData>::EvaluateTensorPosition(const PointType& point)
{
...
DiffusionTensor3DMatrix3x3Transform<TData>::EvaluateTransformedTensor(TensorDataType& tensor,
...
template <class TData>
typename DiffusionTensor3DMatrix3x3Transform<TData>::InternalMatrixTransformType
...
template <class TData>
typename DiffusionTensor3DMatrix3x3Transform<TData>::VectorType
