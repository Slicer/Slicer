...
public:
  ...
  ~DiffusionTensor3DAbs() = default;
  bool operator!=(const DiffusionTensor3DAbs& other) const { return *this != other; }
...
class DiffusionTensor3DAbsCorrectionFilter
  : public UnaryFunctorImageFilter<TInputImage,
                                   TOutputImage,
                                   Functor::DiffusionTensor3DAbs<typename TInputImage::PixelType::ComponentType,
...
public:
  ...
  typedef UnaryFunctorImageFilter<
    TInputImage,
    TOutputImage,
    Functor::DiffusionTensor3DAbs<typename TInputImage::PixelType, typename TOutputImage::PixelType>>
    Superclass;
