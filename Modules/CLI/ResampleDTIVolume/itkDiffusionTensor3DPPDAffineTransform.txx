...
DiffusionTensor3DPPDAffineTransform<TData>::EvaluateTransformedTensor(TensorDataType& tensor)
{
...
DiffusionTensor3DPPDAffineTransform<TData>::ComputeMatrixFromAxisAndAngle(VectorType axis, double cosangle)
{
  double c = cosangle;
