...
DifferenceDiffusionTensor3DImageFilter<TInputImage, TOutputImage>::GetMetaDataDictionary(const InputImageType* image)
{
...
DifferenceDiffusionTensor3DImageFilter<TInputImage, TOutputImage>::ApplyMeasurementFrameToTensor(
...
// ----------------------------------------------------------------------------
template <class TInputImage, class TOutputImage>
void DifferenceDiffusionTensor3DImageFilter<TInputImage, TOutputImage>::ThreadedGenerateData(
