...
void HFieldToDeformationFieldImageFilter<TInputImage, TOutputImage>::GenerateData()
{
  ...
  ImageRegionConstIteratorWithIndex<InputImageType> it =
    ImageRegionConstIteratorWithIndex<InputImageType>(input, inputRequestedRegion);
...
template <typename TInputImage, typename TOutputImage>
typename TOutputImage::PixelType HFieldToDeformationFieldImageFilter<TInputImage, TOutputImage>::ComputeDisplacement(
