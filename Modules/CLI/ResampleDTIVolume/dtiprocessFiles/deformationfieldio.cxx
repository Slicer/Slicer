...
{
  using DeformationImageReader = itk::ImageFileReader<DeformationImageType>;
  ...
  if( dft == HField )
    ...
    using DeformationConvertType = itk::HFieldToDeformationFieldImageFilter<DeformationImageType>;
