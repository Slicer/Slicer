...
==========================================================================*/
#ifndef itkDiffusionTensor3DFSAffineTransform_hxx
#define itkDiffusionTensor3DFSAffineTransform_hxx
...
typename DiffusionTensor3DFSAffineTransform<TData>::MatrixTransformType DiffusionTensor3DFSAffineTransform<TData>::ComputeMatrixSquareRoot(MatrixTransformType matrix)
{
...
template <class TData>
void DiffusionTensor3DFSAffineTransform<TData>::PreCompute()
{
...
typename DiffusionTensor3DFSAffineTransform<TData>::MatrixTransformType DiffusionTensor3DFSAffineTransform<TData>::ComputeRotationMatrixFromTransformationMatrix()
{
  ...
  try
  {
    matrix = ComputeMatrixSquareRoot(this->m_TransformMatrix * TransformMatrixTranspose).GetInverse();
  }
  catch (...)
  {
