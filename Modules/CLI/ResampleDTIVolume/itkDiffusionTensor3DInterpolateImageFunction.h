...
class DiffusionTensor3DInterpolateImageFunction : public ImageFunction<Image<DiffusionTensor3D<TData>, 3>, DiffusionTensor3D<TData>, TCoordRep>
{
public:
  ...
  TensorDataType EvaluateAtIndex(const IndexType& index) const override { return this->GetInputImage()->GetPixel(index); }
