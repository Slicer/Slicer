...
public:
  ...
  ~DiffusionTensor3DNearest() = default;
  bool operator!=(const DiffusionTensor3DNearest& other) const { return *this != other; }

  bool operator==(const DiffusionTensor3DNearest& other) const { return !(*this != other); }

  inline DiffusionTensor3D<TOutput> operator()(const DiffusionTensor3D<TInput>& tensorA)
  {
...
class DiffusionTensor3DNearestCorrectionFilter
  : public UnaryFunctorImageFilter<TInputImage,
                                   TOutputImage,
                                   Functor::DiffusionTensor3DNearest<typename TInputImage::PixelType::ComponentType,
...
public:
  ...
  typedef UnaryFunctorImageFilter<
    TInputImage,
    TOutputImage,
    Functor::DiffusionTensor3DNearest<typename TInputImage::PixelType, typename TOutputImage::PixelType>>
    Superclass;
