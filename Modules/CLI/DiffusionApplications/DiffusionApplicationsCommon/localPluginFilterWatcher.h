/*=========================================================================
  ...
  Module:    $RCSfile: localPluginFilterWatcher.h,v $
  Language:  C++
  Date:      $Date: 2010-02-15 15:36:34 -0600 (Mon, 15 Feb 2010) $
...
=========================================================================*/
#ifndef __localPluginFilterWatcher_h__
#define __localPluginFilterWatcher_h__
...
{
public:
  PluginFilterWatcher(itk::ProcessObject* o, const char *comment = "", ModuleProcessInformation *inf = 0,
                      double fraction = 1.0,
                      double start = 0.0)
