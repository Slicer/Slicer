...
/* berechnet den Nachbarschaftscode der 3x3x3-Umgebung von P{i} */
{
  ...
  nc = Q(-1 - _nx, 1) + Q(-_nx, 2) + Q(1 - _nx, 4) + Q(-1, 8) + Q(0, 16) + Q(1, 32) + Q(-1 + _nx, 64) + Q(_nx, 128)
       + Q(1 + _nx, 256);
  pos += _nzz;
  nc += Q(-1 - _nx, 512) + Q(-_nx, 1024) + Q(1 - _nx, 2048) + Q(-1, 4096) + Q(0, 8192) + Q(1, 16384)
        + Q(-1 + _nx, 32768) + Q(_nx, 65536) + Q(1 + _nx, 131072);
  pos += _nzz;
  nc += Q(-1 - _nx, 262144) + Q(-_nx, 524288) + Q(1 - _nx, 1048576) + Q(-1, 2097152) + Q(0, 4194304) + Q(1, 8388608)
        + Q(-1 + _nx, 16777216) + Q(_nx, 33554432) + Q(1 + _nx, 67108864);
  return nc;
}
...
/* berechnet den Nachbarschaftscode der 3x3x3-Umgebung von P{i} */
{
  ...
  pos = &result[i - nzz];
  nc = Q(-1 - nx, 1) + Q(-nx, 2) + Q(1 - nx, 4) + Q(-1, 8) + Q(0, 16) + Q(1, 32) + Q(-1 + nx, 64) + Q(nx, 128)
       + Q(1 + nx, 256);
  pos += nzz;
  nc += Q(-1 - nx, 512) + Q(-nx, 1024) + Q(1 - nx, 2048) + Q(-1, 4096) + Q(0, 8192) + Q(1, 16384) + Q(-1 + nx, 32768)
        + Q(nx, 65536) + Q(1 + nx, 131072);
  pos += nzz;
  nc += Q(-1 - nx, 262144) + Q(-nx, 524288) + Q(1 - nx, 1048576) + Q(-1, 2097152) + Q(0, 4194304) + Q(1, 8388608)
        + Q(-1 + nx, 16777216) + Q(nx, 33554432) + Q(1 + nx, 67108864);
  return nc;
}
...
/* d wird fuer den Zusatztest bei paralleler Tilgung verwendet        */
{
  ...
  if ((de - df + du) == 1)
  {
    ...
    if (type)
    {
      ...
      if ((d == 0) || (d == 1))
      {
        if (((dex - dfx) == 1) && ((dez - dfz) == 1) && (((bcx > 1) && (bcz > 1))))
        {
          return BG;
        }
      }
      ...
      {
        if (((dey - dfy) == 1) && ((dez - dfz) == 1) && (((bcy > 1) && (bcz > 1))))
        {
          return BG;
        }
      }
      ...
      {
        if (((dex - dfx) == 1) && ((dey - dfy) == 1) && (((bcx > 1) && (bcy > 1))))
        {
          return BG;
        }
      }
    ...
    else
    {
      ...
      switch (d)
      {
        case 0:
        case 1:
          if (((dex - dfx) == 1) && ((dez - dfz) == 1) && (((bcx > 1) && (bcz > 1)) || (c & free_mask)))
          {
            return BG;
          }
          break;
        case 2:
        case 3:
          if (((dey - dfy) == 1) && ((dez - dfz) == 1) && (((bcy > 1) && (bcz > 1)) || (c & free_mask)))
          {
            return BG;
          }
          break;
        case 4:
        case 5:
          if (((dex - dfx) == 1) && ((dey - dfy) == 1) && (((bcx > 1) && (bcy > 1)) || (c & free_mask)))
          {
            return BG;
          }
          break;
        ...
        case 7:
          ...
          if (((dey - dfy) == 1) && ((dex - dfx) == 1) && (((bcy > 1) && (bcx > 1)) || (c & free_mask)))
          {
            return BG;
          }
          break;
