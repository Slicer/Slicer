                                                      ...
                                                      typename ImageType::Pointer image)
{
  ...
  )
  {
    ...
    if (list.deffield.compare(""))
    {
      ...
      ResampleDeformationField(field, resampler->GetOutputOrigin(), resampler->GetOutputSpacing(), resampler->GetSize(), resampler->GetOutputDirection());
    }
...
template <class PixelType>
int AddImage(typename itk::VectorImage<PixelType, 3>::Pointer& imagePile, const std::vector<typename itk::Image<PixelType, 3>::Pointer>& vectorImage)
{
...
template <class PixelType>
int SeparateImages(const typename itk::VectorImage<PixelType, 3>::Pointer& imagePile, std::vector<typename itk::Image<PixelType, 3>::Pointer>& vectorImage)
{
  typedef itk::Image<PixelType, 3> ImageType;
...
int main(int argc, char* argv[])
{
  ...
  {
    case itk::IOComponentEnum::UCHAR: return Rotate<unsigned char>(list); break;
    case itk::IOComponentEnum::CHAR: return Rotate<char>(list); break;
    case itk::IOComponentEnum::USHORT: return Rotate<unsigned short>(list); break;
    case itk::IOComponentEnum::SHORT: return Rotate<short>(list); break;
    case itk::IOComponentEnum::UINT: return Rotate<unsigned int>(list); break;
    case itk::IOComponentEnum::INT: return Rotate<int>(list); break;
    case itk::IOComponentEnum::ULONG: return Rotate<unsigned long>(list); break;
    case itk::IOComponentEnum::LONG: return Rotate<long>(list); break;
    case itk::IOComponentEnum::FLOAT: return Rotate<float>(list); break;
    case itk::IOComponentEnum::DOUBLE: return Rotate<double>(list); break;
