    ...
    if len(pars)==1  and len(dwis)==1:
           ...
           try:
                for s in range(len(rois)): 
                    ...
                    tmpF =  './' + tmpD + '/' 
                    os.chdir(tmpF)
                    print 'python ' + rootA + '/TractoCell0/StochasticTractoGraphyClusterFiles.py ' + fullDir + '/' + pars[0] + ' ' + fullDir + '/' + dwis[0] + ' ' + fullDir + '/'  +  rois[s]
                    ret = os.system('python ' + rootA + '/TractoCell0/StochasticTractoGraphyClusterFiles.py ' + fullDir + '/' + pars[0] + ' ' + fullDir + '/' +  dwis[0] + ' ' + fullDir + '/' +  rois[s])
                    os.chdir('..')
