...
vtkCxxRevisionMacro(vtkLocalAxesActor, "$Revision: 1.7 $");
...
/*  this->AxesPoints->SetNumberOfPoints(3);
  ...
  this->XAxisLabel->GetCaptionTextProperty()->SetFontSize(static_cast<int>(0.2*length));

  this->YAxisLabel->GetCaptionTextProperty()->SetFontSize(static_cast<int>(0.2*length));
