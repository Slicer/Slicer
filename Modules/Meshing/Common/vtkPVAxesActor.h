...
public:
  ...
  void SetXAxisLabelProperty(vtkProperty *textProperty);
  void SetYAxisLabelProperty(vtkProperty *textProperty);
  void SetZAxisLabelProperty(vtkProperty *textProperty);
