...
vtkCxxRevisionMacro(vtkPVAxesActor, "$Revision: 1.5 $");
...
void vtkPVAxesActor::SetXAxisLabelProperty(vtkProperty *textProperty)
{
  return this->XAxisLabel->SetProperty(textProperty);
}

void vtkPVAxesActor::SetYAxisLabelProperty(vtkProperty *textProperty)
{
  return this->YAxisLabel->SetProperty(textProperty);
}

void vtkPVAxesActor::SetZAxisLabelProperty(vtkProperty *textProperty)
{
  return this->ZAxisLabel->SetProperty(textProperty);
}
