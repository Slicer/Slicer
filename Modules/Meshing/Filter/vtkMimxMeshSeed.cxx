...
int vtkMimxMeshSeed::CheckIfCellsShareEdgeX(int cellnum1, int cellnum2, int parcell)
{
        bool status1 = false;
        bool status2 = false;
...
int vtkMimxMeshSeed::CheckIfCellsShareEdgeY(int cellnum1, int cellnum2, int parcell)
{
        bool status1 = false;
        bool status2 = false;
        vtkGenericCell *cell = vtkGenericCell::New();
...
int vtkMimxMeshSeed::CheckIfCellsShareEdgeZ(int cellnum1, int cellnum2, int parcell)
{
        bool status1 = false;
        bool status2 = false;
        vtkGenericCell *cell = vtkGenericCell::New();
