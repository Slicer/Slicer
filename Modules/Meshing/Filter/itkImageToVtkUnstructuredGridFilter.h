...
Module:    $RCSfile: itkImageToVtkUnstructuredGridFilter.h,v $
Language:  C++
...
#ifndef __itkImageToVtkUnstructuredGridFilter_h
#define __itkImageToVtkUnstructuredGridFilter_h
...
class ITK_EXPORT ImageToVtkUnstructuredGridFilter : public ProcessObject
{
public:
  /** Standard "Self" typedef. */
  typedef ImageToVtkUnstructuredGridFilter         Self;
  ...
  itkTypeMacro(ImageToVtkUnstructuredGridFilter, ProcessObject);
...
protected:
  ImageToVtkUnstructuredGridFilter( );
  ~ImageToVtkUnstructuredGridFilter( ){ };
...
private:
  ImageToVtkUnstructuredGridFilter( const Self& ); //purposely not implemented
...
#include "itkImageToVtkUnstructuredGridFilter.txx"
#endif
