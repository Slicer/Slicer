...
Module:    $RCSfile: vtkRebinMaterialProperty.h,v $
Language:  C++
Date:      $Date: 2007/04/09 02:09:41 $
...
// .NAME vtkRebinMaterialProperties - Allows the user to reduce the number of
//       discrete values in the grid material property field
//
// .SECTION Description
// vtkRebinMaterialProperties allows the user to change the number of
...
#ifndef __vtkRebinMaterialProperty_h
#define __vtkRebinMaterialProperty_h
...
class VTK_GRAPHICS_EXPORT vtkRebinMaterialProperty : public vtkUnstructuredGridAlgorithm 
{
public:
  void PrintSelf(ostream& os, vtkIndent indent);
  vtkTypeRevisionMacro(vtkRebinMaterialProperty,vtkUnstructuredGridAlgorithm);
  static vtkRebinMaterialProperty* New();
...
private:
  vtkRebinMaterialProperty( const vtkRebinMaterialProperty& ); // Not implemented.
  void operator = ( const vtkRebinMaterialProperty& ); // Not implemented.
};
