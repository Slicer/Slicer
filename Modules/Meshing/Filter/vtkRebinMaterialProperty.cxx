...
Module:    $RCSfile: vtkRebinMaterialProperty.cxx,v $
Language:  C++
...
vtkCxxRevisionMacro(vtkRebinMaterialProperty,"$Revision: 1.1 $");
vtkStandardNewMacro(vtkRebinMaterialProperty);


void vtkRebinMaterialProperty::PrintSelf(ostream& os, vtkIndent indent )
{
  const char onStr[] = "On";
...
vtkRebinMaterialProperty::vtkRebinMaterialProperty()
{
...
int vtkRebinMaterialProperty::FillInputPortInformation(
    int,
  vtkInformation *info)
{
...
int vtkRebinMaterialProperty::RequestData(
...
void vtkRebinMaterialProperty::ComputeHistogramBins(  ) 
{
