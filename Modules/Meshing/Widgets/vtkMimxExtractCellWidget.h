...
=========================================================================*/
// .NAME vtkMimxExtractCellWidget - orthogonal hexahedron 3D widget
// .SECTION Description
...
// nice feature of the object is that the vtkMimxExtractCellWidget, like any 3D widget,
// will work with the current interactor style. That is, if vtkMimxExtractCellWidget does
...
// vtkMimxExtractCellWidget will terminate the processing of the event that it handles.
//
// To use this object, just invoke SetInteractor() with the argument of the
// method a vtkRenderWindowInteractor.  You may also wish to invoke
// "PlaceWidget()" to initially position the widget. The interactor will act
// normally until the "i" key (for "interactor") is pressed, at which point the
// vtkMimxExtractCellWidget will appear. (See superclass documentation for information
...
// rotate vtkMimxExtractCellWidget, pick a face (but not a face handle) and move the left
...
//
// The vtkMimxExtractCellWidget is very flexible. It can be used to select, cut, clip, or
...
class VTK_MIMXWIDGETS_EXPORT vtkMimxExtractCellWidget : public vtk3DWidget
{
public:
  // Description:
  ...
  vtkTypeRevisionMacro(vtkMimxExtractCellWidget,vtk3DWidget);
 ...
 /* void SetOutlineCursorWires(int);
  ...
  vtkGetObjectMacro(PickedCells, vtkIdList);
protected:
