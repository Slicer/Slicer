...
Module:    $RCSfile: vtkMimxPolyDataWidget.h,v $
Language:  C++
...
// .NAME vtkMimxPolyDataWidget - orthogonal hexahedron 3D widget
// .SECTION Description
...
// nice feature of the object is that the vtkMimxPolyDataWidget, like any 3D widget,
// will work with the current interactor style. That is, if vtkMimxPolyDataWidget does
...
// vtkMimxPolyDataWidget will terminate the processing of the event that it handles.
//
// To use this object, just invoke SetInteractor() with the argument of the
// method a vtkRenderWindowInteractor.  You may also wish to invoke
// "PlaceWidget()" to initially position the widget. The interactor will act
// normally until the "i" key (for "interactor") is pressed, at which point the
// vtkMimxPolyDataWidget will appear. (See superclass documentation for information
...
// rotate vtkMimxPolyDataWidget, pick a face (but not a face handle) and move the left
...
//
// The vtkMimxPolyDataWidget is very flexible. It can be used to select, cut, clip, or
...
#ifndef __vtkMimxPolyDataWidget_h
...
public:
  ...
  static vtkMimxPolyDataWidget *New();

  vtkTypeRevisionMacro(vtkMimxPolyDataWidget,vtk3DWidget);
...
private:
  vtkMimxPolyDataWidget(const vtkMimxPolyDataWidget&);  //Not implemented
  void operator=(const vtkMimxPolyDataWidget&);  //Not implemented
};
