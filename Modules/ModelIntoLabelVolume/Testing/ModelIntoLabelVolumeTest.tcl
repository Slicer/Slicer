...
set volumeNode [$volLogic AddArchetypeVolume $::env(Slicer3_HOME)/../Slicer3/Testing/Data/Input/CTHeadAxial.nhdr "CTHeadAxial" 0]
...
set modelNode [$modLogic AddModel $::env(Slicer3_HOME)/../Slicer3/Modules/ModelIntoLabelVolume/Testing/TestData/Neck.vtk]

# do it
set labelVolume [ModelIntoLabelVolumeIntersect  $modelNode $volumeNode]

# test it
set testVolumeNode [$volLogic AddArchetypeVolume $::env(Slicer3_HOME)/../Slicer3/Modules/ModelIntoLabelVolume/Testing/TestData/ModelIntoLabelVolumeTest.nrrd "ModelIntoLabelVolumeTest" 1]
