...
#
proc ModelIntoLabelVolumeClone { moduleName {slicerSourceDir ""} {targetDir ""} } {
  ...
  set files [glob $slicerSourceDir/Modules/ModelIntoLabelVolume/*]
  foreach f $files {
    set ff [file tail $f]
    ...
    close $fp
    regsub -all "ModelIntoLabelVolume" $contents $moduleName newContents

    regsub -all "ModelIntoLabelVolume" $ff $moduleName newFileName
...
#
proc ModelIntoLabelVolumeAddQuickModel { sliceLogic } {
  ...
  eval $modelDisplayNode SetColor [lrange [ModelIntoLabelVolumeGetPaintColor $::ModelIntoLabelVolume(singleton)] 0 2]
...
#
proc ModelIntoLabelVolumeLabelCheckpoint {} {
  ...
  set labelNode [$volumesLogic CreateLabelVolume $::slicer3::MRMLScene $volumeNode $targetName]
}
...
#
proc ModelIntoLabelVolumeTestQuickModel {} {
  set sliceLogic [lindex [vtkSlicerSliceLogic ListInstances] 0]
  ModelIntoLabelVolumeAddQuickModel $sliceLogic
}
