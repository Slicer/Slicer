...
=========================================================================auto=*/
// .NAME vtkMRIBiasFieldCorrectionWin32Header - manage Windows system differences
// .SECTION Description
// The vtkMRIBiasFieldCorrectionWin32Header captures some system differences between Unix
