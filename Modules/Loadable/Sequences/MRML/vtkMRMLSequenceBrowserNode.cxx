...
std::string vtkMRMLSequenceBrowserNode::SynchronizationProperties::ToString()
{
  std::stringstream ss;
  ss << "playback"
     << " " << (this->Playback ? "true" : "false") << " ";
  ss << "recording"
     << " " << (this->Recording ? "true" : "false") << " ";
  ss << "overwriteProxyName"
     << " " << (this->OverwriteProxyName ? "true" : "false") << " ";
  ss << "saveChanges"
     << " " << (this->SaveChanges ? "true" : "false") << " ";
  ss << "missingItemMode"
     << " " << (vtkMRMLSequenceBrowserNode::GetMissingItemModeAsString(this->MissingItemMode)) << " ";
  return ss.str();
}
...
void vtkMRMLSequenceBrowserNode::WriteXML(ostream& of, int nIndent)
{
  ...
  for (std::vector<std::string>::iterator roleNameIt = this->SynchronizationPostfixes.begin();
       roleNameIt != this->SynchronizationPostfixes.end();
       ++roleNameIt)
  {
  ...
  for (std::map<std::string, SynchronizationProperties*>::iterator rolePostfixIt =
         this->SynchronizationPropertiesMap.begin();
       ...
       ++rolePostfixIt)
  {
    ...
    of << indent << " SynchronizationPropertiesMap" << rolePostfixIt->first.c_str() << "=\""
       << rolePostfixIt->second->ToString() << "\"";
  }
}
...
void vtkMRMLSequenceBrowserNode::ReadXMLAttributes(const char** atts)
{
  ...
  while (*atts != nullptr)
  {
    ...
    else if (!strcmp(attName, "recordingSamplingMode"))
    {
      ...
      if (recordingSamplingMode < 0
          || recordingSamplingMode >= vtkMRMLSequenceBrowserNode::NumberOfRecordingSamplingModes)
      {
        vtkErrorMacro(
          "Invalid recording sampling mode: " << (attValue ? attValue : "(empty). Using LimitedToPlaybackFrameRate."));
    ...
    else if (!strcmp(attName, "indexDisplayMode"))
    {
      ...
      {
        vtkErrorMacro(
          "Invalid index display mode: " << (attValue ? attValue : "(empty). Using IndexDisplayAsIndexValue."));
    ...
    else if (std::string(attName).find("SynchronizationPropertiesMap") != std::string::npos)
    {
      ...
      this->SynchronizationPropertiesMap[rolePostfix] =
        currSyncProps; // Possibly overwriting the default, but that is ok
    }
  }
  ...
  else
  {
         ...
         ++rolePostfixIt)
    {
      ...
      vtkMRMLSequenceNode* sequenceNode =
        vtkMRMLSequenceNode::SafeDownCast(this->GetNodeReference(sequenceNodeReferenceRole.c_str()));
      ...
      vtkMRMLNode* proxyNode =
        vtkMRMLSequenceNode::SafeDownCast(this->GetNodeReference(proxyNodeReferenceRole.c_str()));
      ...
      if (syncProps != nullptr)
      {
        ...
        os << ", MissingItemMode: "
           << vtkMRMLSequenceBrowserNode::GetMissingItemModeAsString(syncProps->MissingItemMode);
      }
      os << "\n";
    }
  }
...
std::string vtkMRMLSequenceBrowserNode::GenerateSynchronizationPostfix()
{
  while (1)
  {
    ...
    bool isUnique =
      (std::find(this->SynchronizationPostfixes.begin(), this->SynchronizationPostfixes.end(), postfix.str())
       == this->SynchronizationPostfixes.end());
    if (isUnique)
    {
      return postfix.str();
    }
...
std::string vtkMRMLSequenceBrowserNode::SetAndObserveMasterSequenceNodeID(const char* sequenceNodeID)
{
  ...
  if (this->GetMasterSequenceNode() && this->GetMasterSequenceNode()->GetID()
  ...
  std::vector<std::string>::iterator oldMasterPostfixPosition =
    std::find(this->SynchronizationPostfixes.begin(), this->SynchronizationPostfixes.end(), masterPostfix);
  ...
  vtkMRMLSequenceNode* newMasterNode =
    (this->Scene ? vtkMRMLSequenceNode::SafeDownCast(this->Scene->GetNodeByID(sequenceNodeID)) : nullptr);
...
void vtkMRMLSequenceBrowserNode::RemoveAllSequenceNodes()
{
  ...
  for (std::vector<std::string>::reverse_iterator rolePostfixIt = synchronizationPostfixes.rbegin();
       rolePostfixIt != synchronizationPostfixes.rend();
       ++rolePostfixIt)
  {
    std::string sequenceNodeReferenceRole = SEQUENCE_NODE_REFERENCE_ROLE_BASE + (*rolePostfixIt);
    vtkMRMLSequenceNode* node =
...
std::string vtkMRMLSequenceBrowserNode::GetSynchronizationPostfixFromSequenceID(const char* sequenceNodeID)
{
  ...
  {
    vtkErrorMacro(
      "vtkMRMLSequenceBrowserNode::GetSynchronizationPostfixFromSequenceID failed: sequenceNodeID is invalid");
    return "";
  }
  for (std::vector<std::string>::iterator rolePostfixIt = this->SynchronizationPostfixes.begin();
       rolePostfixIt != this->SynchronizationPostfixes.end();
...
std::string vtkMRMLSequenceBrowserNode::AddSynchronizedSequenceNodeID(const char* synchronizedSequenceNodeId)
{
  ...
  this->SetAndObserveNodeReferenceID(
    sequenceNodeReferenceRole.c_str(), synchronizedSequenceNodeId, nullptr, ContentModifiedObserveEnabled);
  this->SynchronizationPropertiesMap[rolePostfix] = new SynchronizationProperties();
  return rolePostfix;
}
...
void vtkMRMLSequenceBrowserNode::RemoveSynchronizedSequenceNode(const char* nodeId)
{
  ...
  vtkWarningMacro(
    "vtkMRMLSequenceBrowserNode::RemoveSynchronizedSequenceNode did nothing, the specified node was not synchronized");
}
...
//----------------------------------------------------------------------------
void vtkMRMLSequenceBrowserNode::GetSynchronizedSequenceNodes(
  ...
  bool includeMasterNode /*=false*/)
{
       ...
       ++rolePostfixIt)
  {
    ...
    vtkMRMLSequenceNode* synchronizedNode =
      vtkMRMLSequenceNode::SafeDownCast(this->GetNodeReference(sequenceNodeRef.c_str()));
...
//----------------------------------------------------------------------------
void vtkMRMLSequenceBrowserNode::GetSynchronizedSequenceNodes(vtkCollection* synchronizedSequenceNodes,
                                                              bool includeMasterNode /* =false */)
{
  if (synchronizedSequenceNodes == nullptr)
  {
    vtkErrorMacro(
      "vtkMRMLSequenceBrowserNode::GetSynchronizedSequenceNodes failed: synchronizedSequenceNodes is invalid");
    return;
  }
  ...
  for (std::vector<vtkMRMLSequenceNode*>::iterator it = synchronizedDataNodesVector.begin();
       it != synchronizedDataNodesVector.end();
       ++it)
  {
...
void vtkMRMLSequenceBrowserNode::SetRecordingActive(bool recording)
{
  ...
  if (numberOfItems > 0 && this->GetMasterSequenceNode()->GetIndexType() == vtkMRMLSequenceNode::NumericIndex)
  {
...
int vtkMRMLSequenceBrowserNode::SelectNextItem(int selectionIncrement /*=1*/)
{
  ...
  else
  {
    ...
    else if (selectedItemNumber < 0)
    {
      ...
      {
        // wrap around and keep playback going
        // (need to compute the modulo twice: first to handle negative numbers, the second to actually compute the
        // wraparound)
...
//-----------------------------------------------------------------------------
bool vtkMRMLSequenceBrowserNode::SetSelectedItemByIndexValue(const std::string& indexValue,
                                                             bool exactMatchRequired /*=true*/)
{
  vtkMRMLSequenceNode* sequenceNode = this->GetMasterSequenceNode();
  if (!sequenceNode)
  {
...
void vtkMRMLSequenceBrowserNode::ProcessMRMLEvents(vtkObject* caller, unsigned long event, void* callData)
{
  ...
  else if (vtkMRMLSequenceNode::SafeDownCast(modifiedNode))
  {
    if (this->SelectedItemNumber < 0)
    {
      ...
      // This is consistent with automatically setting selected item number to INVALID_ITEM_NUMBER when all items are
      // removed.
...
void vtkMRMLSequenceBrowserNode::OnNodeReferenceAdded(vtkMRMLNodeReference* nodeReference)
{
  ...
  // because there are many different reference role names and we don't use reference role groups (for backward
  // compatibility reasons). (note: nodeReference->GetReferencedNode() is already valid when NodeReferenceAdded is
  // called)
  if (std::string(nodeReference->GetReferenceRole()).find(PROXY_NODE_REFERENCE_ROLE_BASE) != std::string::npos)
  {
    this->SetAndObserveNodeReferenceID(nodeReference->GetReferenceRole(),
                                       nodeReference->GetReferencedNodeID(),
...
bool vtkMRMLSequenceBrowserNode::GetRecording(vtkMRMLSequenceNode* sequenceNode)
{
  ...
  if (!syncProps)
  {
    vtkErrorMacro("vtkMRMLSequenceBrowserNode::GetRecording failed: sequence node is invalid or does not belong to "
                  "this browser node");
    return false;
  }
...
bool vtkMRMLSequenceBrowserNode::GetPlayback(vtkMRMLSequenceNode* sequenceNode)
{
  ...
  if (!syncProps)
  {
    vtkErrorMacro("vtkMRMLSequenceBrowserNode::GetPlayback failed: sequence node is invalid or does not belong to this "
                  "browser node");
    return false;
  }
...
bool vtkMRMLSequenceBrowserNode::GetOverwriteProxyName(vtkMRMLSequenceNode* sequenceNode)
{
  ...
  if (!syncProps)
  {
    vtkErrorMacro("vtkMRMLSequenceBrowserNode::GetOverwriteProxyName failed: sequence node is invalid or does not "
                  "belong to this browser node");
    return false;
  }
...
bool vtkMRMLSequenceBrowserNode::GetSaveChanges(vtkMRMLSequenceNode* sequenceNode)
{
  ...
  if (!syncProps)
  {
    vtkErrorMacro("vtkMRMLSequenceBrowserNode::GetSaveChanges failed: sequence node is invalid or does not belong to "
                  "this browser node");
    return false;
  }
...
//---------------------------------------------------------------------------
vtkMRMLSequenceBrowserNode::MissingItemModeType vtkMRMLSequenceBrowserNode::GetMissingItemMode(
  vtkMRMLSequenceNode* sequenceNode)
{
  SynchronizationProperties* syncProps = this->GetSynchronizationPropertiesForSequence(sequenceNode);
  if (!syncProps)
...
void vtkMRMLSequenceBrowserNode::SetRecording(vtkMRMLSequenceNode* sequenceNode, bool recording)
{
  ...
  bool modified = false;
  for (std::vector<vtkMRMLSequenceNode*>::iterator it = synchronizedSequenceNodes.begin();
       it != synchronizedSequenceNodes.end();
       ++it)
  {
    SynchronizationProperties* syncProps = this->GetSynchronizationPropertiesForSequence(*it);
    if (!syncProps)
    {
      vtkErrorMacro("vtkMRMLSequenceBrowserNode::SetRecording failed: sequence node is invalid or does not belong to "
                    "this browser node");
      continue;
    }
...
void vtkMRMLSequenceBrowserNode::SetPlayback(vtkMRMLSequenceNode* sequenceNode, bool playback)
{
       ...
       ++it)
  {
    ...
    if (!syncProps)
    {
      vtkErrorMacro("vtkMRMLSequenceBrowserNode::SetPlayback failed: sequence node is invalid or does not belong to "
                    "this browser node");
      continue;
    }
...
void vtkMRMLSequenceBrowserNode::SetOverwriteProxyName(vtkMRMLSequenceNode* sequenceNode, bool overwrite)
{
       ...
       ++it)
  {
    ...
    if (!syncProps)
    {
      vtkErrorMacro("vtkMRMLSequenceBrowserNode::SetOverwriteProxyName failed: sequence node is invalid or does not "
                    "belong to this browser node");
      continue;
    }
...
void vtkMRMLSequenceBrowserNode::SetSaveChanges(vtkMRMLSequenceNode* sequenceNode, bool save)
{
       ...
       ++it)
  {
    ...
    if (!syncProps)
    {
      vtkErrorMacro("vtkMRMLSequenceBrowserNode::SetSaveChanges failed: sequence node is invalid or does not belong to "
                    "this browser node");
      continue;
    }
...
//---------------------------------------------------------------------------
void vtkMRMLSequenceBrowserNode::SetMissingItemMode(vtkMRMLSequenceNode* sequenceNode,
...
std::string vtkMRMLSequenceBrowserNode::GetRecordingSamplingModeAsString(int recordingSamplingMode)
{
  ...
  {
    case vtkMRMLSequenceBrowserNode::SamplingAll:
      return "all";
    case vtkMRMLSequenceBrowserNode::SamplingLimitedToPlaybackFrameRate:
      return "limitedToPlaybackFrameRate";
    default:
      return "";
  }
}
...
std::string vtkMRMLSequenceBrowserNode::GetMissingItemModeAsString(int missingItemMode)
{
  ...
  {
    case vtkMRMLSequenceBrowserNode::MissingItemCreateFromPrevious:
      return "createFromPrevious";
    case vtkMRMLSequenceBrowserNode::MissingItemCreateFromDefault:
      return "createFromDefault";
    case vtkMRMLSequenceBrowserNode::MissingItemSetToDefault:
      return "setToDefault";
    default:
      return "";
  }
...
std::string vtkMRMLSequenceBrowserNode::GetIndexDisplayModeAsString(int indexDisplayMode)
{
  ...
  {
    case vtkMRMLSequenceBrowserNode::IndexDisplayAsIndex:
      return "[index]";
    case vtkMRMLSequenceBrowserNode::IndexDisplayAsIndexValue:
      return "[indexValue]";
    default:
      return "";
  }
...
std::string vtkMRMLSequenceBrowserNode::GetFormattedIndexValue(int index)
{
  ...
  std::string suffix;
  bool argFound =
    vtkMRMLSequenceBrowserNode::ValidateFormatString(sprintfSpecifier, prefix, suffix, formatString, "fFgGeEs");
  if (!argFound)
  {
    return indexValue;
  }
...
//-----------------------------------------------------------------------------
vtkMRMLSequenceBrowserNode::SynchronizationProperties*
vtkMRMLSequenceBrowserNode::GetSynchronizationPropertiesForSequence(vtkMRMLSequenceNode* sequenceNode)
{
  if (!sequenceNode)
  {
    return nullptr;
...
//-----------------------------------------------------------------------------
vtkMRMLSequenceBrowserNode::SynchronizationProperties*
vtkMRMLSequenceBrowserNode::GetSynchronizationPropertiesForPostfix(const std::string& rolePostfix)
{
  if (rolePostfix.empty())
  {
    return nullptr;
