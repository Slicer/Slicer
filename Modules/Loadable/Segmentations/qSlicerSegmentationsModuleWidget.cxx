...
vtkMRMLSegmentationDisplayNode* qSlicerSegmentationsModuleWidget::segmentationDisplayNode(bool create /*=false*/)
{
  ...
  vtkMRMLSegmentationNode* segmentationNode =
    vtkMRMLSegmentationNode::SafeDownCast(d->MRMLNodeSelector_Segmentation->currentNode());
  if (!segmentationNode)
  {
    return nullptr;
  }
...
void qSlicerSegmentationsModuleWidget::init()
{
  ...
  // Make connections
  connect(d->MRMLNodeSelector_Segmentation,
                                                                        ...
                                                                        bool removeFromSource /*=false*/)
{
  ...
  foreach (QString segmentId, selectedSegmentIds)
  {
    success = success && this->copySegmentBetweenSegmentations(
                           sourceSegmentation, targetSegmentation, segmentId, removeFromSource);
  }
