...
void qMRMLSegmentEditorWidgetPrivate::init()
{
  ...
  q->qvtkConnect(this->Logic, vtkSegmentEditorLogic::PauseRenderEvent, q, SLOT(onPauseRender()));
  q->qvtkConnect(this->Logic, vtkSegmentEditorLogic::ResumeRenderEvent, q, SLOT(onResumeRender()));
...
//---------------------------------------------------------------------------
void qMRMLSegmentEditorWidget::onPauseRender()
{
  qSlicerApplication::application()->pauseRender();
}

//---------------------------------------------------------------------------
void qMRMLSegmentEditorWidget::onResumeRender()
{
