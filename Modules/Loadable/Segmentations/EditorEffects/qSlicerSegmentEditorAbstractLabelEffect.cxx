...
{
  vtkSegmentEditorLogic::AppendPolyMask(input, polyData, sliceNode(sliceWidget), segmentationNode);
}
...
{
  vtkSegmentEditorLogic::CreateMaskImageFromPolyData(polyData, outputMask, sliceNode(sliceWidget));
}
