...
{
  auto xy = vtkSegmentEditorLogic::RasToXy(ras, sliceNode(sliceWidget));
  return { xy[0], xy[1] };
}
...
{
  vtkSegmentEditorLogic::XyzToRas(inputXyz, outputRas, sliceNode(sliceWidget));
}
...
{
  vtkSegmentEditorLogic::XyzToIjk(inputXyz, outputIjk, sliceNode(sliceWidget), image, parentTransformNode);
}
...
//-----------------------------------------------------------------------------
void qSlicerSegmentEditorAbstractEffect::setSegmentEditorLogic(const vtkSmartPointer<vtkSegmentEditorLogic>& segmentEditorLogic)
{
  Q_D(qSlicerSegmentEditorAbstractEffect);
