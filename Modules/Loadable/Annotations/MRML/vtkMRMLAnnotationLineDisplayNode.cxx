...
vtkMRMLAnnotationLineDisplayNode::vtkMRMLAnnotationLineDisplayNode()
{
  ...
  this->SliceProjection =
    (vtkMRMLAnnotationDisplayNode::ProjectionOff | vtkMRMLAnnotationLineDisplayNode::ProjectionDashed | vtkMRMLAnnotationLineDisplayNode::ProjectionColoredWhenParallel
     | vtkMRMLAnnotationLineDisplayNode::ProjectionThickerOnTop | vtkMRMLAnnotationLineDisplayNode::ProjectionUseRulerColor);
...
void vtkMRMLAnnotationLineDisplayNode::WriteXML(ostream& of, int nIndent)
{
  ...
  of << " projectedColor=\"" << this->ProjectedColor[0] << " " << this->ProjectedColor[1] << " " << this->ProjectedColor[2] << "\"";
...
void vtkMRMLAnnotationLineDisplayNode::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "Projected Color : (" << this->ProjectedColor[0] << "," << this->ProjectedColor[1] << "," << this->ProjectedColor[2] << ")" << "\n";
