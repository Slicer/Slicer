...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::ReadAnnotationPointDisplayProperties(
  vtkMRMLAnnotationPointDisplayNode* refNode,
...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::ReadAnnotationControlPointsData(
  vtkMRMLAnnotationControlPointsNode* refNode,
  char line[1024],
  int typeColumn,
  int xColumn,
  int yColumn,
...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::ReadAnnotationControlPointsProperties(
  vtkMRMLAnnotationControlPointsNode* refNode,
  char line[1024],
  int& typeColumn,
  int& xColumn,
  ...
  int& numColumns)
{
  ...
  if (lineString.find(preposition + "Columns = ") != std::string::npos)
  {
    ...
    vtkDebugMacro("Got " << numColumns << " columns, type = " << typeColumn << ", x = " << xColumn << ",  y = "
                         << yColumn << ",  z = " << zColumn << ", sel = " << selColumn << ", vis = " << visColumn);
    return 1;
  }
  return 0;
}
...
int vtkMRMLAnnotationControlPointsStorageNode::ReadAnnotation(vtkMRMLAnnotationControlPointsNode* refNode)
{
  ...
  while (fstr.good())
  {
    ...
    if (line[0] == '#')
    {
      if (line[1] == ' ')
      {
        if (!this->ReadAnnotationControlPointsProperties(refNode,
                                                         line,
                                                         typePointColumn,
                                                         xPointColumn,
                                                         yPointColumn,
    ...
    {
      if (this->ReadAnnotationControlPointsData(refNode,
                                                line,
                                                typePointColumn,
                                                xPointColumn,
                                                yPointColumn,
...
{
  // cast the input node
  vtkMRMLAnnotationControlPointsNode* aCPNode = vtkMRMLAnnotationControlPointsNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::WriteAnnotationPointDisplayProperties(
  fstream& of,
  vtkMRMLAnnotationPointDisplayNode* refNode,
  std::string preposition)
{
...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::WriteAnnotationControlPointsProperties(
  fstream& of,
  vtkMRMLAnnotationControlPointsNode* refNode)
{
  // put down a header
...
//----------------------------------------------------------------------------
int vtkMRMLAnnotationControlPointsStorageNode::WriteAnnotationControlPointsData(
  fstream& of,
  vtkMRMLAnnotationControlPointsNode* refNode)
{
  if (!refNode)
  ...
  for (int i = 0; i < refNode->GetNumberOfControlPoints(); i++)
  {
    ...
    of << this->GetAnnotationStorageType() << "|" << coord[0] << "|" << coord[1] << "|" << coord[2] << "|" << sel << "|"
       << vis << endl;
  }
...
int vtkMRMLAnnotationControlPointsStorageNode::WriteAnnotationDataInternal(vtkMRMLNode* refNode, fstream& of)
{
  ...
  {
    vtkErrorMacro("WriteAnnotationDataInternal: unable to cast input node "
                  << refNode->GetID() << " to a known annotation control point node");
    return 0;
  }
