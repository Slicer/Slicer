...
class VTK_SLICER_ANNOTATIONS_MODULE_MRML_EXPORT vtkMRMLAnnotationControlPointsStorageNode
...
protected:
  ...
  int WriteAnnotationPointDisplayProperties(fstream& of,
  ...
  int ReadAnnotationControlPointsData(vtkMRMLAnnotationControlPointsNode* refNode,
                                      char line[1024],
                                      int typeColumn,
                                      int xColumn,
                                      int yColumn,
                                      ...
                                      int visColumn,
                                      int numColumns);
  int ReadAnnotationPointDisplayProperties(vtkMRMLAnnotationPointDisplayNode* refNode,
                                           std::string lineString,
                                           std::string preposition);
  int ReadAnnotationControlPointsProperties(vtkMRMLAnnotationControlPointsNode* refNode,
                                            char line[1024],
                                            int& typeColumn,
                                            int& xColumn,
                                            int& yColumn,
