...
int qMRMLColorTableViewTest1(int argc, char* argv[])
{
  ...
  const vtkSmartPointer<vtkMRMLColorTableNode> userNode = vtkSmartPointer<vtkMRMLColorTableNode>::Take(vtkMRMLColorLogic::CopyNode(colorTableNode.GetPointer(), "User"));
