...
qSlicerTerminologyEditorWidgetPrivate::qSlicerTerminologyEditorWidgetPrivate(qSlicerTerminologyEditorWidget& object)
  : q_ptr(&object)
{
  // Indicate that these colors are not set, so do not overwrite them
  this->TerminologyInfo.ColorAutoGenerated = true;
  this->TerminologyInfo.NameAutoGenerated = true;
}
...
void qSlicerTerminologyEditorWidget::onSelectFromTerminology()
{
  ...
  {
    // Indicate that now color and name are set
    d->TerminologyInfo.ColorAutoGenerated = false;
    d->TerminologyInfo.NameAutoGenerated = false;
    d->updateGUIFromTerminologyInfo();
  }
}
