...
void qSlicerTerminologyEditorWidgetPrivate::updateGUIFromTerminologyInfo()
{
  ...
  this->categoryCodeMeaningLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->GetCodeMeaning());
  this->categoryCodeValueLineEdit->setText(TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->GetCodeValue());
  this->categoryCSDLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->GetCodingSchemeDesignator());
  ...
  this->typeModifierCodeMeaningLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->GetCodeMeaning());
  this->typeModifierCodeValueLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->GetCodeValue());
  this->typeModifierCSDLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->GetCodingSchemeDesignator());
  ...
  this->regionCSDLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetRegionObject()->GetCodingSchemeDesignator());

  this->regionModifierCodeMeaningLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->GetCodeMeaning());
  this->regionModifierCodeValueLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->GetCodeValue());
  this->regionModifierCSDLineEdit->setText(
    TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->GetCodingSchemeDesignator());
...
void qSlicerTerminologyEditorWidgetPrivate::updateTerminologyFromGUI()
{
  ...
  TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->SetCodeMeaning(
    this->categoryCodeMeaningLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->SetCodeValue(
    this->categoryCodeValueLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetCategoryObject()->SetCodingSchemeDesignator(
    this->categoryCSDLineEdit->text().toStdString().c_str());

  TerminologyInfo.GetTerminologyEntry()->GetTypeObject()->SetCodeMeaning(
    this->typeCodeMeaningLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetTypeObject()->SetCodeValue(
    this->typeCodeValueLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetTypeObject()->SetCodingSchemeDesignator(
    this->typeCSDLineEdit->text().toStdString().c_str());

  TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->SetCodeMeaning(
    this->typeModifierCodeMeaningLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->SetCodeValue(
    this->typeModifierCodeValueLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetTypeModifierObject()->SetCodingSchemeDesignator(
    this->typeModifierCSDLineEdit->text().toStdString().c_str());

  TerminologyInfo.GetTerminologyEntry()->GetRegionObject()->SetCodeMeaning(
    this->regionCodeMeaningLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetRegionObject()->SetCodeValue(
    this->regionCodeValueLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetRegionObject()->SetCodingSchemeDesignator(
    this->regionCSDLineEdit->text().toStdString().c_str());

  TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->SetCodeMeaning(
    this->regionModifierCodeMeaningLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->SetCodeValue(
    this->regionModifierCodeValueLineEdit->text().toStdString().c_str());
  TerminologyInfo.GetTerminologyEntry()->GetRegionModifierObject()->SetCodingSchemeDesignator(
    this->regionModifierCSDLineEdit->text().toStdString().c_str());
...
//-----------------------------------------------------------------------------
void qSlicerTerminologyEditorWidget::terminologyInfo(
  qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle& terminologyInfo)
{
  Q_D(qSlicerTerminologyEditorWidget);
...
//-----------------------------------------------------------------------------
void qSlicerTerminologyEditorWidget::setTerminologyInfo(
  qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle& terminologyInfo)
{
  Q_D(qSlicerTerminologyEditorWidget);
