...
#ifndef __VTK_WRAP__
  qSlicerTerminologyEditorDialog(qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle& initialTerminologyInfo,
...
public:
  ...
  /// \param terminologyInfo Terminology shown and edited by the dialog. The edited terminology will be stored in this
  /// variable as well.
  ///   terminologyInfo.ColorAutoGenerated and terminologyInfo.NameAutoGenerated set to false means that these are set
  ///   (from terminology) and so their value is valid and should be used by the caller.
  /// \return Success flag
