...
void qSlicerColorTableTerminologyDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
  ...
  if (editorButton)
  {
    ...
    if (logic)
    {
      ...
      // Get default color and other metadata from loaded terminologies //TODO: Check how this works if not found
    ...
    //---------------------------------------------------------------------------
    bool colorNameAutoGenerated = (colorNode->GetColorNameSource(colorIndex) != vtkMRMLColorTableNode::NameSetManually);
    ...
    qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle terminologyInfo(
      ...
      colorNameAutoGenerated, QColor(), false, QColor() );
...
void qSlicerColorTableTerminologyDelegate::setModelData(QWidget* editor, QAbstractItemModel* model, const QModelIndex &index) const
{
  ...
  {
    vtkMRMLColorTableNode::NameSourceType nameSource = terminologyInfo.NameAutoGenerated ?
      vtkMRMLColorTableNode::NameAutoGeneratedFromTerminology : vtkMRMLColorTableNode::NameSetManually;
    colorTableNode->SetColorName(colorIndex, terminologyInfo.Name.toUtf8().constData(), nameSource);
