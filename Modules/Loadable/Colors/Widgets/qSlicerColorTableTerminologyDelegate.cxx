...
void qSlicerColorTableTerminologyDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
  ...
  if (editorButton)
  {
    ...
    qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle terminologyInfo(
      ...
      colorNode->GetColorNameAutoGenerated(colorIndex), QColor(), false, QColor() );
...
void qSlicerColorTableTerminologyDelegate::setModelData(QWidget* editor, QAbstractItemModel* model, const QModelIndex &index) const
{
  ...
  {
    //TODO: The SetColorName has a nameAutoGenerated attribute, but terminologyInfo.NameAutoGenerated means
    // something different for "auto-generated". In a color node it means that the name is generated from the
    // RGBA color, and for terminology it means it is generated from the terminology type code meaning.
