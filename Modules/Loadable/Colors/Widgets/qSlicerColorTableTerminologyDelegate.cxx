...
void qSlicerColorTableTerminologyDelegate::setEditorData(QWidget* editor, const QModelIndex& index) const
{
  ...
  if (editorButton)
  {
    ...
    qSlicerTerminologyNavigatorWidget::TerminologyInfoBundle terminologyInfo(
      terminologyEntry, colorNode->GetColorName(colorIndex),
      colorAndNameAutoGenerated, color, colorAndNameAutoGenerated, color);
...
void qSlicerColorTableTerminologyDelegate::setModelData(QWidget* editor, QAbstractItemModel* model, const QModelIndex& index) const
{
  ...
  if (colorTableNode != nullptr)
  {
    ...
    colorTableNode->SetColor(colorIndex,
      terminologyInfo.Color.redF(), terminologyInfo.Color.greenF(), terminologyInfo.Color.blueF(), terminologyInfo.Color.alphaF());
  }
