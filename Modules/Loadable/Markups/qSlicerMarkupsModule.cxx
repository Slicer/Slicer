...
void qSlicerMarkupsModulePrivate::addToolBar()
{
	...
	this->ToolBar->setWindowTitle("Markups Menu");
	this->ToolBar->setObjectName("MarkupsToolBar");
...
void qSlicerMarkupsModule::setMRMLScene(vtkMRMLScene* scene)
{
  ...
  //?? this should be moved so scene is set before module is opened
...
//-----------------------------------------------------------------------------
//void qSlicerMarkupsModule::setToolBarActiveMarkupsNode(vtkMRMLMarkupsNode* markupsNode)
//{
//	Q_D(qSlicerMarkupsModule);
//	return d->ToolBar->setActiveMarkupsNode(markupsNode);
//}
