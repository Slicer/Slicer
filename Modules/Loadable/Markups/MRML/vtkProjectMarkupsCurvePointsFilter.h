...
/// This class projects curve points from a vtkMRMLMarkupsCurveNode to the surface of a model.
/// The intended use is for vtkMRMLMarkupsCurveNode to project generated points along a curve
/// to a surface. It is expected the the points given to SetInputData/SetInputConnection are
...
public:
  ...
  /// Sets the points to project. These points are expected to be along the curve that was given by SetInputCurveNode.
  /// They are meant to be the either the curve points generated by the CurveGenerator, or the generated resampled
  /// control points.
  /// \sa SetInputConnection
