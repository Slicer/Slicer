...
public:
  ...
  /// BOX ROI does not require control points to define a region, while the size of a BOUNDING_BOX ROI will be defined
  ...
  /// GetBounds/GetRASBounds will return the axis-aligned bounding box in node/world coordinates, while
  /// GetPlanes/GetPlanesWorld() will return the 6 planes that define the faces of the oriented bounding box. \sa
...
protected:
  ...
  void GenerateBoxBounds(double bounds[6],
                         double xAxis[3],
                         double yAxis[3],
                         double zAxis[3],
                         double center[3],
