...
/// \brief Measurement class calculating area enclosed by a closed curve
...
public:
  ...
  /// Calculate area of \sa InputMRMLNode closed curve markup node and store the result internally
