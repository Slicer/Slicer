...
/// but performance is optimal if there are less than 100 points. For visualizing
/// more points, it is recommended to use a vtkMRMLModelNode, which contains
/// vtkPolyData generated by a vtkGlyph3D filter.
///
