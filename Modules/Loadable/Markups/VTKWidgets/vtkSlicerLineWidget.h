 ...
 * events (that are triggered by VTK events). The vtkSlicerLineRepresentations are
...
class VTK_SLICER_MARKUPS_MODULE_VTKWIDGETS_EXPORT vtkSlicerLineWidget : public vtkSlicerAbstractWidget
{
public:
