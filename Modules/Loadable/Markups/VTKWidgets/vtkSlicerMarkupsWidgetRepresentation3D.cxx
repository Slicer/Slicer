                                                         ...
                                                         double& closestDistance2)
{
  ...
  if (markupsNode->GetNumberOfControlPoints() > 2 && this->CurveClosed)
  {
    ...
    if (interactionEventData->IsDisplayPositionValid())
    {
      double pixelTolerance = this->ControlPointSize / 2.0
                                / vtkMRMLAbstractThreeDViewDisplayableManager::GetViewScaleFactorAtPosition(
                                  this->Renderer, centerPosWorld, interactionEventData)
