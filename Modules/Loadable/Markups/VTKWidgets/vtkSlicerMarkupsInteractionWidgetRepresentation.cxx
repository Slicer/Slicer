...
bool vtkSlicerMarkupsInteractionWidgetRepresentation::IsDisplayable()
{
  ...
  if (!displayNode || !this->GetMarkupsNode() || !this->GetViewNode() || !displayNode->GetVisibility() ||
      !displayNode->GetHandlesInteractive() || !displayNode->IsDisplayableInView(this->GetViewNode()->GetID()))
  {
    return false;
  }
                                                                                        ...
                                                                                        double positionWorld[3])
{
  ...
  if (handlePolyData->GetNumberOfPoints() <= index)
  {
    vtkErrorMacro("GetInteractionHandlePositionWorld: Type: " << type << " Invalid handle index: " << index
                                                              ...
                                                              << handlePolyData->GetNumberOfPoints());
    return;
  }
