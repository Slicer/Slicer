...
void vtkSlicerMarkupsWidgetRepresentation2D::UpdateControlPointSize()
{
  ...
  if (this->MarkupsDisplayNode->GetUseGlyphScale())
  {
    ...
    this->ControlPointSize =
      this->ScreenSizePixel * this->ScreenScaleFactor * this->MarkupsDisplayNode->GetGlyphScale() / 100.0;
  }
  else
  {
    // absolute
...
double vtkSlicerMarkupsWidgetRepresentation2D::GetMaximumControlPointPickingDistance2()
{
  double maximumControlPointPickingDistance =
    this->ControlPointSize / 2.0 + this->PickingTolerance * this->ScreenScaleFactor;
