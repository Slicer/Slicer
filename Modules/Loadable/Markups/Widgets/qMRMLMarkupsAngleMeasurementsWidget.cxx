...
void qMRMLMarkupsAngleMeasurementsWidgetPrivate::setupUi(qMRMLMarkupsAngleMeasurementsWidget* widget)
{
  ...
  QObject::connect(this->angleMeasurementModeComboBox, SIGNAL(currentIndexChanged(int)), q_ptr, SLOT(onAngleMeasurementModeChanged()));
  QObject::connect(this->rotationAxisCoordinatesWidget, SIGNAL(coordinatesChanged(double*)), q_ptr, SLOT(onRotationAxisChanged()));
