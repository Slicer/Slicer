...
//-----------------------------------------------------------------------------
qSlicerDiffusionTensorVolumeDisplayWidgetPrivate ::qSlicerDiffusionTensorVolumeDisplayWidgetPrivate(
...
void qSlicerDiffusionTensorVolumeDisplayWidgetPrivate::init()
{
  ...
  QObject::connect(
    this->ScalarInvariantComboBox, SIGNAL(scalarInvariantChanged(int)), q, SLOT(setVolumeScalarInvariant(int)));
...
vtkMRMLDiffusionTensorVolumeDisplayNode* qSlicerDiffusionTensorVolumeDisplayWidget::volumeDisplayNode() const
{
  ...
  return volumeNode ? vtkMRMLDiffusionTensorVolumeDisplayNode::SafeDownCast(volumeNode->GetVolumeDisplayNode())
                    : nullptr;
}
...
void qSlicerDiffusionTensorVolumeDisplayWidget::updateWidgetFromMRML()
{
  ...
  if (displayNode->GetScalarInvariant() == vtkMRMLDiffusionTensorDisplayPropertiesNode::ColorOrientation
      || displayNode->GetScalarInvariant()
