...
//-----------------------------------------------------------------------------
class qSlicerDTISliceDisplayWidgetPrivate : public Ui_qSlicerDTISliceDisplayWidget
{
...
//-----------------------------------------------------------------------------
qSlicerDTISliceDisplayWidgetPrivate ::qSlicerDTISliceDisplayWidgetPrivate(qSlicerDTISliceDisplayWidget& object)
  : q_ptr(&object)
{}
...
void qSlicerDTISliceDisplayWidgetPrivate::init()
{
  ...
  QObject::connect(this->GlyphVisibilityCheckBox, SIGNAL(toggled(bool)), q, SLOT(setVisibility(bool)));
  QObject::connect(this->GlyphOpacitySliderWidget, SIGNAL(valueChanged(double)), q, SLOT(setOpacity(double)));
  QObject::connect(
    this->GlyphScalarColorTableComboBox, SIGNAL(currentNodeChanged(vtkMRMLNode*)), q, SLOT(setColorMap(vtkMRMLNode*)));
  QObject::connect(
    this->GlyphColorByScalarComboBox, SIGNAL(scalarInvariantChanged(int)), q, SLOT(setColorGlyphBy(int)));
  QObject::connect(this->GlyphManualScalarRangeCheckBox, SIGNAL(toggled(bool)), q, SLOT(setManualScalarRange(bool)));
  QObject::connect(
    this->GlyphScalarRangeWidget, SIGNAL(valuesChanged(double, double)), q, SLOT(setScalarRange(double, double)));
  QObject::connect(this->GlyphGeometryComboBox, SIGNAL(currentIndexChanged(int)), q, SLOT(setGlyphGeometry(int)));
  QObject::connect(this->GlyphScaleSliderWidget, SIGNAL(valueChanged(double)), q, SLOT(setGlyphScaleFactor(double)));
  QObject::connect(this->GlyphSpacingSliderWidget, SIGNAL(valueChanged(double)), q, SLOT(setGlyphSpacing(double)));
  QObject::connect(this->LineEigenVectorComboBox, SIGNAL(currentIndexChanged(int)), q, SLOT(setGlyphEigenVector(int)));
  QObject::connect(this->TubeEigenVectorComboBox, SIGNAL(currentIndexChanged(int)), q, SLOT(setGlyphEigenVector(int)));
}
...
{
  Q_Q(qSlicerDTISliceDisplayWidget);
  const int ScalarInvariant = (q->displayPropertiesNode() ? q->displayPropertiesNode()->GetColorGlyphBy() : -1);
...
// --------------------------------------------------------------------------
qSlicerDTISliceDisplayWidget ::qSlicerDTISliceDisplayWidget(QWidget* parentWidget)
...
vtkMRMLDiffusionTensorDisplayPropertiesNode* qSlicerDTISliceDisplayWidget ::displayPropertiesNode() const
{
  ...
  return d->DisplayNode ? d->DisplayNode->GetDiffusionTensorDisplayPropertiesNode() : nullptr;
}
...
{
  this->setMRMLDTISliceDisplayNode(vtkMRMLDiffusionTensorVolumeSliceDisplayNode::SafeDownCast(node));
}
...
void qSlicerDTISliceDisplayWidget::setMRMLDTISliceDisplayNode(vtkMRMLDiffusionTensorVolumeSliceDisplayNode* displayNode)
{
  ...
  if (displayNode)
  {
    qvtkReconnect(oldDisplayNode, this->displayNode(), vtkCommand::ModifiedEvent, this, SLOT(updateWidgetFromMRML()));
...
void qSlicerDTISliceDisplayWidget::updateWidgetFromMRML()
{
  ...
  d->GlyphVisibilityCheckBox->setChecked(d->DisplayNode->GetVisibility());
  d->GlyphOpacitySliderWidget->setValue(d->DisplayNode->GetOpacity());
  d->GlyphScalarColorTableComboBox->setCurrentNode(d->DisplayNode->GetColorNode());
  ...
  vtkMRMLDiffusionTensorDisplayPropertiesNode* displayPropertiesNode = this->displayPropertiesNode();
...
void qSlicerDTISliceDisplayWidget::setColorGlyphBy(int scalarInvariant)
{
  ...
  if (d->DisplayNode && (this->displayPropertiesNode()->GetColorGlyphBy() ==
                           vtkMRMLDiffusionTensorDisplayPropertiesNode::ColorOrientation ||
                         this->displayPropertiesNode()->GetColorGlyphBy() ==
                           vtkMRMLDiffusionTensorDisplayPropertiesNode::ColorOrientationMiddleEigenvector ||
                         this->displayPropertiesNode()->GetColorGlyphBy() ==
                           vtkMRMLDiffusionTensorDisplayPropertiesNode::ColorOrientationMinEigenvector))
  {
...
{
  Q_D(const qSlicerDTISliceDisplayWidget);
  return d->GlyphVisibilityLabel->isVisibleTo(const_cast<qSlicerDTISliceDisplayWidget*>(this));
}
