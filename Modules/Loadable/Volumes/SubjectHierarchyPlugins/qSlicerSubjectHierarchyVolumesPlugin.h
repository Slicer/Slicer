...
class Q_SLICER_VOLUMES_SUBJECT_HIERARCHY_PLUGINS_EXPORT qSlicerSubjectHierarchyVolumesPlugin
...
public:
  ...
  void collectShownVolumes(QSet<vtkIdType>& shownVolumeItemIDs,
                           int layer = vtkMRMLApplicationLogic::BackgroundLayer
                                       | vtkMRMLApplicationLogic::ForegroundLayer
                                       | vtkMRMLApplicationLogic::LabelLayer) const;
