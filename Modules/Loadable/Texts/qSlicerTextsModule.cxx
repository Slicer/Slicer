...
{
  QString help = tr("A module to create, edit and manage text data in the scene.<br>");
...
QString qSlicerTextsModule::acknowledgementText()const
{
  QString acknowledgement =
    tr("This work was supported through CANARIE's Research Software Program, and Cancer Care Ontario.<br>"
