...
//-----------------------------------------------------------------------------
void qSlicerSubjectHierarchyFolderPlugin::setDisplayColor(vtkIdType itemID, QColor color, const qSlicerTerminologyMetadata& terminologyMetadata)
{
  ...
  qSlicerTerminologyMetadata dummyTerminology;
...
//-----------------------------------------------------------------------------
QColor qSlicerSubjectHierarchyFolderPlugin::getDisplayColor(vtkIdType itemID, qSlicerTerminologyMetadata& terminologyMetadata) const
{
  if (itemID == vtkMRMLSubjectHierarchyNode::INVALID_ITEM_ID)
  {
    qCritical() << Q_FUNC_INFO << ": Invalid input item";
  ...
  terminologyMetadata.setName(shNode->GetItemName(itemID).c_str());
  terminologyMetadata.setNameAutoGenerated(false);
  terminologyMetadata.setColorAutoGenerated(true);
