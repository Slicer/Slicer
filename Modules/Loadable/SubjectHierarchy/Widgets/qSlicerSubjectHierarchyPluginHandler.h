...
class Q_SLICER_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qSlicerSubjectHierarchyPluginHandler : public QObject
{
  ...
  Q_PROPERTY(bool autoDeleteSubjectHierarchyChildren READ autoDeleteSubjectHierarchyChildren WRITE
  ...
  /// True by default
  Q_PROPERTY(bool displayPatientIDInSubjectHierarchyItemName READ displayPatientIDInSubjectHierarchyItemName WRITE
  ...
  /// False by default
  Q_PROPERTY(
    bool displayPatientBirthDateInSubjectHierarchyItemName READ displayPatientBirthDateInSubjectHierarchyItemName WRITE
  ...
  /// subject hierarchy item name after loading from DICOM.
  /// False by default
  Q_PROPERTY(bool displayStudyIDInSubjectHierarchyItemName READ displayStudyIDInSubjectHierarchyItemName WRITE
  ...
  /// subject hierarchy item name after loading from DICOM.
  /// True by default
  Q_PROPERTY(bool displayStudyDateInSubjectHierarchyItemName READ displayStudyDateInSubjectHierarchyItemName WRITE
...
public:
  ...
  /// IMPORTANT NOTE: This function will not change the selection in individual widgets (tree views, comboboxes). This
  /// is
  ...
  /// This function is called from the plugins when exposing and performing the supported actions. As the plugin actions
  /// are not aggregated on multi-selection, this function is never called from plugins in that case (and thus invalid
  /// ID is returned). IMPORTANT NOTE: This function is solely used for plugin-provided context menus. This is NOT to be
  ...
  /// IMPORTANT NOTE: This function is solely used for plugin-provided context menus. This is NOT to be used for getting
  /// the
...
public:
  ...
  /// \return The most suitable plugins if found, empty list otherwise
  QList<qSlicerSubjectHierarchyAbstractPlugin*> pluginsForReparentingItemInSubjectHierarchy(vtkIdType itemID,
  ...
  /// Note: This should happen very rarely. If happens frequently, then confidence numbers returned by plugins need
  /// review. \param textToDisplay Text assembled by the caller displaying the reason and basis (items) of the choice
  /// \param candidatePlugins List of plugins to choose from
  /// \return Plugin chosen by the user
  qSlicerSubjectHierarchyAbstractPlugin* selectPluginFromDialog(
...
private:
  ...
  friend class PythonQtWrapper_qSlicerSubjectHierarchyPluginHandler; // Allow Python wrapping without enabling direct
                                                                     // instantiation
