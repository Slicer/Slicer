...
class Q_SLICER_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qMRMLSubjectHierarchyTreeView : public QTreeView
{
  ...
  Q_PROPERTY(bool lockColumnVisible READ lockColumnVisible WRITE setLockColumnVisible)
...
public:
  ...
  /// Set lock column visibility. Hidden by default
  void setLockColumnVisible(bool visible);
  bool lockColumnVisible();
