...
public:
  ...
  /// section.
  /// \param menu will be set by inserting the actions. If it is set to nullptr then a string will be returned that
  /// contains name and "section" value of each action.
  /// \param allowedActions specifies object name of actions may be added to the menu. If the list is empty then it is
  /// ignored.
