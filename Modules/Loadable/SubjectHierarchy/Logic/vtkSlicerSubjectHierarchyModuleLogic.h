...
class VTK_SLICER_SUBJECTHIERARCHY_LOGIC_EXPORT vtkSlicerSubjectHierarchyModuleLogic : public vtkSlicerModuleLogic
{
public:
...
public:
  ...
  static vtkIdType InsertDicomSeriesInHierarchy(vtkMRMLSubjectHierarchyNode* shNode,
  ...
  static vtkIdType AreItemsInSameBranch(vtkMRMLSubjectHierarchyNode* shNode,
                                        vtkIdType item1,
                                        vtkIdType item2,
  ...
  /// \param hardenExistingTransforms Mode of handling already transformed nodes. If true (default), then the possible
  /// parent transforms
  ///   of target nodes are hardened before applying the specified transform. If false, then the already applied parent
  ///   transforms are transformed with the specified transform (Note: this latter approach may result in unwanted
  ///   transformations of other nodes)
  static void TransformBranch(vtkMRMLSubjectHierarchyNode* shNode,
                              vtkIdType itemID,
  ...
  static vtkIdType CloneSubjectHierarchyItem(vtkMRMLSubjectHierarchyNode* shNode,
                                             vtkIdType itemID,
