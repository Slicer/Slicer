...
public:
  ...
  vtkMRMLTransformNode* AddTransform(const char* filename,
                                     vtkMRMLScene* scene,
                                     vtkMRMLMessageCollection* userMessages = nullptr);

  /// Generate polydata for 2D transform visualization
  /// Return true on success.
  static bool GetVisualization2d(vtkPolyData* output_RAS,
  ...
  /// Return true on success.
  static bool GetVisualization3d(vtkPolyData* output_RAS,
                                 vtkMRMLTransformDisplayNode* displayNode,
  ...
  /// Generate polydata for 3D transform visualization
  /// Region node can be slice (vtkMRMLSliceNode), volume (vtkMRMLVolumeNode), region of interest
  /// (vtkMRMLMarkupsROINode), or model (vtkMRMLModelNode). If glyphPointsNode is specified and display mode is glyphs
  /// then the region is ignored and glyphs are drawn at the markup control points. Return true on success.
  static bool GetVisualization3d(vtkPolyData* output_RAS,
                                 vtkMRMLTransformDisplayNode* displayNode,
  ...
  /// If existingOutputVolumeNode is specified then instead of creating a new volume node, that existing node will be
  /// updated.
  vtkMRMLVolumeNode* CreateDisplacementVolumeFromTransform(vtkMRMLTransformNode* inputTransformNode,
  ...
  /// If referenceVolumeNode is specified then it will determine the origin, spacing, extent, and orientation of the
  /// displacement field. If existingOutputTransformNode is specified then instead of creating a new transform node,
  /// that existing node will be updated.
  vtkMRMLTransformNode* ConvertToGridTransform(vtkMRMLTransformNode* inputTransformNode,
                                               vtkMRMLVolumeNode* referenceVolumeNode = nullptr,
  ...
  static bool GetTransformedPointSamplesAsMagnitudeImage(vtkImageData* outputMagnitudeImage,
  ...
  /// If transformToWorld is true then transform to world is returned, otherwise transform from world is returned.
  /// Returns true on success.
  static bool GetTransformedPointSamplesAsVectorImage(vtkImageData* outputVectorImage,
                                                      vtkMRMLTransformNode* inputTransformNode,
                                                      vtkMatrix4x4* ijkToRAS,
                                                      bool transformToWorld = true);
  ...
  static void GetTransformedNodes(vtkMRMLScene* scene,
...
protected:
  ...
  /// If samplePositions_RAS is specified then those samples will be used as glyph starting points instead of a regular
  /// grid. \sa GetVisualization2d
  static void GetGlyphVisualization2d(vtkPolyData* output_RAS,
                                      vtkMRMLTransformDisplayNode* displayNode,
                                      vtkMatrix4x4* sliceToRAS,
                                      double* fieldOfViewOrigin,
                                      double* fieldOfViewSize,
  ...
  /// If samplePositions_RAS is specified then those samples will be used as glyph starting points instead of a regular
  /// grid. \sa GetVisualization3d
  static void GetGlyphVisualization3d(vtkPolyData* output_RAS,
                                      vtkMRMLTransformDisplayNode* displayNode,
                                      vtkMatrix4x4* roiToRAS,
                                      int* roiSize,
                                      vtkPoints* samplePositions_RAS = nullptr);
  ...
  static void GetGridVisualization2d(vtkPolyData* output_RAS,
                                     vtkMRMLTransformDisplayNode* displayNode,
                                     vtkMatrix4x4* sliceToRAS,
                                     double* fieldOfViewOrigin,
                                     double* fieldOfViewSize);
  ...
  static void GetGridVisualization3d(vtkPolyData* output_RAS,
                                     vtkMRMLTransformDisplayNode* displayNode,
                                     vtkMatrix4x4* roiToRAS,
                                     int* roiSize);
  ...
  /// \sa GetVisualization2d
  static void GetContourVisualization2d(vtkPolyData* output_RAS,
                                        vtkMRMLTransformDisplayNode* displayNode,
                                        vtkMatrix4x4* sliceToRAS,
                                        double* fieldOfViewOrigin,
                                        double* fieldOfViewSize);
  ...
  /// \sa GetVisualization3d
  static void GetContourVisualization3d(vtkPolyData* output_RAS,
                                        vtkMRMLTransformDisplayNode* displayNode,
                                        vtkMatrix4x4* roiToRAS,
                                        int* roiSize);
  ...
  static void CreateGrid(vtkPolyData* outputGrid_RAS,
                         vtkMRMLTransformDisplayNode* displayNode,
                         int numGridPoints[3],
  ...
  /// If transformToWorld is true then transform to world is returned, otherwise transform from world is returned.
  static void GetTransformedPointSamples(vtkPointSet* outputPointSet_RAS,
                                         vtkMRMLTransformNode* inputTransformNode,
  ...
  /// numGridPoints[3]) samplePositions_RAS: if specified then instead of a regular grid, sample points on the slice
  /// will be used
  static void GetTransformedPointSamplesOnSlice(vtkPointSet* outputPointSet_RAS,
                                                vtkMRMLTransformNode* inputTransformNode,
                                                vtkMatrix4x4* sliceToRAS,
                                                double* fieldOfViewOrigin,
                                                double* fieldOfViewSize,
  ...
  /// pointGroupSize: the number of points will be N*pointGroupSize (the actual number will be returned in
  /// numGridPoints[3])
  static void GetTransformedPointSamplesOnRoi(vtkPointSet* outputPointSet_RAS,
                                              vtkMRMLTransformNode* inputTransformNode,
                                              vtkMatrix4x4* roiToRAS,
                                              int* roiSize,
