...
void qSlicerVolumeRenderingModuleWidget::updateWidgetFromMRML()
{
  ...
  d->ClippingSoftEdgeSlider->setValue(displayNode ? displayNode->GetClippingSoftEdgeMm() : 0.0);
...
//-----------------------------------------------------------
void qSlicerVolumeRenderingModuleWidget::setSoftEdgeMm(double softEdgeMm)
{
  vtkMRMLVolumeRenderingDisplayNode* displayNode = this->mrmlDisplayNode();
  if (!displayNode)
  {
  ...
  displayNode->SetClippingSoftEdgeMm(softEdgeMm);
}
