...
class VTK_SLICER_VOLUMERENDERING_MODULE_MRML_EXPORT vtkMRMLVolumePropertyJsonStorageNode
...
protected:
  ...
  bool WriteVolumePropertyNode(
    vtkMRMLJsonWriter* writer, vtkMRMLVolumePropertyNode* volumePropertyNode);
  bool WriteVolumeProperty(
    vtkMRMLJsonWriter* writer, vtkVolumeProperty* volumeProperty, int numberOfComponents=1);
  bool WriteContourValues(
    vtkMRMLJsonWriter* writer, const char* name, vtkContourValues* contourValues);
  bool WriteTransferFunction(
    vtkMRMLJsonWriter* writer, const char* name, vtkObject* transferFunction);

  bool ReadVolumePropertyNode(
    vtkMRMLVolumePropertyNode* vpNode, vtkMRMLJsonElement* volumePropertyElement);
  bool ReadTransferFunction(
