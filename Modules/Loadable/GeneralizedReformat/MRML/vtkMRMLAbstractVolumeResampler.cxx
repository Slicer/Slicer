...
//----------------------------------------------------------------------------
std::string vtkMRMLAbstractVolumeResampler::GetParameterValue(const ResamplingParameters& parameters,
...
//----------------------------------------------------------------------------
double vtkMRMLAbstractVolumeResampler::GetParameterValueAsDouble(const ResamplingParameters& parameters,
                                                                 const std::string& name)
{
...
//----------------------------------------------------------------------------
int vtkMRMLAbstractVolumeResampler::GetParameterValueAsInt(const ResamplingParameters& parameters,
                                                           const std::string& name)
{
...
//----------------------------------------------------------------------------
void vtkMRMLAbstractVolumeResampler::SetParameterValue(ResamplingParameters& parameters,
                                                       const std::string& name,
...
//----------------------------------------------------------------------------
void vtkMRMLAbstractVolumeResampler::SetParameterValueAsDouble(ResamplingParameters& parameters,
                                                               const std::string& name,
                                                               double value)
{
...
//----------------------------------------------------------------------------
void vtkMRMLAbstractVolumeResampler::SetParameterValueAsInt(ResamplingParameters& parameters,
                                                            const std::string& name,
                                                            int value)
{
  vtkMRMLAbstractVolumeResampler::SetParameterValue(parameters, name, vtkVariant(value).ToString());
