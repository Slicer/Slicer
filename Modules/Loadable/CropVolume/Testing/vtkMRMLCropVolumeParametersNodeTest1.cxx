...
{
  vtkSmartPointer< vtkMRMLCropVolumeParametersNode > node1 = vtkSmartPointer< vtkMRMLCropVolumeParametersNode >::New();

  EXERCISE_BASIC_OBJECT_METHODS( node1 );

  node1->UpdateReferences();

  vtkSmartPointer< vtkMRMLCropVolumeParametersNode > node2 = vtkSmartPointer< vtkMRMLCropVolumeParametersNode >::New();
