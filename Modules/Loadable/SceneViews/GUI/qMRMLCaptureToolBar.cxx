...
void qMRMLCaptureToolBarPrivate::setMRMLScene(vtkMRMLScene* newScene)
{
  ...
  qvtkReconnect(
    this->MRMLScene, newScene, vtkMRMLScene::StartBatchProcessEvent, q, SLOT(OnMRMLSceneStartBatchProcessing()));
  qvtkReconnect(
    this->MRMLScene, newScene, vtkMRMLScene::EndBatchProcessEvent, q, SLOT(OnMRMLSceneEndBatchProcessing()));
...
void qMRMLCaptureToolBarPrivate::createSceneView()
{
  ...
  // Ask user for a name
  bool ok = false;
  QString sceneViewName = QInputDialog::getText(q,
                                                qMRMLCaptureToolBar::tr("SceneView Name"),
                                                qMRMLCaptureToolBar::tr("SceneView Name:"),
                                                QLineEdit::Normal,
                                                "View",
                                                &ok);
