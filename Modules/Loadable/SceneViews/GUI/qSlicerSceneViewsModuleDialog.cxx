...
void qSlicerSceneViewsModuleDialogPrivate::setupUi(QDialog* dialog)
{
  ...
  this->CaptureDisplayNodesCheckBox->setToolTip(
    qSlicerSceneViewsModuleDialog::tr("When enabled, the Scene View will store which objects are visible as well as color and transparency,"
                                      " and restore them when the Scene View is loaded.\nView layout and window arrangement are not saved."));
  ...
  this->CaptureViewNodesCheckBox->setToolTip(
    qSlicerSceneViewsModuleDialog::tr("When enabled, the Scene View will store the arrangement of"
                                      " views on the screen (for example, slice views and 3D view) and restore it when the Scene View is loaded."));
