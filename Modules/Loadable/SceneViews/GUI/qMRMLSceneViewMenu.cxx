...
void qMRMLSceneViewMenuPrivate::onMRMLNodeAdded(vtkObject* mrmlScene, vtkObject * mrmlNode)
{
  ...
  const char* sceneViewValue = sequenceBrowserNode->GetAttribute(this->SceneViewsLogic->GetSceneViewNodeAttributeName());
  if (!sceneViewValue || strcmp(sceneViewValue, this->SceneViewsLogic->GetSceneViewNodeAttributeValue()) != 0)
  {
    return;
  }
