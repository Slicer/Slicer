...
void qSlicerSceneViewsModuleWidget::moveDownSelected(QString sceneViewName)
{
  ...
  const char* id = d->logic()->MoveSceneViewDown(sceneViewName.toUtf8());
  if (id != nullptr &&
    strcmp(id, "") != 0)
  {
...
void qSlicerSceneViewsModuleWidget::moveUpSelected(QString sceneViewName)
{
  ...
  const char* id = d->logic()->MoveSceneViewUp(sceneViewName.toUtf8());
...
void qSlicerSceneViewsModuleWidget::restoreSceneView(const QString& sceneViewName)
{
  ...
  const char* sceneViewNameChar = sceneViewName.toUtf8();
  if (!d->logic()->RestoreSceneView(sceneViewNameChar))
  {
    qCritical() << "Failed to restore scene view " << sceneViewNameChar;
  }
