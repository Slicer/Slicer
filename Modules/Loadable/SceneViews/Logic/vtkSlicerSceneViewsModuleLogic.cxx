  ...
  for (vtkMRMLNode* node : savedNodesSet)
  {
    ...
    if (!sequenceNode)
    {
      ...
      if (node->GetName())
      {
        ...
        nodenameStringstream << "Sequence_" << node->GetName();
...
//---------------------------------------------------------------------------
const char* vtkSlicerSceneViewsModuleLogic::MoveSceneViewUp(const char* vtkNotUsed(sceneViewName))
{
  // reset stringHolder
  this->m_StringHolder = "";
...
//---------------------------------------------------------------------------
const char* vtkSlicerSceneViewsModuleLogic::MoveSceneViewDown(const char* vtkNotUsed(sceneViewName))
{
  // reset stringHolder
  this->m_StringHolder = "";
