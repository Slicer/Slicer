...
public:
  ...
  QColor recommendedColorForType(std::string terminologyName,
  ...
  bool findTerminology(vtkSlicerTerminologyEntry* entry,
...
public:
  /// Name (SegmentationCategoryTypeContextName) of the current terminology. Color node name if the current terminology
  /// is a color node.
...
qSlicerTerminologyNavigatorWidgetPrivate::qSlicerTerminologyNavigatorWidgetPrivate(
  qSlicerTerminologyNavigatorWidget& object)
  : q_ptr(&object)
  , NoneItemName(QString("[ ") + qSlicerTerminologyNavigatorWidget::tr("None") + QString(" ]"))
  , GeneratedColor(vtkSlicerTerminologyType::INVALID_COLOR[0],
...
void qSlicerTerminologyNavigatorWidgetPrivate::init()
{
  ...
  // Make connections
  QObject::connect(
    this->ComboBox_Terminology, SIGNAL(currentIndexChanged(int)), q, SLOT(onTerminologySelectionChanged(int)));
  QObject::connect(
    this->ComboBox_Terminology_2, SIGNAL(currentIndexChanged(int)), q, SLOT(onTerminologySelectionChanged(int)));
  QObject::connect(this->tableWidget_Category, SIGNAL(itemSelectionChanged()), q, SLOT(onCategorySelectionChanged()));
  QObject::connect(
    this->pushButton_SelectAllCategories, SIGNAL(clicked()), q, SLOT(onSelectAllCategoriesButtonClicked()));
  QObject::connect(this->tableWidget_Type,
                   SIGNAL(currentItemChanged(QTableWidgetItem*, QTableWidgetItem*)),
                   q,
                   SLOT(onTypeSelected(QTableWidgetItem*, QTableWidgetItem*)));
  QObject::connect(
    this->tableWidget_Type, SIGNAL(cellDoubleClicked(int, int)), q, SLOT(onTypeCellDoubleClicked(int, int)));
  QObject::connect(
    this->ComboBox_TypeModifier, SIGNAL(currentIndexChanged(int)), q, SLOT(onTypeModifierSelectionChanged(int)));
  QObject::connect(
    this->SearchBox_Category, SIGNAL(textChanged(QString)), q, SLOT(onCategorySearchTextChanged(QString)));
  QObject::connect(this->SearchBox_Type, SIGNAL(textChanged(QString)), q, SLOT(onTypeSearchTextChanged(QString)));

  QObject::connect(
    this->ComboBox_RegionContext, SIGNAL(currentIndexChanged(int)), q, SLOT(onRegionContextSelectionChanged(int)));
  QObject::connect(this->tableWidget_Region,
                   SIGNAL(currentItemChanged(QTableWidgetItem*, QTableWidgetItem*)),
                   q,
                   SLOT(onRegionSelected(QTableWidgetItem*, QTableWidgetItem*)));
  QObject::connect(
    this->ComboBox_RegionModifier, SIGNAL(currentIndexChanged(int)), q, SLOT(onRegionModifierSelectionChanged(int)));
  ...
  QObject::connect(
    this->ColorPickerButton_RecommendedRGB, SIGNAL(colorChanged(QColor)), q, SLOT(onColorChanged(QColor)));
  QObject::connect(this->pushButton_ResetColor, SIGNAL(clicked()), q, SLOT(onResetColorClicked()));

  QObject::connect(this->ColorTableView->selectionModel(),
                   SIGNAL(selectionChanged(QItemSelection, QItemSelection)),
                   q,
                   SLOT(onColorSelected(QItemSelection, QItemSelection)));
  QObject::connect(this->ColorTableView,
                   SIGNAL(doubleClicked(const QModelIndex&)),
                   q,
                   SLOT(onColorRowDoubleClicked(const QModelIndex&)));
...
vtkSlicerTerminologiesModuleLogic* qSlicerTerminologyNavigatorWidgetPrivate::terminologyLogic()
{
  ...
  vtkSlicerTerminologiesModuleLogic* terminologiesLogic =
    vtkSlicerTerminologiesModuleLogic::SafeDownCast(app->moduleLogic("Terminologies"));
...
QColor qSlicerTerminologyNavigatorWidgetPrivate::terminologyRecommendedColor()
{
  ...
  if (r == vtkSlicerTerminologyType::INVALID_COLOR[0] && g == vtkSlicerTerminologyType::INVALID_COLOR[1] &&
...
void qSlicerTerminologyNavigatorWidgetPrivate::setRecommendedColorFromCurrentTerminology()
{
  ...
  if (!color.isValid())
  {
    this->ColorPickerButton_RecommendedRGB->blockSignals(
      true); // The callback function is to save the user's custom color selection
...
//-----------------------------------------------------------------------------
QColor qSlicerTerminologyNavigatorWidgetPrivate::recommendedColorForType(std::string terminologyName,
                                                                         vtkSlicerTerminologyCategory* category,
                                                                         vtkSlicerTerminologyType* type)
{
  ...
  if (color.isValid() && (colorArray[0] != vtkSlicerTerminologyType::INVALID_COLOR[0] ||
  ...
  vtkSlicerTerminologiesModuleLogic::CodeIdentifier typeId =
    vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(type);
...
//-----------------------------------------------------------------------------
QTableWidgetItem* qSlicerTerminologyNavigatorWidgetPrivate::findTableWidgetItemForCategory(
  vtkSlicerTerminologyCategory* category)
{
  if (!category)
  {
  ...
  foreach (QTableWidgetItem* item, items)
  {
    QString codingSchemeDesignator =
      item->data(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole).toString();
    QString codeValue = item->data(qSlicerTerminologyNavigatorWidget::CodeValueRole).toString();
    if (category->GetCodingSchemeDesignator() &&
        !codingSchemeDesignator.compare(category->GetCodingSchemeDesignator()) && category->GetCodeValue() &&
        !codeValue.compare(category->GetCodeValue()))
    {
      return item;
    }
  }
...
//-----------------------------------------------------------------------------
QTableWidgetItem* qSlicerTerminologyNavigatorWidgetPrivate::findTableWidgetItemForType(QTableWidget* tableWidget,
                                                                                       vtkSlicerTerminologyType* type)
{
  if (!tableWidget || !type)
  {
...
//-----------------------------------------------------------------------------
int qSlicerTerminologyNavigatorWidgetPrivate::findComboBoxIndexForModifier(ctkComboBox* comboBox,
                                                                           vtkSlicerTerminologyType* modifier)
{
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateTerminologyComboBox()
{
  ...
  if (scene)
  {
    ...
    for (std::string& colorNodeId : colorNodeIds)
    {
      ...
      this->ComboBox_Terminology_2->addItem(QString::fromUtf8(colorNode->GetName()),
                                            QString::fromStdString(colorNodeId));
    }
  }
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateCategoryTable()
{
  ...
  logic->FindCategoriesInTerminology(this->CurrentTerminologyName.toUtf8().constData(),
                                     categories,
                                     this->SearchBox_Category->text().toUtf8().constData());
  ...
  for (idIt = categories.begin(); idIt != categories.end(); ++idIt, ++index)
  {
    ...
    addedCategoryItem->setData(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole,
                               QString(addedCategoryId.CodingSchemeDesignator.c_str()));
    addedCategoryItem->setData(qSlicerTerminologyNavigatorWidget::CodeValueRole,
                               QString(addedCategoryId.CodeValue.c_str()));
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateTypeTable()
{
  ...
  foreach (vtkSlicerTerminologyCategory* category, selectedCategories)
  {
    ...
    std::vector<vtkSlicerTerminologiesModuleLogic::CodeIdentifier>::iterator idIt;
    for (idIt = typesInCategory.begin(), typeObjIt = typesObjectsInCategory.begin(); idIt != typesInCategory.end();
         ++idIt, ++typeObjIt)
    {
      ...
      typeInfo.color =
        this->recommendedColorForType(this->CurrentTerminologyName.toUtf8().constData(), category, *typeObjIt);
  ...
  for (typeIt = types.begin(); typeIt != types.end(); ++typeIt, ++typeIndex)
  {
    ...
    addedTypeItem->setData(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole,
                           QString(addedTypeId.CodingSchemeDesignator.c_str()));
    ...
    addedTypeItem->setData(qSlicerTerminologyNavigatorWidget::CategoryCodingSchemeDesignatorRole,
                           QString(category->GetCodingSchemeDesignator()));
    addedTypeItem->setData(qSlicerTerminologyNavigatorWidget::CategoryCodeValueRole, QString(category->GetCodeValue()));
    addedTypeItem->setData(qSlicerTerminologyNavigatorWidget::CategoryCodeMeaningRole,
                           QString(category->GetCodeMeaning()));
    QString tooltip = QString("Category: %1 (anatomy:%2)")
                        .arg(category->GetCodeMeaning())
                        .arg((category->GetShowAnatomy() ? "available" : "N/A"));
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateTypeModifierComboBox()
{
  ...
  if (this->CurrentTerminologyName.isEmpty() || !this->CurrentCategoryObject || !this->CurrentTypeObject ||
      !this->CurrentTypeObject->GetCodeValue())
  {
    this->ComboBox_TypeModifier->setEnabled(false);
    return;
  ...
  for (idIt = typeModifiers.begin(); idIt != typeModifiers.end(); ++idIt, ++index)
  {
    ...
    userData[QString::number(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole)] =
      QString(addedTypeModifierId.CodingSchemeDesignator.c_str());
    userData[QString::number(qSlicerTerminologyNavigatorWidget::CodeValueRole)] =
      QString(addedTypeModifierId.CodeValue.c_str());
...
void qSlicerTerminologyNavigatorWidgetPrivate::setCurrentTerminology(QString terminologyName, QString colorNodeID)
{
  ...
  if (!this->TerminologyComboboxPopulating)
  {
    ...
    if (!colorNodeID.isEmpty())
    {
      vtkMRMLColorNode* colorNode =
        vtkMRMLColorNode::SafeDownCast(logic->GetMRMLScene()->GetNodeByID(colorNodeID.toUtf8()));
      if (colorNode && colorNode->GetName())
      {
  ...
  else
  {
    ...
    {
      this->tableWidget_Category->setEnabled(
        !this->SearchBox_Type->text().isEmpty()); // Might be empty because of a search
...
void qSlicerTerminologyNavigatorWidgetPrivate::copyContextToUserDirectory(QString filePath)
{
  ...
  if (!settingsFolder.exists())
  {
    qCritical() << Q_FUNC_INFO << ": Settings folder '" << settingsFolder.absolutePath()
                << "' does not exist. Copying context file failed.";
    return;
  }
  ...
  {
    QString message = QString(qSlicerTerminologyNavigatorWidget::tr(
    ...
    QMessageBox::StandardButton answer =
      QMessageBox::question(nullptr,
                            qSlicerTerminologyNavigatorWidget::tr("Context file exists"),
                            message,
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateRegionTable()
{
  ...
  logic->FindRegionsInRegionContext(
    this->CurrentRegionContextName.toUtf8().constData(), regions, this->SearchBox_Region->text().toUtf8().constData());
  ...
  for (idIt = regions.begin(); idIt != regions.end(); ++idIt, ++index)
  {
    ...
    addedRegionItem->setData(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole,
                             QString(addedRegionId.CodingSchemeDesignator.c_str()));
    addedRegionItem->setData(qSlicerTerminologyNavigatorWidget::CodeValueRole,
                             QString(addedRegionId.CodeValue.c_str()));
...
void qSlicerTerminologyNavigatorWidgetPrivate::populateRegionModifierComboBox()
{
  ...
  if (this->CurrentRegionContextName.isEmpty() || !this->CurrentRegionObject ||
      !this->CurrentRegionObject->GetCodeValue())
  {
    this->ComboBox_RegionModifier->setEnabled(false);
    return;
  ...
  for (idIt = regionModifiers.begin(); idIt != regionModifiers.end(); ++idIt, ++index)
  {
    ...
    QMap<QString, QVariant> userData;
    userData[QString::number(qSlicerTerminologyNavigatorWidget::CodingSchemeDesignatorRole)] =
      QString(addedRegionModifierId.CodingSchemeDesignator.c_str());
    userData[QString::number(qSlicerTerminologyNavigatorWidget::CodeValueRole)] =
      QString(addedRegionModifierId.CodeValue.c_str());
...
void qSlicerTerminologyNavigatorWidget::setTerminologyInfo(TerminologyInfoBundle& terminologyInfo)
{
  ...
  else
  {
    ...
    bool enableResetColor =
      !d->ColorAutoGenerated || (d->ColorPickerButton_RecommendedRGB->color() != d->terminologyRecommendedColor());
...
bool qSlicerTerminologyNavigatorWidget::terminologyEntry(vtkSlicerTerminologyEntry* entry)
{
  ...
  {
    vtkMRMLColorNode* colorNode =
      vtkMRMLColorNode::SafeDownCast(logic->GetMRMLScene()->GetNodeByID(d->CurrentColorNodeID.toUtf8()));
    if (colorNode && colorNode->GetName())
    {
      terminologyOrColorName = QString::fromUtf8(colorNode->GetName());
    }
                                                               ...
                                                               int& colorIndexInColorTable)
{
  ...
  if (logic->FindFirstColorNodeOrTerminology(
        entry, preferredTerminologyNames, foundTerminologyName, foundColorNodeID, foundColorIndexInColorTable))
  {
  ...
  else
  {
    ...
    terminologyNameToSelect = (!preferredTerminologyNames.empty() ? QString::fromStdString(preferredTerminologyNames[0])
                                                                  : this->ComboBox_Terminology->itemText(0));
...
QString qSlicerTerminologyNavigatorWidget::nameFromTerminology(vtkSlicerTerminologyEntry* entry)
{
      ...
      strlen(entry->GetRegionObject()->GetCodeValue()) > 0)
  {
    ...
    {
      //: For formatting of terminology entry name. %1 is type name (e.g., "Mass"), %2 is region name (e.g., "Kidney"),
      //: %2 is region modifier (e.g., "Left")
      name = tr("%1 in %2, %3")
               .arg(name)
...
{
  Q_D(qSlicerTerminologyNavigatorWidget);
  if (!d->CurrentTypeObject || (d->CurrentTypeObject->GetHasModifiers() && !d->CurrentTypeModifierObject))
  {
    // Incomplete terminology selection, name is empty
    return QString();
  }
...
void qSlicerTerminologyNavigatorWidget::onTerminologySelectionChanged(int index)
{
  ...
  ctkComboBox* visibleComboBox =
    (d->ComboBox_Terminology->isVisible() ? d->ComboBox_Terminology : d->ComboBox_Terminology_2);
  ctkComboBox* invisibleComboBox =
    (!d->ComboBox_Terminology->isVisible() ? d->ComboBox_Terminology : d->ComboBox_Terminology_2);
                                                        ...
                                                        const QItemSelection& deselected)
{
  ...
  if (colorNode->GetTerminologyCategory(colorIndex) == nullptr ||
      ...
      colorNode->GetTerminologyType(colorIndex) == nullptr ||
      colorNode->GetTerminologyType(colorIndex)->GetCodeMeaning() == nullptr)
  {
    qCritical() << Q_FUNC_INFO << ": Invalid terminology in selected color (" << colorNode->GetName() << ": "
                << colorIndex << ")";
    emit selectionValidityChanged(false);
    return;
  }
...
{
  Q_D(qSlicerTerminologyNavigatorWidget);
  const QString& terminologyFileName = QFileDialog::getOpenFileName(
    this, "Select terminology json file...", QString(), "Json files (*.json);; All files (*)");
  if (!terminologyFileName.isEmpty())
  {
    ...
    if (!loadedContextName.isEmpty())
    {
      QMessageBox::information(
        this, "Load succeeded", QString("Loading terminology context named %1 succeeded").arg(loadedContextName));
    ...
    else
    {
      QString errorMessage = "Loading terminology from file %1 failed!<br><br>"
                             "Please check validity of the file using the <a "
                             "href=\"https://qiicr.org/dcmqi/#/validators\">online validator tool</a>.";
...
{
  Q_D(qSlicerTerminologyNavigatorWidget);
  const QString& regionContextFileName = QFileDialog::getOpenFileName(
    this, "Select region context json file...", QString(), "Json files (*.json);; All files (*)");
  if (!regionContextFileName.isEmpty())
  {
    ...
    {
      QMessageBox::information(
        this, "Load succeeded", QString("Loading region context named %1 succeeded").arg(loadedContextName));
