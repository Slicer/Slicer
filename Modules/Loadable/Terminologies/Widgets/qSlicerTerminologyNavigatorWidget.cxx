...
void qSlicerTerminologyNavigatorWidget::terminologyInfo(TerminologyInfoBundle& terminologyInfo)
{
  ...
  terminologyInfo.GeneratedColor = d->GeneratedColor;
}
...
bool qSlicerTerminologyNavigatorWidget::setTerminologyEntry(vtkSlicerTerminologyEntry* entry)
{
  ...
  else
  {
    ...
    // Get additional metadata (such as recommended display RGB value or 3D Slicer label) by getting type object from terminology.
    vtkNew<vtkSlicerTerminologyType> resolvedTypeObject;
    if (logic && categoryObject && typeObject)
    {
      vtkSlicerTerminologiesModuleLogic::CodeIdentifier categoryId = vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(categoryObject);
      vtkSlicerTerminologiesModuleLogic::CodeIdentifier typeId = vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(typeObject);
      if (logic->GetTypeInTerminologyCategory(d->CurrentTerminologyName.toStdString(), categoryId, typeId, resolvedTypeObject))
      {
        typeObject = resolvedTypeObject;
      }
    }
    ...
    {
      vtkNew<vtkSlicerTerminologyType> resolvedTypeModifierObject;
      if (logic && categoryObject)
      {
        vtkSlicerTerminologiesModuleLogic::CodeIdentifier categoryId = //
          vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(categoryObject);
        vtkSlicerTerminologiesModuleLogic::CodeIdentifier typeId = //
          vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(typeObject);
        vtkSlicerTerminologiesModuleLogic::CodeIdentifier typeModifierId = //
          vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(typeModifierObject);
        if (logic->GetTypeModifierInTerminologyType(d->CurrentTerminologyName.toStdString(), categoryId, typeId, typeModifierId, resolvedTypeModifierObject))
        {
          typeModifierObject = resolvedTypeModifierObject;
        }
      }
...
QString qSlicerTerminologyNavigatorWidget::nameFromCurrentTerminology()
{
  ...
  // Serialized terminology entries may only contain code triples and not 3dSlicerLabel.
  // Resolve full terminology objects from logic so reset-name uses the same generated label
  // as interactive terminology selection.
  vtkSlicerTerminologiesModuleLogic* logic = d->terminologyLogic();
  if (logic && !d->CurrentTerminologyName.isEmpty())
  {
    vtkSlicerTerminologiesModuleLogic::CodeIdentifier categoryId = //
      vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(terminologyEntry->GetCategoryObject());
    vtkSlicerTerminologiesModuleLogic::CodeIdentifier typeId = //
      vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(terminologyEntry->GetTypeObject());

    vtkNew<vtkSlicerTerminologyType> resolvedType;
    if (logic->GetTypeInTerminologyCategory(d->CurrentTerminologyName.toStdString(), categoryId, typeId, resolvedType))
    {
      terminologyEntry->GetTypeObject()->Copy(resolvedType);

      if (resolvedType->GetHasModifiers() && terminologyEntry->GetTypeModifierObject() && terminologyEntry->GetTypeModifierObject()->GetCodeValue())
      {
        vtkSlicerTerminologiesModuleLogic::CodeIdentifier modifierId =
          vtkSlicerTerminologiesModuleLogic::GetCodeIdentifierFromCodedEntry(terminologyEntry->GetTypeModifierObject());
        vtkNew<vtkSlicerTerminologyType> resolvedModifier;
        if (logic->GetTypeModifierInTerminologyType(d->CurrentTerminologyName.toStdString(), categoryId, typeId, modifierId, resolvedModifier))
        {
          terminologyEntry->GetTypeModifierObject()->Copy(resolvedModifier);
        }
      }
    }
  }
