...
{
  if (QSettings().value(this->TerminologySelectorSettingsKey).toBool() == false)
  {
...
//------------------------------------------------------------------------------
void qSlicerTerminologyItemDelegate::setTerminologySelectorSettingsKey(QString settingsKey)
{
  this->TerminologySelectorSettingsKey = settingsKey;
}
