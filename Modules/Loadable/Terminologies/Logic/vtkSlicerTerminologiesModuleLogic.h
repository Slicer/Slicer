...
public:
  ...
  public:
    ...
    bool IsValid() const { return !CodingSchemeDesignator.empty() && !CodeValue.empty(); };
  ...
  /// \param preferredTerminologyNames List of terminology names in order of preference. If an empty list is provided
  /// then all terminologies are searched.
  /// \param foundColorIndices if specified then it will contain the indices of the found colors in the color table.
  /// \param foundPreferredColorNodeIndices if specified then it will contain the indices of the found color nodes in
  /// the preferredColorNodeNames list.
  std::vector<std::string> FindColorNodes(std::string categoryCodingSchemeDesignator,
  ...
  std::vector<std::string> FindTerminologyNames(std::string categoryCodingSchemeDesignator,
                                                std::string categoryCodeValue,
                                                std::string typeCodingSchemeDesignator,
                                                std::string typeCodeValue,
                                                std::string typeModifierCodingSchemeDesignator,
  ...
  bool FindFirstColorNodeOrTerminology(vtkSlicerTerminologyEntry* entry,
                                       std::vector<std::string> preferredTerminologyNames,
  ...
  /// \param foundColorNodeID found color node ID (empty if terminology was found)
  /// \param foundColorIndex found color index in the color node (-1 if color was not found in the table)
  bool FindFirstColorNodeOrTerminology(std::string categoryCodingSchemeDesignator,
                                       std::string categoryCodeValue,
                                       std::string typeCodingSchemeDesignator,
                                       std::string typeCodeValue,
                                       std::string typeModifierCodingSchemeDesignator,
  ...
  /// \param preferredRegionContextNames List of region context names in order of preference. If an empty list is
  /// provided then all context are searched.
  std::vector<std::string> FindRegionContextNames(std::string regionCodingSchemeDesignator,
                                                  std::string regionCodeValue,
                                                  std::string regionModifierCodingSchemeDesignator,
                                                  std::string regionModifierCodeValue,
  ...
  ///   from the types found in the given terminology category
  /// \param typeObjects Output argument containing all the \sa type objects in the category.. This is useful if type
  /// objects
  ///   need to be retrieved for a large number of types, because it avoids the need to do a costly search in the json
  ///   tree.
  /// \return Success flag
  ...
  /// \return Success flag
  bool GetNthRegionInRegionContext(std::string regionContextName,
                                   int regionIndex,
                                   vtkSlicerTerminologyType* regionObject);

  /// Get all region names (codeMeaning) in an context
  /// \return Success flag
  bool FindRegionsInRegionContext(std::string regionContextName,
  ...
  /// \return Success flag
  bool GetRegionInRegionContext(std::string regionContextName,
  ...
  /// \return Success flag
  bool GetRegionModifiersInRegion(std::string regionContextName,
                                  CodeIdentifier regionId,
  ...
  /// \param regionModifierIndex index of region to return, must be between 0 and
  /// GetNumberOfRegionsInRegionContext(...)-1
  /// \param regionModifier found region modifier object
  /// \return Success flag
  bool GetNthRegionModifierInRegion(std::string regionContextName,
                                    vtkSlicerTerminologyType* regionObject,
  ...
  static int GetColorIndexByTerminology(vtkMRMLColorNode* colorNode,
  ...
  bool GetNthRegionInAnatomicContext(std::string anatomicContextName,
                                     int regionIndex,
                                     vtkSlicerTerminologyType* regionObject);
  ...
  int GetNumberOfRegionModifierInAnatomicRegion(std::string anatomicContextName,
                                                vtkSlicerTerminologyType* regionObject);
  /// \deprecated Use GetNthRegionModifierInRegion instead.
  bool GetNthRegionModifierInAnatomicRegion(std::string anatomicContextName,
                                            vtkSlicerTerminologyType* regionObject,
                                            int regionModifierIndex,
                                            vtkSlicerTerminologyType* regionModifier);
