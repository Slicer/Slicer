#ifndef __vtkIntegratedNavigationMRMLManager_h
#define __vtkIntegratedNavigationMRMLManager_h
...
class VTK_IGT_EXPORT vtkIntegratedNavigationMRMLManager : 
  public vtkObject
{
public:
  static vtkIntegratedNavigationMRMLManager *New();
  vtkTypeMacro(vtkIntegratedNavigationMRMLManager,vtkObject);
...
private:
  ...
  ~vtkIntegratedNavigationMRMLManager();
  vtkIntegratedNavigationMRMLManager(const vtkIntegratedNavigationMRMLManager&);
  void operator=(const vtkIntegratedNavigationMRMLManager&);
