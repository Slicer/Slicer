/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper.cxx,v $
  Language:  C++
...
vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper::vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper()
{
}

// Destruct a vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper - clean up any memory used
vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper::~vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper()
{
}
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneSimpleNN( T *data, 
                                                   int threadID,
                                                   int threadCount,
...
// Finally we move on to the next sample along the ray.
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneNN( T *data, 
                                             int threadID,
                                             int threadCount,
                                             vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                             vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageTwoDependentNN( T *data, 
                                                      int threadID,
                                                      int threadCount,
                                                      vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                      vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageFourDependentNN( T *data, 
                                                       int threadID,
                                                       int threadCount,
                                                       vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                       vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageIndependentNN( T *data, 
                                                     int threadID,
                                                     int threadCount,
                                                     vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                     vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneSimpleTrilin( T *data, 
                                                       int threadID,
                                                       int threadCount,
                                                       vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                       vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneTrilin( T *data, 
                                                 int threadID,
                                                 int threadCount,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                 vtkVolume *vol)
...
// the ray.
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageTwoDependentTrilin( T *data, 
                                                          int threadID,
                                                          int threadCount,
                                                          vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                          vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageFourDependentTrilin( T *data, 
                                                           int threadID,
                                                           int threadCount,
                                                           vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                           vtkVolume *vol)
...
// move on to the next sample along the ray.
template <class T>
void vtkSlicerFixedPointCompositeShadeHelperGenerateImageIndependentTrilin( T *data, 
                                                         int threadID,
                                                         int threadCount,
                                                         vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                         vtkVolume *vol)
...
void vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper::GenerateImage( int threadID,
                                                 int threadCount,
                                                 vtkVolume *vol,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper )
{
    ...
    if ( mapper->GetInput()->GetNumberOfScalarComponents() == 1 )
      ...
      if ( mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneSimpleNN(
              (VTK_TT *)(data),
    ...
    // Dependent (color) components
      ...
      if ( mapper->GetInput()->GetNumberOfScalarComponents() == 2 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeShadeHelperGenerateImageTwoDependentNN(
              (VTK_TT *)(data),
              threadID, threadCount, mapper, vol) );
          }
        }
      ...
      // specify color and the fourth specifies opacity (through a lookup table)
        ...
        if ( scalarType == VTK_UNSIGNED_CHAR )
          {
          vtkSlicerFixedPointCompositeShadeHelperGenerateImageFourDependentNN( 
    ...
    if ( mapper->GetInput()->GetNumberOfScalarComponents() == 1 )
      ...
      // Scale != 1.0 or shift != 0.0 - must apply scale/shift in inner loop
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeShadeHelperGenerateImageOneTrilin(
              (VTK_TT *)(data),
              threadID, threadCount, mapper, vol) );
          }
        }
...
// Print method for vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper
void vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper::PrintSelf(ostream& os, vtkIndent indent)
{
