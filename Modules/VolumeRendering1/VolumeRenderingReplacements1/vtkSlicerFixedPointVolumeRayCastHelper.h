/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastHelper.h,v $
...
#ifndef __vtkSlicerFixedPointVolumeRayCastHelper_h
#define __vtkSlicerFixedPointVolumeRayCastHelper_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS1_EXPORT vtkSlicerFixedPointVolumeRayCastHelper : public vtkObject
{
public:
...
private:
  vtkSlicerFixedPointVolumeRayCastHelper(const vtkSlicerFixedPointVolumeRayCastHelper&);  // Not implemented.
  void operator=(const vtkSlicerFixedPointVolumeRayCastHelper&);  // Not implemented.
};
