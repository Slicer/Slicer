...
public:
  ...
  //void SetHandleProperty(int index,vtkProperty handleProperty)
  //{
  //    if(index<0||index>7)
  //    {
  //        vtkErrorMacro("only index values between 0 and 7 are valid"); 
  //    }
  //    this->HandleProperties[index]=handleProperty;
  //}
