/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastCompositeHelper.cxx,v $
  Language:  C++
...
vtkCxxRevisionMacro(vtkSlicerFixedPointVolumeRayCastCompositeHelper, "$Revision: 1.5 $");
vtkStandardNewMacro(vtkSlicerFixedPointVolumeRayCastCompositeHelper);

// Construct a new vtkSlicerFixedPointVolumeRayCastCompositeHelper with default values
vtkSlicerFixedPointVolumeRayCastCompositeHelper::vtkSlicerFixedPointVolumeRayCastCompositeHelper()
{
}

// Destruct a vtkSlicerFixedPointVolumeRayCastCompositeHelper - clean up any memory used
vtkSlicerFixedPointVolumeRayCastCompositeHelper::~vtkSlicerFixedPointVolumeRayCastCompositeHelper()
{
}
...
void vtkSlicerFixedPointVolumeRayCastCompositeHelper::GenerateImage( int threadID,
                                                 int threadCount,
                                                 vtkVolume *vol,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper )
{
...
// Print method for vtkSlicerFixedPointVolumeRayCastCompositeHelper
void vtkSlicerFixedPointVolumeRayCastCompositeHelper::PrintSelf(ostream& os, vtkIndent indent)
{
