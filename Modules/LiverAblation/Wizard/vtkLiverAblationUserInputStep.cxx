...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkLiverAblationUserInputStep);
vtkCxxRevisionMacro(vtkLiverAblationUserInputStep, "$Revision: 1.4 $");
...
//----------------------------------------------------------------------------
void vtkLiverAblationUserInputStep::ShowUserInterface()
{
...
void vtkLiverAblationUserInputStep::CustomizeButtonCallback()
{
...
void vtkLiverAblationUserInputStep::GoToNavButtonCallback()
{
...
bool vtkLiverAblationUserInputStep::CheckInputErrors()
{
  bool error = false;
...
//---------------------------------------------------------------------------
void vtkLiverAblationUserInputStep::UpdateLabelmapSourceMenu()
{
...
//----------------------------------------------------------------------------
void vtkLiverAblationUserInputStep::PrintSelf(ostream& os, vtkIndent indent)
{
...
vtkLiverAblationUserInputStep::LabeledVolumeType::Pointer vtkLiverAblationUserInputStep::AddAblationMarginAndResample(double ablationMargin,
                                                        double noPassMargin,
...
vtkLiverAblationUserInputStep::LabeledVolumeType::Pointer vtkLiverAblationUserInputStep::dilateLabeledVolume(LabeledVolumeType::Pointer inputVolume,
...
void vtkLiverAblationUserInputStep::Customize(LabeledVolumeType::Pointer labeledVolume)
{
