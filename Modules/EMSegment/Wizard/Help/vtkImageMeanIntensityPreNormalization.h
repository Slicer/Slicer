...
=========================================================================auto=*/
// .NAME vtkImageMeanIntensityPreNormalization

#ifndef __vtkImageMeanIntensityPreNormalization_h
#define __vtkImageMeanIntensityPreNormalization_h
...
class VTK_EMSEGMENT_EXPORT vtkImageMeanIntensityPreNormalization : public vtkImageToImageFilter
{
  public:
  static vtkImageMeanIntensityPreNormalization *New();
  vtkTypeMacro(vtkImageMeanIntensityPreNormalization,vtkImageToImageFilter);
  ...
  //vtkSetMacro(NormValRec,double);
  //vtkGetMacro(NormValRec,double);
...
protected:
  ...
  vtkImageMeanIntensityPreNormalization();
  vtkImageMeanIntensityPreNormalization(const vtkImageMeanIntensityPreNormalization&) {};
  ~vtkImageMeanIntensityPreNormalization();

  void operator=(const vtkImageMeanIntensityPreNormalization&) {};
