/*=auto=======================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkITKTransformAdapter.h,v $
...
class VTK_EMSEGMENT_EXPORT vtkITKTransformAdapter : public vtkWarpTransform
{
public:
...
protected:
  ...
  void ForwardTransformPoint(const float in[3], float out[3])
  {
    ...
    this->ITKTMP_outputPoint = this->ITKTransform->TransformPoint(this->
        ITKTMP_point);
  ...
  void ForwardTransformPoint(const double in[3], double out[3])
  {
    ...
    this->ITKTMP_outputPoint = this->ITKTransform->TransformPoint(
        this->ITKTMP_point);
