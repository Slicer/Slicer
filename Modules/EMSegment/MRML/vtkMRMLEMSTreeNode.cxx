/*=auto=======================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLEMSTreeNode.cxx,v$
...
//----------------------------------------------------------------------------
vtkMRMLEMSTreeNode* vtkMRMLEMSTreeNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLEMSTreeNode");
...
//----------------------------------------------------------------------------
vtkMRMLNode* vtkMRMLEMSTreeNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLEMSTreeNode");
...
//----------------------------------------------------------------------------
void vtkMRMLEMSTreeNode::UpdateReferenceID(const char* oldID, const char*
    newID)
{
...
void vtkMRMLEMSTreeNode::UpdateReferences()
{
  ...
  if (this->ParentNodeID != NULL && this->Scene->GetNodeByID(this->
        ParentNodeID) == NULL)
  {
    this->SetParentNodeID(NULL);
  }

  if (this->TreeParametersNodeID != NULL && this->Scene->GetNodeByID(this->
        TreeParametersNodeID) == NULL)
  {
    this->SetTreeParametersNodeID(NULL);
  }
  ...
  {
    if (childIDsCopy[i].empty() || this->Scene->GetNodeByID(
          childIDsCopy[i].c_str()) != NULL)
    {
...
//----------------------------------------------------------------------------
const char* vtkMRMLEMSTreeNode::GetNthChildNodeID(int n)
{
...
//----------------------------------------------------------------------------
int vtkMRMLEMSTreeNode::GetChildIndexByMRMLID(const char* childID)
{
...
//----------------------------------------------------------------------------
vtkMRMLEMSTreeNode* vtkMRMLEMSTreeNode::GetParentNode()
{
...
//----------------------------------------------------------------------------
vtkMRMLEMSTreeParametersNode* vtkMRMLEMSTreeNode::GetParametersNode()
{
...
//----------------------------------------------------------------------------
vtkMRMLEMSTreeNode* vtkMRMLEMSTreeNode::GetNthChildNode(int n)
{
  vtkMRMLEMSTreeNode* node = NULL;

  if (this->GetScene() && this->GetNthChildNodeID(n))
    {
    vtkMRMLNode* snode = this->GetScene()->GetNodeByID(this->
        GetNthChildNodeID(n));
...
//----------------------------------------------------------------------------
void vtkMRMLEMSTreeNode::MoveNthChildNode(int fromIndex, int toIndex)
{
  std::string movingParam = this->ChildNodeIDs[fromIndex];

  this->ChildNodeIDs.erase( this->ChildNodeIDs.begin()+fromIndex);
  this->ChildNodeIDs.insert(this->ChildNodeIDs.begin()+toIndex, movingParam);
...
//----------------------------------------------------------------------------
void vtkMRMLEMSTreeNode::RemoveNthChildNode(int n)
{
...
//----------------------------------------------------------------------------
void vtkMRMLEMSTreeNode::AddChildNode(const char* mrmlID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLEMSTreeNode::SetNthChildNode(int n, const char* mrmlID)
{
