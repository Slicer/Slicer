/*=auto=======================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLEMSSegmenterNode.cxx,v$
...
//----------------------------------------------------------------------------
vtkMRMLNode* vtkMRMLEMSSegmenterNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance(
      "vtkMRMLEMSSegmenterNode");
...
//----------------------------------------------------------------------------
void vtkMRMLEMSSegmenterNode::UpdateReferenceID(const char* oldID, const char*
    newID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLEMSSegmenterNode::UpdateReferences()
{
...
//----------------------------------------------------------------------------
vtkMRMLEMSTemplateNode* vtkMRMLEMSSegmenterNode::GetTemplateNode()
{
  vtkMRMLEMSTemplateNode* node = NULL;

  if (this->GetScene() && this->GetTemplateNodeID())
    {
    vtkMRMLNode* snode = this->GetScene()->GetNodeByID(this->TemplateNodeID);
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkMRMLEMSSegmenterNode::GetOutputVolumeNode()
{
...
//----------------------------------------------------------------------------
vtkMRMLEMSWorkingDataNode* vtkMRMLEMSSegmenterNode::GetWorkingDataNode()
{
