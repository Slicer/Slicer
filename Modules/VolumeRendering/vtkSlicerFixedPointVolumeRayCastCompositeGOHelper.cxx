/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastCompositeGOHelper.cxx,v $
  Language:  C++
...
vtkCxxRevisionMacro(vtkSlicerFixedPointVolumeRayCastCompositeGOHelper, "$Revision: 1.5 $");
vtkStandardNewMacro(vtkSlicerFixedPointVolumeRayCastCompositeGOHelper);

// Construct a new vtkSlicerFixedPointVolumeRayCastCompositeGOHelper with default values
vtkSlicerFixedPointVolumeRayCastCompositeGOHelper::vtkSlicerFixedPointVolumeRayCastCompositeGOHelper()
{
}

// Destruct a vtkSlicerFixedPointVolumeRayCastCompositeGOHelper - clean up any memory used
vtkSlicerFixedPointVolumeRayCastCompositeGOHelper::~vtkSlicerFixedPointVolumeRayCastCompositeGOHelper()
{
}
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageOneSimpleNN( T *data, 
                                                   int threadID,
                                                   int threadCount,
...
// Finally we move on to the next sample along the ray.
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageOneNN( T *data, 
                                             int threadID,
                                             int threadCount,
                                             vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                             vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageTwoDependentNN( T *data, 
                                                      int threadID,
                                                      int threadCount,
                                                      vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                      vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageFourDependentNN( T *data, 
                                                         int threadID,
                                                         int threadCount,
                                                         vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                         vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageIndependentNN( T *data, 
                                                     int threadID,
                                                     int threadCount,
                                                     vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                     vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageOneSimpleTrilin( T *data, 
                                                       int threadID,
                                                       int threadCount,
                                                       vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                       vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageOneTrilin( T *data, 
                                                 int threadID,
                                                 int threadCount,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                 vtkVolume *vol)
...
// the ray.
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageTwoDependentTrilin( T *data, 
                                                          int threadID,
                                                          int threadCount,
                                                          vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                          vtkVolume *vol)
...
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageFourDependentTrilin( T *data, 
                                                             int threadID,
                                                             int threadCount,
                                                             vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                             vtkVolume *vol)
...
// move on to the next sample along the ray.
template <class T>
void vtkSlicerFixedPointCompositeGOHelperGenerateImageIndependentTrilin( T *data, 
                                                         int threadID,
                                                         int threadCount,
                                                         vtkSlicerFixedPointVolumeRayCastMapper *mapper,
                                                         vtkVolume *vol)
...
void vtkSlicerFixedPointVolumeRayCastCompositeGOHelper::GenerateImage( int threadID,
                                                 int threadCount,
                                                 vtkVolume *vol,
                                                 vtkSlicerFixedPointVolumeRayCastMapper *mapper )
{
  ...
  if ( mapper->ShouldUseNearestNeighborInterpolation( vol ) )
    ...
    if ( mapper->GetInput()->GetNumberOfScalarComponents() == 1 )
      ...
      if ( mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeGOHelperGenerateImageOneSimpleNN(
              (VTK_TT *)(data),
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeGOHelperGenerateImageOneNN(
              (VTK_TT *)(data),
              threadID, threadCount, mapper, vol) );
          }
        }
    ...
    // More that one independent components
      ...
      switch ( scalarType )
        {
        vtkTemplateMacro( 
          vtkSlicerFixedPointCompositeGOHelperGenerateImageIndependentNN( 
            (VTK_TT *)(data),
            threadID, threadCount, mapper, vol) );
        }
      }
    // Dependent (color) components
      ...
      // specify color and the fourth specifies opacity (through a lookup table)
        ...
        if ( scalarType == VTK_UNSIGNED_CHAR )
          {
          vtkSlicerFixedPointCompositeGOHelperGenerateImageFourDependentNN(
  ...
  // Trilinear Interpolation
    ...
    if ( mapper->GetInput()->GetNumberOfScalarComponents() == 1 )
      ...
      if ( mapper->GetTableScale()[0] == 1.0 && mapper->GetTableShift()[0] == 0.0 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeGOHelperGenerateImageOneSimpleTrilin(
              (VTK_TT *)(data),
              threadID, threadCount, mapper, vol) );
          }
        }
    ...
    // Indepedent components (more than one)
      ...
      switch ( scalarType )
        {
        vtkTemplateMacro( 
          vtkSlicerFixedPointCompositeGOHelperGenerateImageIndependentTrilin(
            (VTK_TT *)(data),
            threadID, threadCount, mapper, vol) );
        }
      }
    // Dependent components
      ...
      if ( mapper->GetInput()->GetNumberOfScalarComponents() == 2 )
        ...
        switch ( scalarType )
          {
          vtkTemplateMacro( 
            vtkSlicerFixedPointCompositeGOHelperGenerateImageTwoDependentTrilin(
              (VTK_TT *)(data),
              threadID, threadCount, mapper, vol) );
          }
        }
      ...
      // specify color and the fourth specifies opacity (through a lookup table)
        ...
        if ( scalarType == VTK_UNSIGNED_CHAR )
          {
          vtkSlicerFixedPointCompositeGOHelperGenerateImageFourDependentTrilin(
            static_cast<unsigned char *>(data), threadID, threadCount, mapper, vol );
          }
        else
          {
...
// Print method for vtkSlicerFixedPointVolumeRayCastCompositeGOHelper
void vtkSlicerFixedPointVolumeRayCastCompositeGOHelper::PrintSelf(ostream& os, vtkIndent indent)
{
