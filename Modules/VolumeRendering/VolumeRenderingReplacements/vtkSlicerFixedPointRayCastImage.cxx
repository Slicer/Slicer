/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointRayCastImage.cxx,v $
...
vtkCxxRevisionMacro(vtkSlicerFixedPointRayCastImage, "$Revision: 1.3 $");
vtkStandardNewMacro(vtkSlicerFixedPointRayCastImage);

// Construct a new vtkSlicerFixedPointRayCastImage with default values
vtkSlicerFixedPointRayCastImage::vtkSlicerFixedPointRayCastImage()
{
...
// Destruct a vtkSlicerFixedPointRayCastImage - clean up any memory used
vtkSlicerFixedPointRayCastImage::~vtkSlicerFixedPointRayCastImage()
{
  delete [] this->Image;
  delete [] this->ZBuffer;
...
// Allocate memory
void vtkSlicerFixedPointRayCastImage::AllocateImage()
{
  delete [] this->Image;
  this->Image = NULL;
...
// Clear image to 0
void vtkSlicerFixedPointRayCastImage::ClearImage()
{
...
void vtkSlicerFixedPointRayCastImage::AllocateZBuffer()
{
...
float vtkSlicerFixedPointRayCastImage::GetZBufferValue(int x, int y)
{
  if ( !this->UseZBuffer )
    {
    return 1.0;
...
void vtkSlicerFixedPointRayCastImage::PrintSelf(ostream& os, vtkIndent indent)
{
