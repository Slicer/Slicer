...
void vtkSlicerGPURayCastVolumeMapper::SetupRayCastParameters(vtkRenderer *pRen, vtkVolume *pVol)
{
  double bounds[6];
...
void vtkSlicerGPURayCastVolumeMapper::LoadNoShadingFragmentShaderMIP()
{
...
void vtkSlicerGPURayCastVolumeMapper::LoadNoShadingFragmentShaderMINIP()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec4 Position;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeMapper::LoadNoShadingFragmentShader()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec4 Position;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeMapper::LoadFragmentShader()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec4 Position;                                                                 \n"
        ...
        "    {                                                                                       \n"
        "        vec4 scalar = texture3D(TextureVol, coord);                                         \n"
        "        g_normalA = voxelNormalA(coord);                                                    \n"
        "        color = texture2D(TextureColorLookup, vec2(scalar.x, length(g_normalA)));            \n"
        "    }                                                                                       \n"
        "    return color;                                                                       \n"
        "}                                                                                          \n"
        "                                                                                           \n"
        ...
        "    {                                                                                       \n"
        "        vec4 scalar = texture3D(TextureVol, coord);                                         \n"
        "        g_normalB = voxelNormalB(coord);                                                   \n"
        "        color = texture2D(TextureColorLookup, vec2(scalar.y, length(g_normalB) ));          \n"
        "    }                                                                                       \n"
        "    return color;                                                                       \n"
        "}                                                                                          \n"
        "                                                                                        \n"
