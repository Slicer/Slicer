/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerOpenGLRayCastImageDisplayHelper.cxx,v $
...
//
void vtkSlicerOpenGLRayCastImageDisplayHelper::RenderTexture( vtkVolume *vol, 
                                                        vtkRenderer *ren,
...
void vtkSlicerOpenGLRayCastImageDisplayHelper::RenderTextureInternal( vtkVolume *vol, 
                                                                vtkRenderer *ren,
                                                                int imageMemorySize[2],
                                                                int imageViewportSize[2],
                                                                int imageInUseSize[2],
...
void vtkSlicerOpenGLRayCastImageDisplayHelper::PrintSelf(ostream& os, vtkIndent indent)
{
