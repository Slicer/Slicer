...
from slicer import vtkMRMLScalarVolumeNode, vtkMRMLPlotSeriesNode, vtkMRMLTableNode, vtkMRMLMarkupsLineNode
...
class LineProfileParameterNode:
    ...
    inputLine: vtkMRMLMarkupsLineNode
...
class LineProfileWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: Optional[LineProfileParameterNode]) -> None:
        """
