...
class DICOMExportScene:
    ...
    def createDICOMFileForScene(self):
        ...
        self.progress(_('Saving scene into MRB...'))
        ...
        self.progress(_('Making dicom reference file...'))
...
"""
        ...
        self.progress(_('Encapsulating scene in DICOM dump...'))
        ...
        seriesDescription = _('Slicer Data Bundle') if self.seriesDescription is None else str(self.seriesDescription)
        args = [
        ...
        self.progress(_('Creating DICOM binary file...'))
        DICOMLib.DICOMCommand('img2dcm', args).start()

        self.progress(_('Deleting temporary files...'))
        os.remove(zipFile)
        os.remove(dumpFile)
