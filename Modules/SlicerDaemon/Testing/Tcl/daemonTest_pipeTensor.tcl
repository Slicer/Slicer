...
tclsh $::env(SLICER_HOME)/lib/Slicer3/Modules/SlicerDaemon/Tcl/slicerget.tcl $tensor_name | \
tclsh $::env(SLICER_HOME)/lib/Slicer3/Modules/SlicerDaemon/Tcl/slicerput.tcl $piped_tensor_name"
