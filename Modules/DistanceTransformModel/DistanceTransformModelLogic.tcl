...
#
proc DistanceTransformModelAddQuickModel { sliceLogic } {
  ...
  eval $modelDisplayNode SetColor [lrange [DistanceTransformModelGetPaintColor $::DistanceTransformModel(singleton)] 0 2]
...
#
proc DistanceTransformModelLabelCheckpoint {} {
...
#
proc DistanceTransformModelTestQuickModel {} {
  set sliceLogic [lindex [vtkSlicerSliceLogic ListInstances] 0]
  DistanceTransformModelAddQuickModel $sliceLogic
}
