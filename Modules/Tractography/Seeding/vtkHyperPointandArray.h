...
//BTX
class VTK_SLICERTRACTOGRAPHYSEEDING_EXPORT vtkHyperPoint { //;prevent man page generation
public:
...
//BTX
class VTK_SLICERTRACTOGRAPHYSEEDING_EXPORT vtkHyperArray { //;prevent man page generation
public:
  vtkHyperArray();
  ~vtkHyperArray()
    {
