/*=========================================================================
  ...
  Module:    $RCSfile: vtkDisplayableManagerBoxRepresentation.h,v $
...
=========================================================================*/
///  vtkDisplayableManagerBoxRepresentation - a class defining the representation for the vtkDisplayableManagerBoxWidget2
/// 
/// This class is a concrete representation for the vtkDisplayableManagerBoxWidget2. It
...
//
/// .SECTION Caveats
/// This class, and vtkDisplayableManagerBoxWidget2, are second generation VTK
/// widgets. An earlier version of this functionality was defined in the
/// class vtkSlicerBoxWidget.

/// .SECTION See Also
/// vtkDisplayableManagerBoxWidget2 vtkSlicerBoxWidget


#ifndef __vtkDisplayableManagerBoxRepresentation_h
#define __vtkDisplayableManagerBoxRepresentation_h
...
class  VTK_MRML_DISPLAYABLEMANAGER_EXPORT vtkDisplayableManagerBoxRepresentation : public vtkWidgetRepresentation
{
public:
  /// 
  /// Instantiate the class.
  static vtkDisplayableManagerBoxRepresentation *New();

  /// 
  /// Standard methods for the class.
  vtkTypeRevisionMacro(vtkDisplayableManagerBoxRepresentation,vtkWidgetRepresentation);
...
//ETX
  ...
  /// 
  /// The interaction state may be set from a widget (e.g., vtkDisplayableManagerBoxWidget2) or
...
protected:
  vtkDisplayableManagerBoxRepresentation();
  ~vtkDisplayableManagerBoxRepresentation();
...
private:
  vtkDisplayableManagerBoxRepresentation(const vtkDisplayableManagerBoxRepresentation&);  //Not implemented
  void operator=(const vtkDisplayableManagerBoxRepresentation&);  //Not implemented
};
