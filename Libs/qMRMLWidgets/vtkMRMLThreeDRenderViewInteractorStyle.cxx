...
vtkCxxRevisionMacro(vtkMRMLThreeDRenderViewInteractorStyle, "$Revision$");
vtkStandardNewMacro(vtkMRMLThreeDRenderViewInteractorStyle);

//----------------------------------------------------------------------------
vtkMRMLThreeDRenderViewInteractorStyle::vtkMRMLThreeDRenderViewInteractorStyle()
{
  this->MotionFactor   = 10.0;
  this->CameraNode = 0;
//   this->ApplicationLogic = 0;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnMouseMove()
{ 
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnEnter()
{
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnLeave()
{
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnLeftButtonDown()
{ 
    ...
    if (this->Interactor->GetControlKey()) 
      ...
      if (mouseInteractionMode == vtkMRMLInteractionNode::ViewTransform)
        ...
        if (mouseInteractionMode == vtkMRMLInteractionNode::Place)
          {
          this->InvokeEvent(vtkMRMLThreeDRenderViewInteractorStyle::PickEvent, this->Interactor->GetEventPosition());
          ...
          this->InvokeEvent(vtkMRMLThreeDRenderViewInteractorStyle::SelectRegionEvent, this->Interactor->GetEventPosition());
          this->NumberOfPicks++;
          ...
          this->InvokeEvent(vtkMRMLThreeDRenderViewInteractorStyle::PlotEvent, this->Interactor->GetEventPosition());
#endif
          }
        }
      }
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnLeftButtonUp()
{
  // get the scene's mouse interaction mode
  int mouseInteractionMode = vtkMRMLInteractionNode::ViewTransform;
  int pickModePersistence = 0;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnMiddleButtonDown()
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == 0)
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnMiddleButtonUp()
{
  switch (this->State) 
    {
    case VTKIS_PAN:
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnRightButtonDown()
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == 0)
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnRightButtonUp()
{
  switch (this->State) 
    {
    case VTKIS_DOLLY:
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnMouseWheelForward()
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == 0)
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnMouseWheelBackward()
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == 0)
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::OnExpose()
{
  std::cout << "vtkMRMLThreeDRenderViewInteractorStyle::OnExpose" << std::endl;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::Rotate()
{
  if (this->CurrentRenderer == 0)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::Spin()
{
  if (this->CurrentRenderer == 0)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::Pan()
{
  if (this->CurrentRenderer == 0)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::Dolly()
{
  if (this->CurrentRenderer == 0)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDRenderViewInteractorStyle::Dolly(double factor)
{
  if (this->CurrentRenderer == 0)
    {
    return;
...
// //----------------------------------------------------------------------------
// void vtkMRMLThreeDRenderViewInteractorStyle::SetViewerWidget ( vtkSlicerViewerWidget *viewerWidget )
// {
