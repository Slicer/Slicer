 ...
 */
void GeneratePre(std::ofstream &, ModuleDescription &, int, char *[], std::vector<std::string>&);
...
main(int argc, char *argv[])
{
  ...
  GeneratePre(sout, module, argc, argv, logoFiles);
...
void GeneratePre(std::ofstream &sout, ModuleDescription &module, int argc, char *argv[], std::vector<std::string> &logos)
{
...
void GeneratePluginDataSymbols(std::ofstream &sout, std::vector<std::string>& logos, std::string XMLFile)
{
  ...
  if (logos.size() == 1)
    ...
    sout << "Module_EXPORT int ModuleLogoWidth = image_"
         << fileName << "_width;" << std::endl;
    sout << "Module_EXPORT int ModuleLogoHeight = image_"
         << fileName << "_height;" << std::endl;
    sout << "Module_EXPORT int ModuleLogoPixelSize = image_"
         << fileName << "_pixel_size;" << std::endl;
    sout << "Module_EXPORT unsigned long ModuleLogoLength = image_"
         << fileName << "_length;" << std::endl;
    sout << "Module_EXPORT int ModuleLogoOptions = 0;" << std::endl;
    // sout << "Module_EXPORT unsigned char* ModuleLogo
    }
