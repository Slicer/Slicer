...
// load in results that were already computed
int QdecGlmFit::Load(QdecGlmDesign* iGlmDesign)
{
  if (iGlmDesign == NULL)
    {
    return -1;
    ...
    {
    fprintf(stdout, "QdecGlmFit::Load: glm desing working dir = %s\n",iGlmDesign->GetWorkingDir().c_str());
    }
