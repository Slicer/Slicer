...
//
int vtkITKLevelTracingImageFilter::RequestData(vtkInformation* vtkNotUsed(request),
...
# define vtkTemplateMacroCase_ll(typeN, type, call)
  ...
  if (inScalars->GetNumberOfComponents() == 1)
  {
    ...
    {
      vtkTemplateMacro(vtkITKLevelTracingTrace(
        this, static_cast<VTK_TT*>(scalars), dims, extent, origin, spacing, newPts, newPolys, this->Seed, this->Plane));
    } // switch
  }
