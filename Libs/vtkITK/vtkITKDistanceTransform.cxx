...
template <class T>
void vtkITKDistanceTransformExecute(vtkITKDistanceTransform* self,
                                    vtkImageData* input,
                                    vtkImageData* output,
                                    T* inPtr,
                                    T* vtkNotUsed(outPtr))
...
#define CALL \
  vtkITKDistanceTransformExecute(this, input, output, static_cast<VTK_TT*>(inPtr), static_cast<VTK_TT*>(outPtr));
