...
public:
  ...
  {
    this->DesiredCoordinateOrientation = itk::SpatialOrientation::ITK_COORDINATE_ORIENTATION_RAI;
  ...
  {
    this->DesiredCoordinateOrientation = itk::SpatialOrientation::ITK_COORDINATE_ORIENTATION_RSA;
  ...
  {
    this->DesiredCoordinateOrientation = itk::SpatialOrientation::ITK_COORDINATE_ORIENTATION_ASL;
  ...
  vtkSetClampMacro(DICOMImageIOApproach,
                   int,
                   vtkITKArchetypeImageSeriesReader::GDCM,
                   vtkITKArchetypeImageSeriesReader::DCMTK);
