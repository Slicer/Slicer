...
itk::SmartPointer<itk::Image<float, Dimension>> sdf(itk::SmartPointer<itk::Image<InputPixelType, Dimension>> labelImage,
                                                    int backgroundValue)
{
...
itk::SmartPointer<ImageType> sdfMargin(itk::SmartPointer<ImageType> labelImage,
                                       int backgroundValue,
...
//----------------------------------------------------------------------------
template <class T>
void vtkITKImageMarginExecute(vtkITKImageMargin* self,
                              vtkImageData* input,
