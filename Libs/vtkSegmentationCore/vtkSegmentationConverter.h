...
public:
  ...
  /// not used (e.g., an image is only created to parse image geometry)
  /// \param scalarType If specified then scalar type will be set to the requested value, otherwise current value will
  /// be kept.
  /// \param numberOfScalarsComponents If specified then the number of scalar components will be set to the requested
  /// value, otherwise current value will be kept.
  /// \return Success flag
