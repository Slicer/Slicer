...
public:
  ...
  /// neighbor (binary labelmap). Default is false. \return Success flag
  ...
  /// \param outputImage Output image
  /// \param linearInterpolation True if linear interpolation is requested (fractional labelmap), or false for nearest
  /// neighbor (binary labelmap). Default is false. \param padImage If enabled then it is made sure that the input
  /// image's extent fits into the resampled reference image, so if part of the extent is transformed
  ...
  /// resampled into referenceImage. \return Success flag
