...
void vtkMRMLThreeDReformatDisplayableManager::vtkInternal::AddSliceNode(vtkMRMLSliceNode* sliceNode)
{
  ...
  this->SliceNodes.insert(std::pair<vtkMRMLSliceNode*, vtkImplicitPlaneWidget2*>(sliceNode, static_cast<vtkImplicitPlaneWidget2*>(nullptr)));
...
//---------------------------------------------------------------------------
vtkMRMLSliceNode* vtkMRMLThreeDReformatDisplayableManager::vtkInternal::GetSliceNode(vtkImplicitPlaneWidget2* planeWidget)
{
  if (!planeWidget)
  {
    return nullptr;
...
//---------------------------------------------------------------------------
bool vtkMRMLThreeDReformatDisplayableManager::vtkInternal::UpdateWidget(vtkMRMLSliceNode* sliceNode, vtkImplicitPlaneWidget2* planeWidget)
{
  ...
  if (volumeNode)
  {
    ...
    double bounds[6] = { bounds[0] = center[0] - dimensions[0] / 2, bounds[1] = center[0] + dimensions[0] / 2, bounds[2] = center[1] - dimensions[1] / 2,
                         bounds[3] = center[1] + dimensions[1] / 2, bounds[4] = center[2] - dimensions[2] / 2, bounds[5] = center[2] + dimensions[2] / 2 };
...
//----------------------------------------------------------------------------
void vtkMRMLThreeDReformatDisplayableManager::ProcessWidgetsEvents(vtkObject* caller, unsigned long event, void* vtkNotUsed(callData))
{
