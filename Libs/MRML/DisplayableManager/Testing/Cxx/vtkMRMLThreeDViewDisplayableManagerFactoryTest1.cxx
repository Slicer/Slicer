...
int vtkMRMLThreeDViewDisplayableManagerFactoryTest1(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  {
    std::cerr << "Line " << __LINE__ << " - Factory obtained using either GetInstance() or New() should be the same."
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Line " << __LINE__ << " - Problem with method factory->GetRegisteredDisplayableManagerCount()"
              << std::endl;
