...
int vtkMRMLLayoutLogicTest1(int, char*[])
{
  ...
  {
    std::cerr << __LINE__ << " Wrong number of views returned:" << layoutLogic->GetViewNodes()->GetNumberOfItems()
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << __LINE__ << " Wrong nodes returned:" << viewNode << " " << redNode << " " << yellowNode << " "
              << greenNode << std::endl;
    return EXIT_FAILURE;
  }
