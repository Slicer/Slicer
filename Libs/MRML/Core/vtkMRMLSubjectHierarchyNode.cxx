...
//----------------------------------------------------------------------------
void vtkMRMLSubjectHierarchyNode::ReadMRMLStatusFromJSONString(const char *json)
{
  if (!json)
  {
    vtkErrorMacro("vtkMRMLSubjectHierarchyNode::ReadMRMLStatusFromJSONString : input json is null.");
    return;
  }
  ...
  {
    vtkErrorMacro("vtkMRMLSubjectHierarchyNode::ReadMRMLStatusFromJSONString : Failed to parse XML from JSON string.");
    return;
  }
  if (element->GetName() == nullptr || strcmp(element->GetName(), this->GetNodeTagName()) != 0)
  {
    vtkErrorMacro("vtkMRMLSubjectHierarchyNode::ReadMRMLStatusFromJSONString : Invalid JSON string.");
    return;
  }
