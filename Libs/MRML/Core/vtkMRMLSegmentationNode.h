...
// ETX
  ...
  /// If terminology or name of a segment name matches an entry in this color table, then the value of the color will be
  /// used as the label value for the segment when exporting the segmentation to labelmap.
