...
public:
  ...
  const char* GetIcon() override {return ":/Icons/MarkupsAddPlane.svg";}
  const char* GetAddIcon() override {return ":/Icons/MarkupsAddPlane.svg";}
  const char* GetPlaceAddIcon() override {return ":/Icons/MarkupsAddPlane.svg";}
