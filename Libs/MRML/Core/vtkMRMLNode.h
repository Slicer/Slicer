...
public:
  ...
  virtual std::string WriteMRMLStatusToJSONString(int indent = 0, vtkMRMLMessageCollection* userMessagesInput=nullptr);

  /// Read this node's information from a string in JSON format.
  ///
  /// \sa ReadXMLAttributes(),
  virtual void ReadMRMLStatusFromJSONString(const char* json);
