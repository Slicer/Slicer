...
void vtkMRMLCameraNode::ProcessMRMLEvents(vtkObject* caller, unsigned long event, void* callData)
{
  ...
  if (this->Camera != nullptr && this->Camera == vtkCamera::SafeDownCast(caller) && event == vtkCommand::ModifiedEvent)
  {
    this->Modified();
  }

  vtkMRMLTransformNode* tnode = this->GetParentTransformNode();
  if (this->Camera != nullptr && tnode == vtkMRMLTransformNode::SafeDownCast(caller)
