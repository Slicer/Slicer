...
void vtkMRMLDisplayableHierarchyNode::Copy(vtkMRMLNode* anode)
{
  ...
  vtkMRMLDisplayableHierarchyNode* const node = (vtkMRMLDisplayableHierarchyNode*)anode;
...
void vtkMRMLDisplayableHierarchyNode::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "DisplayNodeID: " << (this->DisplayNodeID ? this->DisplayNodeID : "(none)") << "\n";
...
{
  vtkMRMLDisplayableNode* const node = vtkMRMLDisplayableNode::SafeDownCast(this->GetAssociatedNode());
  return node;
}
...
vtkMRMLDisplayNode* vtkMRMLDisplayableHierarchyNode::GetDisplayNode()
{
  ...
  {
    vtkMRMLNode* const snode = this->GetScene()->GetNodeByID(this->DisplayNodeID);
...
void vtkMRMLDisplayableHierarchyNode::SetAndObserveDisplayNodeID(const char* displayNodeID)
{
  ...
  vtkMRMLDisplayNode* const dnode = this->GetDisplayNode();
...
//---------------------------------------------------------------------------
void vtkMRMLDisplayableHierarchyNode::ProcessMRMLEvents(vtkObject* caller, unsigned long event, void* callData)
{
...
void vtkMRMLDisplayableHierarchyNode::RemoveChildrenNodes()
{
  ...
  for (unsigned int i = 0; i < children.size(); i++)
  {
    ...
    if (child)
    {
      const std::vector<vtkMRMLHierarchyNode*> childChildern = child->GetChildrenNodes();
      vtkMRMLDisplayableNode* const dnode = child->GetDisplayableNode();
      if (dnode)
      {
        this->GetScene()->RemoveNode(dnode);
      }
      vtkMRMLDisplayNode* const disnode = child->GetDisplayNode();
      if (disnode)
      {
...
//----------------------------------------------------------------------------
vtkMRMLDisplayableHierarchyNode* vtkMRMLDisplayableHierarchyNode::GetDisplayableHierarchyNode(vtkMRMLScene* scene, const char* displayableNodeID)
{
  return vtkMRMLDisplayableHierarchyNode::SafeDownCast(vtkMRMLHierarchyNode::GetAssociatedHierarchyNode(scene, displayableNodeID));
}
