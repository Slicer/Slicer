...
int vtkMRMLSceneAddSingletonTest(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  const char sceneXML[] = "<MRML  version=\"18916\" userTags=\"\">"
  ...
  vtkMRMLSceneViewNode* sceneViewNode = vtkMRMLSceneViewNode::SafeDownCast(tempScene->GetFirstNodeByName("sceneView"));

  // Test singleton loading/restoring.
  vtkMRMLNode* restoredSingleton1 = sceneViewNode->GetStoredScene()->GetNthNodeByClass(0, "vtkMRMLModelNode");
  ...
  restoredSingleton1 = sceneViewNode->GetStoredScene()->GetNthNodeByClass(1, "vtkMRMLModelNode");
  restoredSingleton1->SetSingletonTag("Singleton");
  restoredSingleton1->SetAddToScene(1);
  addedNode = scene->AddNode(restoredSingleton1);
  ...
  restoredSingleton1 = sceneViewNode->GetStoredScene()->GetNthNodeByClass(2, "vtkMRMLModelNode");
  restoredSingleton1->SetSingletonTag("Singleton");
  restoredSingleton1->SetAddToScene(1);
  addedNode = scene->AddNode(restoredSingleton1);
  ...
  const char scene1XML[] =
    ...
    "vtkMRMLScriptedModuleNodeSingletonB;\" > </ScriptedModule>"
  ...
  const char scene2XML[] =
    ...
    "vtkMRMLScriptedModuleNodeSingletonXB;\" > </ScriptedModule>"
