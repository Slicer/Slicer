...
vtkMatrix4x4* CreateTransformMatrix(double translateX, double translateY, double translateZ, double rotateX, double rotateY, double rotateZ)
{
  ...
  tr->RotateY(rotateY);
  tr->RotateZ(rotateZ);
  vtkMatrix4x4* const matrix = vtkMatrix4x4::New();
  tr->GetMatrix(matrix);
  return matrix;
}
...
int vtkMRMLTransformNodeTest1(int, char*[])
{
  ...
  const vtkNew<vtkMatrix4x4> linearTransform;
  ...
  const vtkSmartPointer<vtkMatrix4x4> w_from_b_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(34, 23, -12, 44, 12, 78));
  const vtkSmartPointer<vtkMatrix4x4> b_from_c_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(-34, 11, 12, -22, 128, 18));
  const vtkSmartPointer<vtkMatrix4x4> c_from_d_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(14, -23, 44, 11, -71, 38));
  const vtkSmartPointer<vtkMatrix4x4> d_from_e_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(73, 81, 35, 22, 11, -98));
  const vtkSmartPointer<vtkMatrix4x4> b_from_q_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(13, -71, 335, -42, 91, -28));
  const vtkSmartPointer<vtkMatrix4x4> q_from_r_mx = vtkSmartPointer<vtkMatrix4x4>::Take(CreateTransformMatrix(53, -11, 65, -12, 21, 8));
  ...
  const vtkNew<vtkMatrix4x4> c_from_r_mx;
  vtkMatrix4x4::Multiply4x4(c_from_b_mx.GetPointer(), b_from_r_mx.GetPointer(), c_from_r_mx.GetPointer());

  // Test AreTransformsEqual
  const vtkNew<vtkGeneralTransform> transform1;
  const vtkNew<vtkGeneralTransform> transform2;
  ...
  const vtkNew<vtkMatrix4x4> test_mx;
