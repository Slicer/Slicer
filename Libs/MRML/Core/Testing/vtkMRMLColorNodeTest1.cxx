...
public:
  ...
  vtkMRMLNode* CreateNodeInstance() override { return vtkMRMLColorNodeTestHelper1::New(); }

  const char* GetTypeAsString() override { return "vtkMRMLColorNodeTestHelper1"; }
...
int TestGetColorNameAsFileName(const char* colorName, const char* expectedColorFileName, const char* substr = "_");
...
int TestGetColorNameAsFileName()
{
  ...
  CHECK_EXIT_SUCCESS(
    TestGetColorNameAsFileName("n^a$m(e!w)i-t_h~v{a}l.iD#c%h'ars", "n^a$m(e!w)i-t_h~v{a}l.iD#c%h'ars"));
  CHECK_EXIT_SUCCESS(
    TestGetColorNameAsFileName("n`a@m&e*w+i=t[h]i;n:v\\a|l\"i<D>c,h/a?rs", "n_a_m_e_w_i_t_h_i_n_v_a_l_i_D_c_h_a_rs"));
  ...
  CHECK_EXIT_SUCCESS(TestGetColorNameAsFileName("very very very very very very very very very very "
