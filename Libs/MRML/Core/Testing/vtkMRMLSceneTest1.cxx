  ...
  // Verify content of ReferencedIDChanges map
  {
        ...
        !nodeInPrivateSceneID.compare(nodeAddedFromPrivateSceneID))
    {
      std::cerr << "Line " << __LINE__ << " - Problem with GetChangedID()\n"
                ...
                << "  nodeAddedFromPrivateSceneID: " << (nodeAddedFromPrivateSceneID ? nodeAddedFromPrivateSceneID : "NULL") << std::endl;
      return EXIT_FAILURE;
    }
        ...
        !strcmp(changedIDFromImportedScene, importedNodeID))
    {
      std::cerr << "Line " << __LINE__ << " - Problem with GetChangedID()\n"
                ...
                << "  changedIDFromImportedScene: " << (changedIDFromImportedScene ? changedIDFromImportedScene : "NULL") << std::endl;
      return EXIT_FAILURE;
    }
