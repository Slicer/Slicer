...
public:
  ...
  virtual vtkMRMLNode* CreateNodeInstance() override {return  vtkMRMLTestVolumeNode::New();}
  virtual const char* GetNodeTagName() override {return "vtkMRMLTestVolumeNode";}
};
