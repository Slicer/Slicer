...
int vtkMRMLVolumeNodeEventsTest(int, char*[])
{
  ...
  {
    std::cerr << __LINE__ << ": vtkMRMLVolumeNode::SetAndObserveImageData failed: " << callback->GetErrorString().c_str() << " "
              << "Number of ModifiedEvent: " << callback->GetNumberOfEvents(vtkCommand::ModifiedEvent) << " "
              << "Number of ImageDataModifiedEvent: " << callback->GetNumberOfEvents(vtkMRMLVolumeNode::ImageDataModifiedEvent) << std::endl;
    return EXIT_FAILURE;
  }
