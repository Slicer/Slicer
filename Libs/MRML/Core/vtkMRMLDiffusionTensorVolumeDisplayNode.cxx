...
{
  return this->DTIMathematics->GetNumberOfInputConnections(0) ? this->DTIMathematics->GetInputConnection(0, 0) : nullptr;
}
...
vtkAlgorithmOutput* vtkMRMLDiffusionTensorVolumeDisplayNode::GetBackgroundImageStencilDataConnection()
{
  switch (this->GetScalarInvariant())
  {
    ...
    default: return this->Superclass::GetBackgroundImageStencilDataConnection();
  }
}
