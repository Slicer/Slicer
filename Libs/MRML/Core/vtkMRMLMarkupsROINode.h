...
public:
  ...
  const char* GetIcon() override {return ":/Icons/MarkupsAddROI.svg";}
  const char* GetAddIcon() override {return ":/Icons/MarkupsAddROI.svg";}
  const char* GetPlaceAddIcon() override {return ":/Icons/MarkupsAddROI.svg";}
