...
///   names includ "Binary labelmap", "Closed surface", "Planar contours", "Fractional labelmap"
...
///   even if the segment's dispay name is changed.
...
/// - SegmentN__ColorAutoGenerated: if value is 0 then it means that SegmentN_Color was chosen manually by the user, if value is 1 then it means
