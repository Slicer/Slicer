...
#define TEST_SET_GET_BOOLEAN(object, variable)                                                                \
  ...
  {                                                                                                           \
    std::cerr << "Error in Set/Get" #variable << ", Get" #variable                                            \
              << " returned zero while it is expected to return non-zero" << std::endl;                       \
    return EXIT_FAILURE;                                                                                      \
  }                                                                                                           \
  object->Set##variable(false);                                                                               \
  if (object->Get##variable() != 0)                                                                           \
  {                                                                                                           \
    std::cerr << "Error in Set/Get" #variable << ", Get" #variable << " returned " << object->Get##variable() \
  ...
  if (object->Get##variable() == 0)                                                                           \
  {                                                                                                           \
    std::cerr << "Error in On/Get" #variable << ", Get" #variable                                             \
              << " returned zero while it is expected to return non-zero" << std::endl;                       \
    return EXIT_FAILURE;                                                                                      \
  }                                                                                                           \
  object->variable##Off();                                                                                    \
  if (object->Get##variable() != 0)                                                                           \
  {                                                                                                           \
    std::cerr << "Error in Off/Get" #variable << ", Get" #variable << " returned " << object->Get##variable() \
              << " while 0 is expected" << std::endl;                                                         \
    return EXIT_FAILURE;                                                                                      \
  }
...
#define TEST_SET_GET_STRING(object, variable)                                                             \
  {                                                                                                       \
    ...
    {                                                                                                     \
      std::cerr << "Error in Set/Get" #variable << ", tried to set to " << string1.c_str() << " but got " \
                << (object->Get##variable() ? object->Get##variable() : "null") << std::endl;             \
      return EXIT_FAILURE;                                                                                \
    }                                                                                                     \
    ...
    {                                                                                                     \
      std::cerr << "Error in Set/Get" #variable << ", tried to set to " << string2.c_str() << " but got " \
                << (object->Get##variable() ? object->Get##variable() : "null") << std::endl;             \
      return EXIT_FAILURE;                                                                                \
    }                                                                                                     \
    if (originalStringPointer != nullptr)                                                                 \
...
#define TEST_SET_GET_STD_STRING(object, variable)                                                 \
  {                                                                                               \
    ...
    if (object->Get##variable() != string1)                                                       \
    {                                                                                             \
      std::cerr << "Error in Set/Get" #variable << ", tried to set to " << string1 << " but got " \
    ...
    if (object->Get##variable() != string2)                                                       \
    {                                                                                             \
      std::cerr << "Error in Set/Get" #variable << ", tried to set to " << string2 << " but got " \
                << object->Get##variable() << std::endl;                                          \
      return EXIT_FAILURE;                                                                        \
    }                                                                                             \
