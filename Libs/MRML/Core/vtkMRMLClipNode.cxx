...
Program:   3D Slicer
Module:    $RCSfile: vtkMRMLClipNode.cxx,v $
...
const char* vtkMRMLClipNode::ClippingNodeReferenceRole = "clip";
const char* vtkMRMLClipNode::ClippingNodeReferenceRef = "clipRef";
const char* vtkMRMLClipNode::ClippingNodeStatePropertyName = "clipState";
...
//----------------------------------------------------------------------------
const char* vtkMRMLClipNode::GetClippingNodeStatePropertyName() const
{
