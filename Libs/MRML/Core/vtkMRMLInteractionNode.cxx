...
{
  if (this->GetCurrentInteractionMode() == vtkMRMLInteractionNode::Place && this->GetPlaceModePersistence() == 1)
  {
    return;
  }
  int disabledModify = this->StartModify();
...
{
  if (this->GetCurrentInteractionMode() == vtkMRMLInteractionNode::Place && this->GetPlaceModePersistence() == 0)
  {
    return;
  }
  int disabledModify = this->StartModify();
