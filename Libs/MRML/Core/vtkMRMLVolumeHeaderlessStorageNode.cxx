...
void vtkMRMLVolumeHeaderlessStorageNode::WriteXML(ostream& of, int nIndent)
{
  ...
  {
    of << " fileDimensions=\"" << this->FileDimensions[0] << " " << this->FileDimensions[1] << " " << this->FileDimensions[2] << "\"";
  }
  {
...
int vtkMRMLVolumeHeaderlessStorageNode::ReadDataInternal(vtkMRMLNode* refNode)
{
  ...
  mat->Identity();
  volNode->ComputeIJKToRASFromScanOrder(this->GetFileScanOrder(), spacing, dims, this->GetCenterImage(), mat.GetPointer());
