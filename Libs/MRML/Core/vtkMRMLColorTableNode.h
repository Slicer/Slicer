...
public:
  ...
  void AddColor(const char* name, double r, double g, double b, double a = 1.0, NameSourceType nameSource = NameSourceUnknown);

  ///
  /// Set a color into the User color table. Return 1 on success, 0 on failure.
  int SetColor(int entry, const char* name, double r, double g, double b, double a = 1.0, NameSourceType nameSource = NameSourceUnknown);

  /// Undefine color entry.
  /// Returns true on success.
  bool ClearColor(int entry);
  ...
  int SetColors(int firstEntry, int lastEntry, const char* name, double r, double g, double b, double a = 1.0, NameSourceType nameSource=NameSourceUnknown);

  /// Undefines entries in the specified range.
  /// Returns true on success, false on failure.
  bool ClearColors(int firstEntry, int lastEntry);
