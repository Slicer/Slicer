...
void vtkMRMLModelNode::SetAndObserveMesh(vtkPointSet* mesh)
{
  ...
  else
  {
    ...
    vtkTrivialProducer* oldProducer = vtkTrivialProducer::SafeDownCast(this->MeshConnection ? this->MeshConnection->GetProducer() : nullptr);
...
void vtkMRMLModelNode::UpdateImplicitDistanceFunction()
{
  ...
  vtkSmartPointer<vtkGeneralTransform> localToWorldTransform = vtkGeneralTransform::SafeDownCast(this->PolyDataLocalToWorldTransformFilter->GetTransform());
...
vtkPolyData* vtkMRMLModelNode::GetPolyData()
{
  ...
  {
    vtkWarningMacro("GetPolyData() correctly returned a null pointer " << "since the model's mesh is a vtkUnstructuredGrid, but "
...
vtkUnstructuredGrid* vtkMRMLModelNode::GetUnstructuredGrid()
{
  ...
  {
    vtkWarningMacro("GetUnstructuredGrid() correctly returned a null pointer " << "since the model's mesh is a vtkPolyData, but "
...
void vtkMRMLModelNode::TransformBoundsToRAS(double inputBounds_Local[6], double outputBounds_RAS[6])
{
  ...
  double cornerPoints_Local[8][4] = {
    { inputBounds_Local[0], inputBounds_Local[2], inputBounds_Local[4], 1 }, { inputBounds_Local[0], inputBounds_Local[3], inputBounds_Local[4], 1 },
    { inputBounds_Local[0], inputBounds_Local[2], inputBounds_Local[5], 1 }, { inputBounds_Local[0], inputBounds_Local[3], inputBounds_Local[5], 1 },
    { inputBounds_Local[1], inputBounds_Local[2], inputBounds_Local[4], 1 }, { inputBounds_Local[1], inputBounds_Local[3], inputBounds_Local[4], 1 },
    { inputBounds_Local[1], inputBounds_Local[2], inputBounds_Local[5], 1 }, { inputBounds_Local[1], inputBounds_Local[3], inputBounds_Local[5], 1 }
  };
...
void vtkMRMLModelNode::CreateDefaultDisplayNodes()
{
  ...
  vtkMRMLModelDisplayNode* dispNode = vtkMRMLModelDisplayNode::SafeDownCast(scene->AddNewNodeByClass("vtkMRMLModelDisplayNode"));
