...
bool vtkMRMLMarkupsFiducialStorageNode::SetPointFromString(vtkMRMLMarkupsNode* markupsNode, int pointIndex, const char* line)
{
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    {
      vtkGenericWarningMacro("vtkMRMLMarkupsFiducialStorageNode::SetMarkupFromString failed:" << " numeric values expected for xyz, got instead: "
                                                                                              << parser.GetField(FIELD_XYZ + i));
      return false;
    }
  }
