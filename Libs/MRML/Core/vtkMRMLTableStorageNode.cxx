...
int vtkMRMLTableStorageNode::WriteDataInternal(vtkMRMLNode* refNode)
{
  ...
  // Write out table
  if (!vtkMRMLTableStorageNode::WriteTable(
        fullName, tableNode->GetTable(), this->GetFieldDelimiterCharacters(fullName), componentNamesMap))
  {
    vtkErrorToMessageCollectionMacro(this->GetUserMessages(),
                                     "vtkMRMLTableStorageNode::WriteData",
...
//----------------------------------------------------------------------------
bool vtkMRMLTableStorageNode::WriteTable(std::string filename,
                                         vtkTable* table,
