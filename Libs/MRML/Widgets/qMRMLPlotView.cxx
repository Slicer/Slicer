...
void qMRMLPlotViewPrivate::init()
{
  ...
  if (!q->chart()->GetBackgroundBrush() || !q->chart()->GetTitleProperties() || !q->chart()->GetLegend() || !q->scene())
  {
    return;
  }

  if (!q->chart()->GetLegend()->GetLabelProperties() || !q->scene()->GetRenderer())
  {
    return;
  }
...
vtkMRMLPlotSeriesNode* qMRMLPlotViewPrivate::plotSeriesNodeFromPlot(vtkPlot* plot)
{
  ...
  vtkMRMLPlotSeriesNode* plotSeriesNode =
    vtkMRMLPlotSeriesNode::SafeDownCast(this->mrmlScene()->GetNodeByID(plotSeriesNodeID.toUtf8().constData()));
...
// --------------------------------------------------------------------------
vtkSmartPointer<vtkPlot> qMRMLPlotViewPrivate::updatePlotFromPlotSeriesNode(vtkMRMLPlotSeriesNode* plotSeriesNode,
                                                                            vtkPlot* existingPlot)
{
  if (plotSeriesNode == nullptr)
  {
    return nullptr;
  ...
  if (newPlot->GetPen())
  {
    ...
    else
    {
      ...
      {
        case vtkMRMLPlotSeriesNode::LineStyleNone:
          lineStyleVtk = vtkPen::NO_PEN;
          break;
        case vtkMRMLPlotSeriesNode::LineStyleSolid:
          lineStyleVtk = vtkPen::SOLID_LINE;
          break;
        case vtkMRMLPlotSeriesNode::LineStyleDash:
          lineStyleVtk = vtkPen::DASH_LINE;
          break;
        case vtkMRMLPlotSeriesNode::LineStyleDot:
          lineStyleVtk = vtkPen::DOT_LINE;
          break;
        case vtkMRMLPlotSeriesNode::LineStyleDashDot:
          lineStyleVtk = vtkPen::DASH_DOT_LINE;
          break;
        case vtkMRMLPlotSeriesNode::LineStyleDashDotDot:
          lineStyleVtk = vtkPen::DASH_DOT_DOT_LINE;
          break;
        default:
          lineStyleVtk = vtkPen::NO_PEN;
      }
  ...
  if (plotLine)
  {
    ...
    {
      case vtkMRMLPlotSeriesNode::MarkerStyleNone:
        markerStyleVtk = VTK_MARKER_NONE;
        break;
      case vtkMRMLPlotSeriesNode::MarkerStyleCross:
        markerStyleVtk = VTK_MARKER_CROSS;
        break;
      case vtkMRMLPlotSeriesNode::MarkerStylePlus:
        markerStyleVtk = VTK_MARKER_PLUS;
        break;
      case vtkMRMLPlotSeriesNode::MarkerStyleSquare:
        markerStyleVtk = VTK_MARKER_SQUARE;
        break;
      case vtkMRMLPlotSeriesNode::MarkerStyleCircle:
        markerStyleVtk = VTK_MARKER_CIRCLE;
        break;
      case vtkMRMLPlotSeriesNode::MarkerStyleDiamond:
        markerStyleVtk = VTK_MARKER_DIAMOND;
        break;
      default:
  ...
  // TODO: set labels as axis text using vtkAxis::SetCustomTickPositions(vtkDoubleArray *positions, vtkStringArray
  // *labels)
...
void qMRMLPlotViewPrivate::onPlotChartNodeChanged()
{
  ...
  {
    newPlotChartNode =
      vtkMRMLPlotChartNode::SafeDownCast(this->MRMLScene->GetNodeByID(this->MRMLPlotViewNode->GetPlotChartNodeID()));
  }

  this->qvtkReconnect(
    this->MRMLPlotChartNode, newPlotChartNode, vtkCommand::ModifiedEvent, this, SLOT(updateWidgetFromMRML()));
...
void qMRMLPlotViewPrivate::emitSelection()
{
  ...
  vtkMRMLPlotChartNode* plotChartNode =
    vtkMRMLPlotChartNode::SafeDownCast(this->MRMLScene->GetNodeByID(PlotChartNodeID));
  if (!plotChartNode)
  {
    return;
  }
...
void qMRMLPlotViewPrivate::updateWidgetFromMRML()
{
  ...
  if (!this->MRMLScene || !this->MRMLPlotViewNode || !q->isEnabled() || !q->chart() || !q->chart()->GetLegend())
  {
    return;
  }
  ...
  vtkSmartPointer<vtkCollection> allPlotSeriesNodesInScene =
    vtkSmartPointer<vtkCollection>::Take(this->mrmlScene()->GetNodesByClass("vtkMRMLPlotSeriesNode"));
  ...
  for (int chartPlotSeriesNodesIndex = q->chart()->GetNumberOfPlots() - 1; chartPlotSeriesNodesIndex >= 0;
       chartPlotSeriesNodesIndex--)
  {
    ...
    if (plotSeriesNode != nullptr)
    {
      ...
      if (std::find(plotSeriesNodesIDs.begin(), plotSeriesNodesIDs.end(), plotSeriesNode->GetID())
          == plotSeriesNodesIDs.end())
      {
  ...
  {
    vtkMRMLPlotSeriesNode* plotSeriesNode =
      vtkMRMLPlotSeriesNode::SafeDownCast(this->mrmlScene()->GetNodeByID(it->c_str()));
  ...
  int fontTypeIndex = q->chart()->GetTitleProperties()->GetFontFamilyFromString(
    plotChartNode->GetFontType() ? plotChartNode->GetFontType() : "Arial");
...
void qMRMLPlotView::setMRMLPlotViewNode(vtkMRMLPlotViewNode* newPlotViewNode)
{
  ...
  d->qvtkReconnect(d->MRMLPlotViewNode,
                   newPlotViewNode,
                   vtkMRMLPlotViewNode::PlotChartNodeChangedEvent,
                   d,
