...
void qMRMLEventLoggerPrivate::setMRMLScene(vtkMRMLScene* scene)
{
  ...
  this->EventNameToConnectionIdMap["NodeRemoved"] =
    this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::NodeRemovedEvent, q, SLOT(onNodeRemovedEvent(vtkObject*, vtkObject*)), priority);

  this->EventNameToConnectionIdMap["NewScene"] = this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::NewSceneEvent, q, SLOT(onNewSceneEvent()), priority);

  this->EventNameToConnectionIdMap["SceneClosed"] = this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::EndCloseEvent, q, SLOT(onSceneClosedEvent()), priority);

  this->EventNameToConnectionIdMap["SceneAboutToBeClosed"] =
    this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::StartCloseEvent, q, SLOT(onSceneAboutToBeClosedEvent()), priority);

  this->EventNameToConnectionIdMap["MetadataAdded"] = this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::MetadataAddedEvent, q, SLOT(onMetadataAddedEvent()), priority);

  this->EventNameToConnectionIdMap["ImportProgressFeedback"] =
    this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::ImportProgressFeedbackEvent, q, SLOT(onImportProgressFeedbackEvent()), priority);

  this->EventNameToConnectionIdMap["SaveProgressFeedback"] =
    this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::SaveProgressFeedbackEvent, q, SLOT(onSaveProgressFeedbackEvent()), priority);

  this->EventNameToConnectionIdMap["SceneAboutToBeImported"] =
    this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::StartImportEvent, q, SLOT(onSceneAboutToBeImportedEvent()), priority);

  this->EventNameToConnectionIdMap["SceneImported"] = this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::EndImportEvent, q, SLOT(onSceneImportedEvent()), priority);

  this->EventNameToConnectionIdMap["SceneRestored"] = this->qvtkReconnect(this->MRMLScene, scene, vtkMRMLScene::EndRestoreEvent, q, SLOT(onSceneRestoredEvent()), priority);
