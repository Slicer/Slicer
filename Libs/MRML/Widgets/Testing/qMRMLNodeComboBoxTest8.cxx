...
int qMRMLNodeComboBoxTest8(int argc, char* argv[])
{
  ...
  {
    std::cout << "After adding a new user action, new number of actions " << actionsPlusOne << " != " << startingActions
              << " + 1" << std::endl;
    return EXIT_FAILURE;
  }
  else
  ...
  if (startingActions + 1 != actionsPlusOne)
  {
    std::cout << "After adding a second new user action that conflicts with a "
              << "default one, new number of actions " << actionsPlusOne << " != " << startingActions << " + 1"
              << std::endl;
    return EXIT_FAILURE;
  }
  else
  ...
  if (startingActions + 1 != actionsPlusOne)
  {
    std::cout << "After adding a duplicate user action, new number of actions " << actionsPlusOne
  ...
  {
    std::cout << "After adding a third new user action with duplicate text, new number of actions = " << actionsPlusOne
              << std::endl;
  }
  ...
  {
    std::cout << "After adding a new user action with valid text, new number of actions " << actionsPlusTwo
              << " != " << startingActions << " + 2" << std::endl;
    return EXIT_FAILURE;
  }
  else
  {
    std::cout << "After adding a fourth new user action with valid text, new number of actions = " << actionsPlusTwo
              << std::endl;
  }
  ...
  {
    std::cerr << __LINE__ << " - qMRMLNodeSelector: 2 new actions are expected for each new node type, but actually "
              << actionsWithTwoNodeTypes - actionsWithOneNodeType << " new actions have been added." << std::endl;
    return EXIT_FAILURE;
  }
