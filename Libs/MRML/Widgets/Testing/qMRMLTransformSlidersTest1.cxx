...
int qMRMLTransformSlidersTest1(int argc, char* argv[])
{
  ...
  {
    std::cerr << "Failed to set large translation: expected [" << largeTranslation[0] << ", " << largeTranslation[1]
              << ", " << largeTranslation[2] << "],   found: [ " << largeTranslationMatrix->GetElement(0, 3) << ", "
              << largeTranslationMatrix->GetElement(1, 3) << ", " << largeTranslationMatrix->GetElement(2, 3) << "]"
              << std::endl;
    return EXIT_FAILURE;
  }
