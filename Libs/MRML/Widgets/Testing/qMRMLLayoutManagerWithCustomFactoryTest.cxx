...
protected:
  QWidget* createViewFromNode(vtkMRMLAbstractViewNode* viewNode) override
  {
    ...
    QColor sliceLayoutColor =
      QColor::fromRgbF(sliceNode->GetLayoutColor()[0], sliceNode->GetLayoutColor()[1], sliceNode->GetLayoutColor()[2]);
...
int qMRMLLayoutManagerWithCustomFactoryTest(int argc, char* argv[])
{
  ...
  qMRMLLayoutSliceViewFactory* mrmlSliceViewFactory =
    qobject_cast<qMRMLLayoutSliceViewFactory*>(layoutManager.mrmlViewFactory("vtkMRMLSliceNode"));
