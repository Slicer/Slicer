  ...
  : q_ptr(&object)
{
  ...
  this->Flags =
    qMRMLSliderWidget::Prefix | qMRMLSliderWidget::Suffix | qMRMLSliderWidget::Precision | qMRMLSliderWidget::Scaling;
  ...
  if (d->SelectionNode)
  {
    ...
    if (unitNode)
    {
      ...
      if (d->Flags.testFlag(qMRMLSliderWidget::Precision))
      {
        ...
        {
          range =
            unitNode->GetDisplayValueFromValue(this->maximum()) - unitNode->GetDisplayValueFromValue(this->minimum());
        }
