...
void qMRMLScalarsDisplayWidgetPrivate::init()
{
  ...
  // update range mode
  q->setScalarRangeMode(qMRMLScalarsDisplayWidget::Data); // former auto
}
...
// --------------------------------------------------------------------------
void qMRMLScalarsDisplayWidget::setScalarRangeMode(ControlMode controlMode)
{
  Q_D(qMRMLScalarsDisplayWidget);
...
void qMRMLScalarsDisplayWidget::setScalarRangeMode(int scalarRangeMode)
{
  switch(scalarRangeMode)
    {
    case 0:
      this->setScalarRangeMode(qMRMLScalarsDisplayWidget::Data);
      break;
    case 1:
      this->setScalarRangeMode(qMRMLScalarsDisplayWidget::LUT);
      break;
    case 2:
      this->setScalarRangeMode(qMRMLScalarsDisplayWidget::DataType);
      break;
    case 3:
      this->setScalarRangeMode(qMRMLScalarsDisplayWidget::Manual);
      break;
    case 4:
      this->setScalarRangeMode(qMRMLScalarsDisplayWidget::DirectMapping);
      break;
    default:
      break;
    }
...
// --------------------------------------------------------------------------
qMRMLScalarsDisplayWidget::ControlMode qMRMLScalarsDisplayWidget::scalarRangeMode() const
{
  Q_D(const qMRMLScalarsDisplayWidget);
  switch( d->DisplayedScalarRangeModeComboBox->currentIndex() )
    {
    case 0:
      return qMRMLScalarsDisplayWidget::Data;
      break;
    case 1:
      return qMRMLScalarsDisplayWidget::LUT;
      break;
    case 2:
      return qMRMLScalarsDisplayWidget::DataType;
      break;
    case 3:
      return qMRMLScalarsDisplayWidget::Manual;
      break;
    case 4:
      return qMRMLScalarsDisplayWidget::DirectMapping;
      break;
    default:
      break;
    }
...
void qMRMLScalarsDisplayWidget::updateWidgetFromMRML()
{
  ...
  ControlMode controlMode = qMRMLScalarsDisplayWidget::Manual;
  switch (firstDisplayNode->GetScalarRangeFlag())
    {
    case vtkMRMLDisplayNode::UseDataScalarRange: controlMode = qMRMLScalarsDisplayWidget::Data; break;
    case vtkMRMLDisplayNode::UseColorNodeScalarRange: controlMode = qMRMLScalarsDisplayWidget::LUT; break;
    case vtkMRMLDisplayNode::UseDataTypeScalarRange: controlMode = qMRMLScalarsDisplayWidget::DataType; break;
    case vtkMRMLDisplayNode::UseManualScalarRange: controlMode = qMRMLScalarsDisplayWidget::Manual; break;
    case vtkMRMLDisplayNode::UseDirectMapping: controlMode = qMRMLScalarsDisplayWidget::DirectMapping; break;
    }
