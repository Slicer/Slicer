...
void vtkMRMLVolumePropertyNode::GetColorTransferFunction(std::string str, vtkColorTransferFunction* result)
{
    std::stringstream stream;
    stream<<str;
    int size=0;
...
void vtkMRMLVolumePropertyNode::AddReference(std::string id)
{
...
bool vtkMRMLVolumePropertyNode::HasReference(std::string id)
{
...
void vtkMRMLVolumePropertyNode::RemoveReference(std::string id)
{
