...
int vtkSlicerApplicationLogicTest1(int, char*[])
{
  ...
  //-----------------------------------------------------------------------------
  {
    ...
    {
      TestRowType row;
      row.push_back("/home/jchris/Projects/Slicer4-Superbuild-Debug/Slicer-build/bin/Slicer.app/Contents/Extensions-4810/Reporting/lib/Slicer-4.1/qt-loadable-modules/Python/"
                    "vtkSlicerReportingModuleLogic.py");
      row.push_back("/home/jchris/Projects/Slicer4-Superbuild-Debug/Slicer-build");
      row.push_back("4810");
      row.push_back("0");
      data.push_back(row);
    ...
    {
      TestRowType row;
      row.push_back("/home/jchris/Projects/Slicer4-Superbuild-Debug/Slicer-build/bin/" Slicer_BUNDLE_LOCATION
    ...
    {
      TestRowType row;
      row.push_back("/home/jchris/Projects/Slicer4-Superbuild-Debug/Slicer-build/bin/Foo.app/Contents/Extensions-4810/Reporting/lib/Slicer-4.1/qt-loadable-modules/Python/"
                    "vtkSlicerReportingModuleLogic.py");
      row.push_back("/home/jchris/Projects/Slicer4-Superbuild-Debug/Slicer-build");
      row.push_back("4810");
      row.push_back("0");
  ...
  //-----------------------------------------------------------------------------
  {
    ...
    for (int i = 0; i < numNodes; i++)
    {
      ...
      if (mrmlNode && mrmlNode->IsA("vtkMRMLModelHierarchyNode"))
      {
        ...
        std::cout << i << ": Model Hierarchy node named " << hnode->GetName() << " with id " << hnode->GetID() << " has parent node id of "
