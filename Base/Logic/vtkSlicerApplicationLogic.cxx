                                                  ...
                                                  const std::string& extensionsDirBase)
{
  ...
  if (itksys::SystemTools::StringStartsWith(canonicalPath.c_str(), applicationHomeDir.c_str()))
  {
    ...
    if (isAppBuildTree)
    {
      ...
      {
        std::string extensionInstallDir = itksys::SystemTools::GetRealPath(applicationHomeDir + "/" + organisationDomain + "/" + extensionsDirBase);
      ...
      {
        std::string extensionInstallDir = itksys::SystemTools::GetRealPath(applicationHomeDir + "/" + organisationName + "/" + extensionsDirBase);
        if (itksys::SystemTools::StringStartsWith(canonicalPath.c_str(), extensionInstallDir.c_str()))
        {
          return true;
        }
