/*=========================================================================
  ...
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/trunk/Base/GUI/vtkSlicerModelDisplayManager.h $
...
#ifndef __vtkSlicerModelDisplayManager_h
#define __vtkSlicerModelDisplayManager_h
...
class Q_SLICER_BASE_QTGUI_EXPORT vtkSlicerModelDisplayManager : public vtkSlicerLogic
{

public:
  static vtkSlicerModelDisplayManager* New();
  vtkTypeRevisionMacro(vtkSlicerModelDisplayManager,vtkSlicerLogic);
  ...
  vtkGetObjectMacro(MainViewer, vtkRenderWindow);
  vtkSetObjectMacro(MainViewer, vtkRenderWindow);
...
protected:
  vtkSlicerModelDisplayManager();
  virtual ~vtkSlicerModelDisplayManager();
...
private:
  ...
  vtkSlicerModelDisplayManager(const vtkSlicerModelDisplayManager&); /// Not implemented
  void operator=(const vtkSlicerModelDisplayManager&); /// Not Implemented
};
