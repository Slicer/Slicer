/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerManagerInteractorStyle.cxx,v $
...
vtkCxxRevisionMacro(vtkSlicerManagerInteractorStyle, "$Revision: 13328 $");
vtkStandardNewMacro(vtkSlicerManagerInteractorStyle);

//----------------------------------------------------------------------------
vtkSlicerManagerInteractorStyle::vtkSlicerManagerInteractorStyle() 
{
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnMouseMove() 
{ 
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnEnter()
{
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnLeave()
{
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnLeftButtonDown() 
{ 
    ...
    if (this->Interactor->GetControlKey()) 
      ...
      if (mouseInteractionMode == vtkMRMLInteractionNode::ViewTransform)
        ...
        if (mouseInteractionMode == vtkMRMLInteractionNode::Place)
          {
          this->InvokeEvent(vtkSlicerManagerInteractorStyle::PickEvent, this->Interactor->GetEventPosition());
          ...
          this->InvokeEvent(vtkSlicerManagerInteractorStyle::SelectRegionEvent, this->Interactor->GetEventPosition());
          this->NumberOfPicks++;
          ...
          this->InvokeEvent(vtkSlicerManagerInteractorStyle::PlotEvent, this->Interactor->GetEventPosition());
#endif
          }
        }
      }
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnLeftButtonUp()
{
  // get the scene's mouse interaction mode
  int mouseInteractionMode = vtkMRMLInteractionNode::ViewTransform;
  int pickModePersistence = 0;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnMiddleButtonDown() 
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == NULL)
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnMiddleButtonUp()
{
  switch (this->State) 
    {
    case VTKIS_PAN:
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnRightButtonDown() 
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == NULL)
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnRightButtonUp()
{
  switch (this->State) 
    {
    case VTKIS_DOLLY:
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnMouseWheelForward() 
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == NULL)
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnMouseWheelBackward()
{
  this->FindPokedRenderer(this->Interactor->GetEventPosition()[0], 
                          this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == NULL)
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::OnExpose()
{
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::Rotate()
{
  if (this->CurrentRenderer == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::Spin()
{
  if (this->CurrentRenderer == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::Pan()
{
  if (this->CurrentRenderer == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::Dolly()
{
  if (this->CurrentRenderer == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::Dolly(double factor)
{
  if (this->CurrentRenderer == NULL)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkSlicerManagerInteractorStyle::SetViewerWidget ( vtkSlicerModelDisplayManager *viewerWidget )
{
