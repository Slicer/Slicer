...
void qSlicerSettingsGeneralPanelPrivate::init()
{
  ...
  q->registerProperty("ioManager/MaximumFileNameLength",
                      this->MaximumFileNameLengthSpinBox,
                      /*no tr*/ "value",
                      SIGNAL(valueChanged(int)),
  ...
  QObject::connect(
    this->MaximumFileNameLengthSpinBox, SIGNAL(valueChanged(int)), q, SLOT(setMaximumFileNameLength(int)));
}
