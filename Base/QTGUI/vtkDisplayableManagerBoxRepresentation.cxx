/*=========================================================================
  ...
  Module:    $RCSfile: vtkDisplayableManagerBoxRepresentation.cxx,v $
...
vtkCxxRevisionMacro(vtkDisplayableManagerBoxRepresentation, "$Revision: 12141 $");
vtkStandardNewMacro(vtkDisplayableManagerBoxRepresentation);

//----------------------------------------------------------------------------
vtkDisplayableManagerBoxRepresentation::vtkDisplayableManagerBoxRepresentation()
{
  // The initial state
  this->InteractionState = vtkDisplayableManagerBoxRepresentation::Outside;
...
//----------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetPolyData(vtkPolyData *pd)
{
...
//----------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::StartWidgetInteraction(double e[2])
{
...
//----------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::WidgetInteraction(double e[2])
{
  ...
  // Process the motion
  if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF0 )
    {
    this->MoveMinusXFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF1 )
    {
    this->MovePlusXFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF2 )
    {
    this->MoveMinusYFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF3 )
    {
    this->MovePlusYFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF4 )
    {
    this->MoveMinusZFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::MoveF5 )
    {
    this->MovePlusZFace(prevPickPoint,pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::Translating )
    {
    this->Translate(prevPickPoint, pickPoint);
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::Scaling )
    {
    this->Scale(prevPickPoint, pickPoint, 
                static_cast<int>(e[0]), static_cast<int>(e[1]));
    }

  else if ( this->InteractionState == vtkDisplayableManagerBoxRepresentation::Rotating )
    {
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MoveFace(double *p1, double *p2, double *dir, 
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetDirection(const double Nx[3],const double Ny[3], 
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MovePlusXFace(double *p1, double *p2)
{
  double *pts =
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MoveMinusXFace(double *p1, double *p2)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MovePlusYFace(double *p1, double *p2)
{
  double *pts =
     static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MoveMinusYFace(double *p1, double *p2)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MovePlusZFace(double *p1, double *p2)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::MoveMinusZFace(double *p1, double *p2)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
...
void vtkDisplayableManagerBoxRepresentation::Translate(double *p1, double *p2)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double v[3];
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::Scale(double *vtkNotUsed(p1),
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::ComputeNormals()
{
  double *pts =
     static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetPlanes(vtkPlanes *planes)
{
  if ( ! planes )
    {
    return;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::Rotate(int X,
                                  int Y,
                                  double *p1,
                                  double *p2,
                                  double *vpn)
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::CreateDefaultProperties()
{
  // Handle properties
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::PlaceWidget(double bds[6])
{
  int i;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetCenter(double center[])
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double *p14 = pts + 3*14;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetExtents(double bounds[])
{
  double *pts =
     static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GetTransform(vtkTransform *t)
{
  double *pts =
    static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::SetTransform(vtkTransform* t)
{
  if (!t)
    {
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::SetOutlineFaceWires(int newValue)
{
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::SetOutlineCursorWires(int newValue)
{
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::GenerateOutline()
{
...
//----------------------------------------------------------------------------
int vtkDisplayableManagerBoxRepresentation::ComputeInteractionState(int X, int Y, int vtkNotUsed(modify))
{
  ...
  if ( path != NULL )
    ...
    if ( this->CurrentHandle == this->Handle[0] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF0;
      }
    else if ( this->CurrentHandle == this->Handle[1] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF1;
      }
    else if ( this->CurrentHandle == this->Handle[2] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF2;
      }
    else if ( this->CurrentHandle == this->Handle[3] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF3;
      }
    else if ( this->CurrentHandle == this->Handle[4] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF4;
      }
    else if ( this->CurrentHandle == this->Handle[5] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::MoveF5;
      }
    else if ( this->CurrentHandle == this->Handle[6] )
      {
      this->InteractionState = vtkDisplayableManagerBoxRepresentation::Translating;
      }
    }
...
//----------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::SetInteractionState(int state)
{
  // Clamp to allowable values
  state = ( state < vtkDisplayableManagerBoxRepresentation::Outside ? vtkDisplayableManagerBoxRepresentation::Outside : 
            (state > vtkDisplayableManagerBoxRepresentation::Scaling ? vtkDisplayableManagerBoxRepresentation::Scaling : state) );
  ...
  switch (state)
    {
    case vtkDisplayableManagerBoxRepresentation::MoveF0:
    case vtkDisplayableManagerBoxRepresentation::MoveF1:
    case vtkDisplayableManagerBoxRepresentation::MoveF2:
    case vtkDisplayableManagerBoxRepresentation::MoveF3:
    case vtkDisplayableManagerBoxRepresentation::MoveF4:
    case vtkDisplayableManagerBoxRepresentation::MoveF5:
      this->HighlightOutline(0);
      handle = this->HighlightHandle(this->CurrentHandle);
      this->HighlightFace(handle);
      break;
    case vtkDisplayableManagerBoxRepresentation::Rotating:
      //this->HighlightOutline(0);
      //this->HighlightHandle(NULL);
      //this->HighlightFace(this->HexPicker->GetCellId());
      break;
    case vtkDisplayableManagerBoxRepresentation::Translating:
    case vtkDisplayableManagerBoxRepresentation::Scaling:
...
//----------------------------------------------------------------------
double *vtkDisplayableManagerBoxRepresentation::GetBounds()
{
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::BuildRepresentation()
{
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::ReleaseGraphicsResources(vtkWindow *w)
{
...
//----------------------------------------------------------------------------
int vtkDisplayableManagerBoxRepresentation::RenderOpaqueGeometry(vtkViewport *v)
{
  int count=0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
int vtkDisplayableManagerBoxRepresentation::RenderTranslucentPolygonalGeometry(vtkViewport *v)
{
  int count=0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
int vtkDisplayableManagerBoxRepresentation::HasTranslucentPolygonalGeometry()
{
  int result=0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::PositionHandles()
{
  double *pts =
     static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::HandlesOn()
{
  for (int i=0; i<7; i++)
    {
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::HandlesOff()
{
  for (int i=0; i<7; i++)
    {
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::SizeHandles()
{
  double *center 
    = static_cast<vtkDoubleArray *>(this->Points->GetData())->GetPointer(3*14);
  double radius =
...
//----------------------------------------------------------------------------
int vtkDisplayableManagerBoxRepresentation::HighlightHandle(vtkProp *prop)
{
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::HighlightFace(int cellId)
{
  if ( cellId >= 0 )
    {
    vtkIdType npts;
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::HighlightOutline(int highlight)
{
  if ( highlight )
    {
...
//----------------------------------------------------------------------------
void vtkDisplayableManagerBoxRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
