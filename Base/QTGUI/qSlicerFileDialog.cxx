...
{
  if (ioProperties.value("objectName").toString().isEmpty())
  {
  ...
  if (ioProperties.value("fileType").toBool())
  {
    fileDialog->setNameFilters(qSlicerFileDialog::nameFilters((qSlicerIO::IOFileType)ioProperties.value("fileType").toString()));
  }
