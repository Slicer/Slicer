...
void qSlicerApplicationUpdateManagerTester::testUpdateCheck_data()
{
  ...
  QTest::newRow("1") << ":/application_30893_slicer_win_amd64.json" << Slicer_OS_WIN_NAME << "amd64" << "29000" << true
                     << "5.0.3" << "30893";
  QTest::newRow("2") << ":/application_30893_slicer_linux_amd64.json" << Slicer_OS_LINUX_NAME << "amd64" << "29000"
                     << true << "5.0.3" << "30893";
  QTest::newRow("3") << ":/application_30893_slicer_macosx_amd64.json" << Slicer_OS_MAC_NAME << "amd64" << "29000"
                     << true << "5.0.3" << "30893";

  QTest::newRow("4") << ":/application_30893_slicer_win_amd64.json" << Slicer_OS_WIN_NAME << "amd64" << "31000" << false
                     << "5.0.3" << "30893";
  QTest::newRow("5") << ":/application_30893_slicer_linux_amd64.json" << Slicer_OS_LINUX_NAME << "amd64" << "31000"
                     << false << "5.0.3" << "30893";
  QTest::newRow("6") << ":/application_30893_slicer_macosx_amd64.json" << Slicer_OS_MAC_NAME << "amd64" << "31000"
                     << false << "5.0.3" << "30893";
}
