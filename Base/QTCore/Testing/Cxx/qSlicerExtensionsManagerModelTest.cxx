...
void qSlicerExtensionsManagerModelTester::testSetExtensionsSettingsFilePath_data()
{
  ...
  QTest::newRow("existing relative path - ini extension") << "settings.ini" << "settings.ini";
...
void qSlicerExtensionsManagerModelTester::testSetSlicerRequirements_data()
{
  ...
  QList<QStringList> requirementsToSetList =
    QList<QStringList>() << (QStringList() << "" << "" << "") << (QStringList() << "5" << "" << "")
                         << (QStringList() << "5" << "linux" << "") << (QStringList() << "5" << "linux" << "")
                         << (QStringList() << "5" << "linux" << "amd64") << (QStringList() << "5" << "linux" << "amd64")
