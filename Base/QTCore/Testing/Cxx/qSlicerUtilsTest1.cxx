...
bool createFile(int line, const QDir& dir, const QString& relativePath, const QString& fileName)
{
  ...
  {
    std::cerr << "Line " << line << " - Failed to open file for writing" << qPrintable(filePath) << std::endl;
    return false;
  }
...
int isPluginInstalledBuiltinTest()
{
  ...
  if (current != expected)
  {
    std::cerr << __LINE__ << " - Error in  pathEndsWith()" << std::endl << "current = " << current << std::endl << "expected = " << expected << std::endl;
    return EXIT_FAILURE;
  }
...
int replaceWikiUrlVersionTest()
{
  ...
  CHECK_QSTRING(qSlicerUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Nightly/Extensions/SlicerToKiwiExporter", "4.4"),
  ...
  CHECK_QSTRING(qSlicerUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Foo/Extensions/SlicerToKiwiExporter", "Bar"),
  ...
  CHECK_QSTRING(qSlicerUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Foo/Extensions/SlicerToKiwiExporter/Foo", "Bar"),
...
int replaceDocumentationUrlVersionTest()
{
  ...
  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/stable/user_guide/get_help.html", hostname, "5.0"),
                "https://slicer.readthedocs.io/en/5.0/user_guide/get_help.html");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/4.11/user_guide/get_help.html", hostname, "5.0"),
                "https://slicer.readthedocs.io/en/5.0/user_guide/get_help.html");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/v4.11/user_guide/get_help.html", hostname, "v5.0"),
                "https://slicer.readthedocs.io/en/v5.0/user_guide/get_help.html");

  // GitHub -> no replacements are done

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart#readme", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart#readme");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/tree/4.6#readme", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart/tree/4.6#readme");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/tree/v4.6#readme", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart/tree/v4.6#readme");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/4.6/README.md", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart/blob/4.6/README.md");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/main/README.md", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart/blob/main/README.md");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/master/README.md", hostname, "5.0"),
                "https://github.com/SlicerHeart/SlicerHeart/blob/master/README.md");

  CHECK_QSTRING(qSlicerUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/latest/data/1.0/README.md", hostname, "5.0"),
