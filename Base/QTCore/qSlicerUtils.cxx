...
bool qSlicerUtils::isPluginInstalled(const QString& filePath, const QString& applicationHomeDir)
{
  ...
  return vtkSlicerApplicationLogic::IsPluginInstalled(filePath.toStdString(), applicationHomeDir.toStdString(), organisationDomain, organisationName, extensionsDirBase);
}
