...
void vtkSlicerModuleCollapsibleFrame::CreateWidget()
{
  ...
  this->Script(
    "pack %s -fill both -expand y -side top", this->ExternalMarginFrame->GetWidgetName());
  this->Script(
  ...
  this->Script (
                "pack %s -anchor nw -side left  -padx 2 -pady 0", this->Icon->GetWidgetName ( ));
  this->Script(
               "pack %s -anchor nw -side left -padx 2 -pady 0", this->Label->GetWidgetName());
