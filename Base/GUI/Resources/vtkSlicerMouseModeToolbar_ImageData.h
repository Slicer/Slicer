 ...
 *    MouseDefineROIDisabled.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseDefineROIDisabled_width          = 21;
static const unsigned int  image_MouseDefineROIDisabled_height         = 21;
static const unsigned int  image_MouseDefineROIDisabled_pixel_size     = 3;
 ...
 */
static const unsigned int  image_MouseManipulateDisabled_width          = 21;
static const unsigned int  image_MouseManipulateDisabled_height         = 21;
static const unsigned int  image_MouseManipulateDisabled_pixel_size     = 3;
static const unsigned long image_MouseManipulateDisabled_length         = 260;
static const unsigned long image_MouseManipulateDisabled_decoded_length = 1323;

static const unsigned char image_MouseManipulateDisabled[] = 
  "eNrVk7EKwyAQht9/SSBIIJMS+gDiEojgLm5xchOHvoY9KpWr1KQxUOg/HKfw+92dKoSIMY"
  "oL8d6qdEKz/Tf027vO0rEF54f0dV27rqvZ9+nDMGRLCGGaphp927bCC1BMlFL2fQ+xRjfG"
  "5P1xHPFR3ntCCGMMIuS13p1znHOtdVEJQNlLkJ+dfEIn4QK+uXeMLgo4pOeusXIBh3RrrX"
  "iKUgqTn+c5LWH/1JtflgXsSqm2H/fR/i/0nf9+JT4ArHxhPg==";

/* 
 * Resource generated for file:
 *    MouseManipulateOff.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseManipulateOff_width          = 21;
static const unsigned int  image_MouseManipulateOff_height         = 21;
static const unsigned int  image_MouseManipulateOff_pixel_size     = 3;
static const unsigned long image_MouseManipulateOff_length         = 272;
static const unsigned long image_MouseManipulateOff_decoded_length = 1323;

static const unsigned char image_MouseManipulateOff[] = 
  "eNrbtGnT////N1FAUgIoMYE+tp9mYEBGpNqOrAWZTdCEXbt29fX14dKOX++kSZPgWj5//W"
  "XpPe3Tp+9Ybb906RKaXqClyDZOmntU0awTSOKy/fTp03D2tGnTkI0CWqrjMMEifiOQBLJx"
  "+f3mzZsbNmw4efIkui/mHgXqhSAgm9SQh1gNQWgOIGgCstVoDiCoF+5rZITsAPwmnL30pK"
  "ptBxB5Rs0Dhnxg0mIIFyhOUppvm7QfqH3W4pPk5Rqs2oeK7fjzO9kkAMDXi70=";

/* 
 * Resource generated for file:
 *    MouseManipulateOn.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseManipulateOn_width          = 21;
static const unsigned int  image_MouseManipulateOn_height         = 21;
static const unsigned int  image_MouseManipulateOn_pixel_size     = 3;
static const unsigned long image_MouseManipulateOn_length         = 256;
static const unsigned long image_MouseManipulateOn_decoded_length = 1323;

static const unsigned char image_MouseManipulateOn[] = 
  "eNpjYGBkoAz9JxcMCe2nGRiQERnasbIJat+1a1dfXx952idNmgTX8vnrL0vvaZ8+fceq/d"
  "KlS2h6gZYi2zhp7lFFs04gicv206dPw8WnTZuGbBTQUh2HCRbxG4EkkI3L8Tdv3tywYcPJ"
  "kyfRfTH3KFAvBAHZpIY8xGoIQnYAMdqRrUZzAEHtcF8jI7gDCGo/e+lJVdsOIPKMmgcM+c"
  "CkxRAuUJykNN82aT9Q+6zFJ8nLMkNaO578TgkCAJNjwQY=";
...
/* 
 * Resource generated for file:
 *    MouseSelectDisabled.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseSelectDisabled_width          = 21;
static const unsigned int  image_MouseSelectDisabled_height         = 21;
static const unsigned int  image_MouseSelectDisabled_pixel_size     = 3;
static const unsigned long image_MouseSelectDisabled_length         = 92;
static const unsigned long image_MouseSelectDisabled_decoded_length = 1323;

static const unsigned char image_MouseSelectDisabled[] = 
  "eNrbtGnT////N1FAPiMXQEwgWzt1bV8AA8RwMW1HlsIFkNVg2k6S9kEV8gPrdwptH/BUN4"
  "B+pzDND8X8TgkJANJaffc=";

/* 
 * Resource generated for file:
 *    MouseSelectOff.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseSelectOff_width          = 21;
static const unsigned int  image_MouseSelectOff_height         = 21;
static const unsigned int  image_MouseSelectOff_pixel_size     = 3;
static const unsigned long image_MouseSelectOff_length         = 92;
static const unsigned long image_MouseSelectOff_decoded_length = 1323;

static const unsigned char image_MouseSelectOff[] = 
  "eNrbtGnT////N1FAUgIoMYG6tp9mYIAgYriYtiNL4QJoatBsJ0n7oAr5gfU7hbYPeKobQL"
  "9TmOaHaH4nmwQAq1y7ug==";

/* 
 * Resource generated for file:
 *    MouseSelectOn.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseSelectOn_width          = 21;
static const unsigned int  image_MouseSelectOn_height         = 21;
static const unsigned int  image_MouseSelectOn_pixel_size     = 3;
static const unsigned long image_MouseSelectOn_length         = 88;
static const unsigned long image_MouseSelectOn_decoded_length = 1323;

static const unsigned char image_MouseSelectOn[] = 
  "eNpjYmJgogz9JxcMKu2nGRggiBguVu0EbaSddvoHHSPjYPH7kAu6weN3CtM8/YOOhYWRbO"
  "3MzOQXcRC9AOiv8fo=";

/* 
 * Resource generated for file:
 *    MouseZoomDisabled.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseZoomDisabled_width          = 21;
static const unsigned int  image_MouseZoomDisabled_height         = 21;
static const unsigned int  image_MouseZoomDisabled_pixel_size     = 3;
static const unsigned long image_MouseZoomDisabled_length         = 168;
static const unsigned long image_MouseZoomDisabled_decoded_length = 1323;

static const unsigned char image_MouseZoomDisabled[] = 
  "eNqtlMsNwDAIQ7fvHqyAOlPXoIdIyHIKqnB8yIHavDQ/d48IF8ZnqtWhMZhZ8xXpNyizS5"
  "UB6VmkLHYgJ9GrLHX4Q2+002l615f2JU06TY/MVEkz0rFDE0cn0bNexcl2lq78u7Ly4r4f"
  "P3WDM6/cOPG+j18bZXwBl/w5Dw==";

/* 
 * Resource generated for file:
 *    MouseZoomOff.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseZoomOff_width          = 21;
static const unsigned int  image_MouseZoomOff_height         = 21;
static const unsigned int  image_MouseZoomOff_pixel_size     = 3;
static const unsigned long image_MouseZoomOff_length         = 176;
static const unsigned long image_MouseZoomOff_decoded_length = 1323;

static const unsigned char image_MouseZoomOff[] = 
  "eNrbtGnT////N1FAUgLwm2ARv5FIvQuQAFwvBOFSgGwCsiAQGPpNREbIUnCVaLYjuxkTYV"
  "WJy3Y8ANN2tCAyxgawBinEBCAX2YNoitFEgCoh2pFthwvi146mEtl2eBDh0g5RQCPbKfE7"
  "JSFPYbxTPdWRkeYpyXEU5ndKShuySQA9bTfO";

/* 
 * Resource generated for file:
 *    MouseZoomOn.png (zlib, base64) (image file)
 */
static const unsigned int  image_MouseZoomOn_width          = 21;
static const unsigned int  image_MouseZoomOn_height         = 21;
static const unsigned int  image_MouseZoomOn_pixel_size     = 3;
static const unsigned long image_MouseZoomOn_length         = 160;
static const unsigned long image_MouseZoomOn_decoded_length = 1323;

static const unsigned char image_MouseZoomOn[] = 
  "eNpjYGBkoAz9JxcQ1G4Rv5FI7QuQAFwvBOFSgKYd2WRDv4nICFmKoHa4vciIeO34AaZ2tC"
  "AyxgYwgxRZO7IH0RSjiQBVYtUOdwMe7cgqMbVDxHFphyigke2U+J2SkKcw3qme6shI85Tk"
  "OArzO9mlDSUIAA/5bRc=";
