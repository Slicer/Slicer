...
// slicer3 build patch: need to check versions
// to know if inet_pton and inet_ntop need to be 
// stubbed out or not in this file
#if defined(MS_WINDOWS) 
#undef  _INC_SDKDDKVER
#pragma message ("including sdkddkver.h")
#  include "sdkddkver.h"
#endif
...
#pragma message ("NTDDI_VERSION " cppstring(NTDDI_VERSION) )
#pragma message ("NTDDI_LONGHORN " cppstring(NTDDI_LONGHORN) )
#ifndef HAVE_INET_PTON
#if !defined(NTDDI_VERSION) || (NTDDI_VERSION < NTDDI_LONGHORN)
/* Don't redefine inet_pton in VS2008 */
