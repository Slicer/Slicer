...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkSlicerIGTDemoGUI );
vtkCxxRevisionMacro ( vtkSlicerIGTDemoGUI, "$Revision: 1.0 $");


//---------------------------------------------------------------------------
vtkSlicerIGTDemoGUI::vtkSlicerIGTDemoGUI ( )
{
    this->Logic = NULL;
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::PrintSelf ( ostream& os, vtkIndent indent )
{
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::RemoveGUIObservers ( )
{
    // Fill in
    if (this->LoadConfigButton)
    {
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::AddGUIObservers ( )
{
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::ProcessGUIEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    ...
    {
        vtkSlicerIGTDemoLogic *igtLogic = this->Logic;
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::ProcessLogicEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    // Fill in
}
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::ProcessMRMLEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    // Fill in
}
...
void vtkSlicerIGTDemoGUI::ProcessTimerEvents ()
{
    if (! this->StopTimer)
    {
...
void vtkSlicerIGTDemoGUI::MakeLocator()
{
...
void vtkSlicerIGTDemoGUI::UpdateSliceDisplay(float px, float py, float pz)
{
...
void vtkSlicerIGTDemoGUI::UpdateLocator()
{
    vtkSlicerIGTDemoLogic *igtLogic = this->Logic;
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::Enter ( )
{
    // Fill in
...
//---------------------------------------------------------------------------
void vtkSlicerIGTDemoGUI::BuildGUI ( )
{

    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    // Define your help text here.
    const char *help = "The **IGT Demo Module** connects Slicer to a SPLOT server that feeds a real-time stream of coordinates from a tracking device. This is useful in the operating room to allow the surgeons to navigate the preloaded volume(s) by pointing to a location with a probe that is tracked."; 

    // ---
    // MODULE GUI FRAME 
    // create a page
    this->UIPanel->AddPage ( "SPLIGTDemo", "SPLIGTDemo", NULL );

    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "SPLIGTDemo" );


    // ----------------------------------------------------------------
    // HELP FRAME            
    // ----------------------------------------------------------------
    vtkSlicerModuleCollapsibleFrame *IGTDemoHelpFrame = vtkSlicerModuleCollapsibleFrame::New ( );
    IGTDemoHelpFrame->SetParent ( page );
    IGTDemoHelpFrame->Create ( );
    IGTDemoHelpFrame->CollapseFrame ( );
    IGTDemoHelpFrame->SetLabelText ("Help");
    app->Script ( "pack %s -side top -anchor nw -fill x -padx 2 -pady 2 -in %s",
            IGTDemoHelpFrame->GetWidgetName(), page->GetWidgetName());

    // configure the parent classes help text widget
    this->HelpText->SetParent ( IGTDemoHelpFrame->GetFrame() );
...
void vtkSlicerIGTDemoGUI::BuildGUIForRegistrationFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "SPLIGTDemo" );
...
void vtkSlicerIGTDemoGUI::BuildGUIForServerFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "SPLIGTDemo" );
...
void vtkSlicerIGTDemoGUI::BuildGUIForTrackingFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "SPLIGTDemo" );
...
void vtkSlicerIGTDemoGUI::BuildGUIForHandPieceFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "SPLIGTDemo" );
