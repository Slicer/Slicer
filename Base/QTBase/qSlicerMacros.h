...
// Instantiate Internal structure
//
...
// Also make sure qInternal is instantiated
//
...
// Also make sure qInternal is instantiated
//
#define qSlicerCxxInternalBckPtrConstructor1Macro(_CLASSTYPE, _ARG1) \
  _CLASSTYPE::_CLASSTYPE(_ARG1 parent) :                             \
    Superclass(parent)                                               \
    {                                                                \
...
#define qSlicerSetInternalCxxMacro(_CLASSTYPE, _TYPE, _NAME, _VARNAME)  \
  void _CLASSTYPE::_NAME(_TYPE var)                                     \
  {                                                                     \
