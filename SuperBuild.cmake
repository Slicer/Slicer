...
if(Slicer_BUILD_DICOM_SUPPORT AND Slicer_USE_PYTHONQT_WITH_OPENSSL)
  ...
  list(APPEND Slicer_DEPENDENCIES python-certifi)
  list(APPEND Slicer_DEPENDENCIES python-idna)
  list(APPEND Slicer_DEPENDENCIES python-chardet)
  list(APPEND Slicer_DEPENDENCIES python-urllib3)
  list(APPEND Slicer_DEPENDENCIES python-requests)
