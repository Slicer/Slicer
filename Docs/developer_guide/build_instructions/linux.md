...
- Qt5 with the components listed below. Qt version 5.15.x is recommended, other Qt versions are not tested and may cause build errors or may cause problems when running the application.
  - Multimedia
  - UiTools
  - XMLPatterns
  - SVG
