...
- Left-click on a translation handle: Translate along a specific axis, or parallel to the view plane.
- Alt + left-click on a translation handle: Translate the center of transformation.
- Left-click on a rotation handle: Rotate around a specific axis, or parallel to the view plane.
- Left-click on a scale handle: Scale along a specific axis.
- Alt + left-click on a scale handle: Uniform scaling
- Right-click during interaction: Cancel and return to original state
- Escape during interaction: Cancel and return to original state
