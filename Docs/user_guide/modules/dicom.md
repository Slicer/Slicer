...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserTabMode.png)

*Tab patient mode: organized by patient tabs for clinical workflows*

![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserListMode.png)
...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserSidePanel.png)
...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserJobs.png)
...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserServerSettings.png)
...
1. In the DICOM module, click the "Show visual DICOM browser" button to toggle between the traditional text-based browser and the Visual DICOM Browser
...
4. (Optional) Click "Show in side panel" to dock the browser to the side of the main window, allowing you to work with your data while keeping the browser visible
...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_dicom_visualDICOMBrowserProxyServerSettings.png)
