...
Slicer is extensible. If you are interested in customizing or adding functionality to Slicer, click [here](https://slicer.github.io/training.slicer.org/#developer-tutorials).
...
Try the [Welcome Tutorial](https://slicer.github.io/training.slicer.org/#stc-gen-101-welcome-tutorial) and the [Data Loading and 3D Visualization Tutorial](https://slicer.github.io/training.slicer.org/#stc-vis-102-data-loading-and-3d-visualization) to learn the basics.

For more tutorials, visit the [Tutorial page](https://slicer.github.io/training.slicer.org/).
