/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkSlicerExtensionTestLogic.cxx,v $
...
//----------------------------------------------------------------------------
vtkCxxRevisionMacro(vtkSlicerExtensionTestLogic, "$Revision: 1.9.12.1 $");
vtkStandardNewMacro(vtkSlicerExtensionTestLogic);

//----------------------------------------------------------------------------
vtkSlicerExtensionTestLogic::vtkSlicerExtensionTestLogic()
{
...
//----------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::ProcessMRMLEvents(vtkObject *vtkNotUsed(caller),
...
//----------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::ProcessLogicEvents(vtkObject *vtkNotUsed(caller), 
                                            unsigned long event, 
                                            void *callData)
{
...
//#include <vtkMRMLScalarVolumeDisplayNode.h"
//----------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::SetActiveVolumeNode(vtkMRMLVolumeNode *activeNode)
{
...
vtkMRMLVolumeNode* vtkSlicerExtensionTestLogic::AddHeaderVolume (const char* filename, const char* volname, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerExtensionTestLogic::AddArchetypeScalarVolume (const char* filename, const char* volname, int loadingOptions)
{ 
  int centerImage = 0;
  int labelMap = 0;
  int singleFile = 0;
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkSlicerExtensionTestLogic::AddArchetypeScalarVolume(
...
// higher bits are reserved for future use
vtkMRMLVolumeNode* vtkSlicerExtensionTestLogic::AddArchetypeVolume (const char* filename, const char* volname, int loadingOptions, vtkStringArray *fileList)
{
...
//----------------------------------------------------------------------------
vtkMRMLVolumeNode* vtkSlicerExtensionTestLogic::AddArchetypeVolume(const char* filename, 
                                                                    const char* volname, 
                                                                    int loadingOptions) 
{
...
//----------------------------------------------------------------------------
int vtkSlicerExtensionTestLogic::SaveArchetypeVolume(const char* filename, 
...
//----------------------------------------------------------------------------
vtkMRMLScalarVolumeNode *vtkSlicerExtensionTestLogic::CreateLabelVolume (vtkMRMLScene *scene, vtkMRMLVolumeNode *volumeNode, const char *name)
{
  if ( volumeNode == 0 ) 
    {
    return 0;
...
//----------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);

  os << indent << "vtkSlicerExtensionTestLogic:             " << this->GetClassName() << "\n";
...
//----------------------------------------------------------------------------
int vtkSlicerExtensionTestLogic::IsFreeSurferVolume (const char* filename)
{
...
//-------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::ComputeTkRegVox2RASMatrix ( vtkMRMLVolumeNode *VNode,
                                                                       vtkMatrix4x4 *M )
{
    double dC, dS, dR;
    double Nc, Ns, Nr;
...
//-------------------------------------------------------------------------
void vtkSlicerExtensionTestLogic::TranslateFreeSurferRegistrationMatrixIntoSlicerRASToRASMatrix( vtkMRMLVolumeNode *V1Node,
