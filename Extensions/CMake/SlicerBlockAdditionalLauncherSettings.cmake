...
if(NOT TARGET ConfigureAdditionalLauncherSettings)
  ...
  PYTHONPATH=${CMAKE_BINARY_DIR}/${Slicer_QTSCRIPTEDMODULES_LIB_DIR}<PATHSEP>${CMAKE_BINARY_DIR}/${Slicer_QTLOADABLEMODULES_LIB_DIR}/\${CMAKE_CFG_INTDIR}<PATHSEP>${CMAKE_BINARY_DIR}/${Slicer_QTLOADABLEMODULES_PYTHON_LIB_DIR}<PATHSEP><env:PYTHONPATH>
  \")
  ")
