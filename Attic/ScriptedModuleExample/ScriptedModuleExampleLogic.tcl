#
# ScriptedModuleExample logic procs
#

#
# make a clone of the scripted module example with a new name
#
proc ScriptedModuleExampleClone { moduleName {slicerSourceDir ""} {targetDir ""} } {
  ...
  set files [glob $slicerSourceDir/Modules/ScriptedModuleExample/*]
  foreach f $files {
    set ff [file tail $f]
    ...
    close $fp
    regsub -all "ScriptedModuleExample" $contents $moduleName newContents

    regsub -all "ScriptedModuleExample" $ff $moduleName newFileName
...
#
proc ScriptedModuleExampleAddQuickModel { sliceLogic } {
  ...
  eval $modelDisplayNode SetColor [lrange [ScriptedModuleExampleGetPaintColor $::ScriptedModuleExample(singleton)] 0 2]
...
#
proc ScriptedModuleExampleLabelCheckpoint {} {
