...
IF(MSVC)
  ...
  IF(MSVC70)
    SET(__install__libs
      "${SYSTEMROOT}/system32/msvcp70d.dll"
      "${SYSTEMROOT}/system32/msvcr70d.dll"
      )
  ENDIF(MSVC70)
  IF(MSVC71)
    SET(__install__libs
      "${SYSTEMROOT}/system32/msvcp71d.dll"
      "${SYSTEMROOT}/system32/msvcr71d.dll"
      )
  ENDIF(MSVC71)
  IF(MSVC80)
  ...
  IF(CMAKE_INSTALL_MFC_LIBRARIES)
    IF(MSVC70)
      SET(__install__libs ${__install__libs}
        "${SYSTEMROOT}/system32/mfc70d.dll"
        )
    ENDIF(MSVC70)
    IF(MSVC71)
      SET(__install__libs ${__install__libs}
        "${SYSTEMROOT}/system32/mfc71d.dll"
        )
    ENDIF(MSVC71)
